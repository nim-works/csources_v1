...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		} LA2: ;
		{
			...
			prefix = substr__system_7554(s, ((NI) 0), (NI)(le - ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			suffix = substr__system_7566(s, (NI)(ri + ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			{
				NimStringV2 middle;
				...
				colontmp__2 = substr__system_7554(s, (NI)(le + ((NI) 1)), (NI)(ri - ((NI) 1)));
				...
				splitsX60gensym33_ = ((NI) -1);
				{
					while (1) {
						...
						LA34_: ;
						colontmp__5 = substr__system_7554(colontmp__2, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
