...
{nimErr_ = nimErrorFlag();
	...
	LA9_: ;
	eqdestroy___system_3228((&(*dest).event.instLoc.Field0));
	switch ((*dest).event.kind) {
	case ((tyEnum_VmEventKind__eTgzLRBCQcqciUSHj9a1q1Q) 1):
	{
		eqdestroy___system_3228((&(*dest).event._kind_1.errMsg));
	}
	break;
	case ((tyEnum_VmEventKind__eTgzLRBCQcqciUSHj9a1q1Q) 15):
	{
		eqdestroy___system_3228((&(*dest).event._kind_2.callName));
		{
			NIM_BOOL T15_;
			T15_ = (NIM_BOOL)0;
			...
			nimRawDispose((*dest).event._kind_2.argAst, ((NI) 4));
		}
		LA16_: ;
	}
	break;
	...
	{
		eqdestroy___system_3228((&(*dest).event._kind_5.msg));
	}
	break;
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose((*dest).event._kind_6.ast, ((NI) 4));
		}
		LA35_: ;
	}
	break;
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose((*dest).event._kind_7.exc, ((NI) 4));
		}
		LA41_: ;
...
(*dest).instLoc.Field0.len = (*src).instLoc.Field0.len; (*dest).instLoc.Field0.p = (*src).instLoc.Field0.p;
	...
	case ((tyEnum_VmEventKind__eTgzLRBCQcqciUSHj9a1q1Q) 1):
	{
		eqdestroy___system_3228((&(*dest)._kind_1.errMsg));
	}
	break;
	case ((tyEnum_VmEventKind__eTgzLRBCQcqciUSHj9a1q1Q) 15):
	{
		eqdestroy___system_3228((&(*dest)._kind_2.callName));
		{
			NIM_BOOL T5_;
			T5_ = (NIM_BOOL)0;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose((*dest)._kind_2.argAst, ((NI) 4));
		}
		LA6_: ;
	}
	break;
	...
	case ((tyEnum_VmEventKind__eTgzLRBCQcqciUSHj9a1q1Q) 20):
	{
		eqdestroy___system_3228((&(*dest)._kind_5.msg));
	}
	break;
	case ((tyEnum_VmEventKind__eTgzLRBCQcqciUSHj9a1q1Q) 25):
	case ((tyEnum_VmEventKind__eTgzLRBCQcqciUSHj9a1q1Q) 26):
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose((*dest)._kind_6.ast, ((NI) 4));
		}
		LA25_: ;
	}
	break;
	...
	{
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimRawDispose((*dest)._kind_7.exc, ((NI) 4));
		}
		LA31_: ;
