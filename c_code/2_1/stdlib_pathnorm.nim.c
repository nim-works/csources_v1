...
{nimErr_ = nimErrorFlag();
	...
	(*it).prev = (*it).i;
	{
		...
		colontmp_ = (NIM_BOOL)0;
		{
			...
			LA5_: ;
			colontmp_ = (((NU8)(x.p->data[(*it).i])) == ((NU8)(47)) || ((NU8)(x.p->data[(*it).i])) == ((NU8)(47)));
		} LA2: ;
		{
		...
		LA9_: ;
		{
			while (1) {
				...
				{
					colontmp__2 = ((*it).i < x.len);
					{
						if (!!(colontmp__2)) goto LA16_;
						goto LA13;
					}
					LA16_: ;
					colontmp__2 = !((((NU8)(x.p->data[(*it).i])) == ((NU8)(47)) || ((NU8)(x.p->data[(*it).i])) == ((NU8)(47))));
				} LA13: ;
				{
	...
	{
		{
			NI colontmp__3;
			NI colontmp__4;
			if (!((*it).prev < (*it).i)) goto LA25_;
			colontmp__3 = (*it).prev;
			colontmp__4 = (NI)((*it).i - ((NI) 1));
		...
		LA25_: ;
		{
			NIM_BOOL T29_;
			T29_ = (NIM_BOOL)0;
			T29_ = hasNext__pureZpathnorm_6((*it), x);
	...
	} LA22: ;
	{
		while (1) {
			...
			colontmp__5 = (NIM_BOOL)0;
			{
				...
				LA37_: ;
				colontmp__5 = (((NU8)(x.p->data[(*it).i])) == ((NU8)(47)) || ((NU8)(x.p->data[(*it).i])) == ((NU8)(47)));
			} LA34: ;
			{
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isSlash__pureZpathnorm_66)(NimStringV2 x, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ bounds) {
	...
	colontmp_ = (NIM_BOOL)0;
	{
		...
		LA4_: ;
		colontmp_ = (((NU8)(x.p->data[bounds.Field0])) == ((NU8)(47)) || ((NU8)(x.p->data[bounds.Field0])) == ((NU8)(47)));
	} LA1: ;
	result = colontmp_;
	return result;
}
	...
	LA3_: ;
	{
		while (1) {
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			{
				...
				colontmp__2 = (NIM_BOOL)0;
				{
					colontmp__2 = ((NI)((NI32)((*state)) >> (NU32)(((NI) 1))) == ((NI) 0));
					{
						if (!!(colontmp__2)) goto LA27_;
						goto LA24;
					}
					LA27_: ;
					colontmp__2 = isSlash__pureZpathnorm_66(x, b);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				} LA24: ;
				{
					...
					colontmp__3 = (NIM_BOOL)0;
					{
						...
						LA36_: ;
						colontmp__3 = !((((NU8)((*result).p->data[(NI)((*result).len - ((NI) 1))])) == ((NU8)(47)) || ((NU8)((*result).p->data[(NI)((*result).len - ((NI) 1))])) == ((NU8)(47))));
					} LA33: ;
					{
				...
				LA31_: ;
				{
					NIM_BOOL T44_;
					T44_ = (NIM_BOOL)0;
					T44_ = isDotDot__pureZpathnorm_62(x, b);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					if (!T44_) goto LA45_;
					{
						...
						{
							NI d;
							if (!(((NI) 1) <= (NI)((NI32)((*state)) >> (NU32)(((NI) 1))))) goto LA50_;
							d = (*result).len;
							{
								while (1) {
									...
									colontmp__4 = (NIM_BOOL)0;
									{
										...
										LA57_: ;
										colontmp__4 = !((((NU8)((*result).p->data[(NI)(d - ((NI) 1))])) == ((NU8)(47)) || ((NU8)((*result).p->data[(NI)(d - ((NI) 1))])) == ((NU8)(47))));
									} LA54: ;
									{
						...
						colontmp__6 = (NIM_BOOL)0;
						{
							...
							LA70_: ;
							colontmp__6 = !((((NU8)((*result).p->data[(NI)((*result).len - ((NI) 1))])) == ((NU8)(47)) || ((NU8)((*result).p->data[(NI)((*result).len - ((NI) 1))])) == ((NU8)(47))));
						} LA67: ;
						{
						...
						LA74_: ;
						colontmp__5 = substr__system_7542(x, b.Field0, b.Field1);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&(*result)), colontmp__5);
				...
				LA45_: ;
				{
					NIM_BOOL T78_;
					T78_ = (NIM_BOOL)0;
					T78_ = isDot__pureZpathnorm_58(x, b);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					if (!T78_) goto LA79_;
					goto LA23;
				}
				LA79_: ;
				{
					...
					colontmp__8 = (NIM_BOOL)0;
					{
						...
						LA89_: ;
						colontmp__8 = !((((NU8)((*result).p->data[(NI)((*result).len - ((NI) 1))])) == ((NU8)(47)) || ((NU8)((*result).p->data[(NI)((*result).len - ((NI) 1))])) == ((NU8)(47))));
					} LA86: ;
					{
					...
					LA93_: ;
					colontmp__9 = substr__system_7542(x, b.Field0, b.Field1);
...
appendString((&(*result)), colontmp__7);
	...
	} LA97: ;
	{
		...
		colontmp__11 = result;
		eqsink___system_3234(colontmp__11, TM__DfU0iuayCGwHDN1Exp9cbKg_3);
	}
	LA104_: ;
	}BeforeRet_: ;
}
