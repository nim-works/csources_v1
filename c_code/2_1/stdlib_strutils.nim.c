...
{nimErr_ = nimErrorFlag();
	...
	LA18_: ;
	result = substr__system_7542(s, first, last);
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___pureZstrutils_1103)(NimStringV2* s, tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA x, NimStringV2 b) {
	...
	L = (NI)((NI)(x.b - a) + ((NI) 1));
	{
		NI shiftX60gensym455_;
		NI newLenX60gensym455_;
		{
		...
		LA4_: ;
		shiftX60gensym455_ = (NI)(b.len - ((((NI) 0) >= L) ? ((NI) 0) : L));
		newLenX60gensym455_ = (NI)((*s).len + shiftX60gensym455_);
		{
			{
				if (!(((NI) 0) < shiftX60gensym455_)) goto LA16_;
				setLengthStrV2((&(*s)), ((NI) (newLenX60gensym455_)));
				{
					NI iX60gensym455_;
					NI colontmp_;
					NI colontmp__2;
					...
					colontmp_ = (NI)0;
					colontmp__2 = (NI)0;
					colontmp_ = (NI)(newLenX60gensym455_ - ((NI) 1));
					...
					res = colontmp_;
					{
						while (1) {
							...
							iX60gensym455_ = res;
							nimPrepareStrMutationV2((&(*s)));
							(*s).p->data[iX60gensym455_] = (*s).p->data[(NI)(iX60gensym455_ - shiftX60gensym455_)];
							(*s).p->data[(NI)(iX60gensym455_ - shiftX60gensym455_)] = 0;
							res -= ((NI) 1);
						} LA20: ;
					}
				}
			...
			LA16_: ;
			{
				...
				NI colontmp__4;
				NI res_2;
				iX60gensym455__2 = (NI)0;
				colontmp__3 = (NI)0;
				colontmp__4 = (NI)0;
				colontmp__3 = (NI)(a + b.len);
				colontmp__4 = (NI)(newLenX60gensym455_ - ((NI) 1));
				res_2 = colontmp__3;
				{
					while (1) {
						{
						...
						LA30_: ;
						iX60gensym455__2 = res_2;
						nimPrepareStrMutationV2((&(*s)));
						(*s).p->data[iX60gensym455__2] = (*s).p->data[(NI)(iX60gensym455__2 - shiftX60gensym455_)];
						(*s).p->data[(NI)(iX60gensym455__2 - shiftX60gensym455_)] = 0;
						res_2 += ((NI) 1);
					} LA27: ;
				}
			}
		...
		} LA13: ;
		{
			...
			i_3 = ((NI) 0);
			{
				while (1) {
					...
					LA37_: ;
					iX60gensym455__3 = i_3;
					nimPrepareStrMutationV2((&(*s)));
					(*s).p->data[(NI)(a + iX60gensym455__3)] = b.p->data[iX60gensym455__3];
					i_3 += ((NI) 1);
				} LA34: ;
			}
		}
		...
		LA4_: ;
		{
			...
			i = ((NI) 0);
			{
				while (1) {
					...
					LA15_: ;
					colontmp__2 = substr__system_7542(s, i, (NI)(j - ((NI) 1)));
					if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
...
appendString((&result), by);
			...
			colontmp__3 = substr__system_7554(s, i);
			if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
...
appendString((&result), colontmp_);
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				LA23_: ;
				colontmp__5 = substr__system_7542(s, i_2, (NI)(j_2 - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&result), by);
		...
		colontmp__4 = substr__system_7554(s, i_2);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		splitsX60gensym33_ = maxsplit;
		{
			while (1) {
				...
				LA21_: ;
				xX60gensym66_ = substr__system_7542(s, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				xX60gensym75_ = substr__system_7542(s, first, colontmp_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				colontmp__5 = substr__system_7542(s, first, colontmp_);
	...
	result = ((NI) 2147483647);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				colontmp__4 = substr__system_7542(s, first, colontmp_);
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmp_ = substr__system_7554(s, ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
