...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		} LA2: ;
		{
			...
			prefix = substr__system_7542(s, ((NI) 0), (NI)(le - ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			suffix = substr__system_7554(s, (NI)(ri + ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA11_;
			{
				NimStringV2 middle;
				...
				colontmp__2 = substr__system_7542(s, (NI)(le + ((NI) 1)), (NI)(ri - ((NI) 1)));
				...
				splitsX60gensym33_ = ((NI) -1);
				{
					while (1) {
						...
						NimStringV2 T36_;
						{
							if (!!((lastX60gensym33_ <= colontmp__2.len))) goto LA18_;
							goto LA15;
						}
						LA18_: ;
						...
						firstX60gensym33_ = lastX60gensym33_;
						{
							while (1) {
								...
								{
									colontmp__4 = (lastX60gensym33_ < colontmp__2.len);
									{
										if (!!(colontmp__4)) goto LA26_;
										goto LA23;
									}
									LA26_: ;
									colontmp__4 = !(((NU8)(colontmp__2.p->data[lastX60gensym33_]) == (NU8)(124)));
								} LA23: ;
								{
						...
						LA34_: ;
						colontmp__5 = substr__system_7542(colontmp__2, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
						if (NIM_UNLIKELY(*nimErr_)) goto LA20_;
						eqsink___system_3234((&middle), colontmp__5);
...
appendString((&T36_), suffix);
						...
						libCandidates__pureZdynlib_59(colontmp__3, dest);
						if (NIM_UNLIKELY(*nimErr_)) goto LA20_;
						{
				...
				}
				{
					...
					eqdestroy___system_3228((&middle));
		...
		colontmp__7.len = 0; colontmp__7.p = NIM_NIL;
		eqcopy___system_3231((&colontmp__7), s);
		add__stdZenumutils_66(dest, colontmp__7);
	} LA1: ;
	}BeforeRet_: ;
}
