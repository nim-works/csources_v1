...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__pureZos_1726)(NimStringV2 dir);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplAux__pureZos_1875)(NimStringV2 procPath);
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHeuristic__pureZos_1879)(void);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__pureZos_1719)(NimStringV2 dir);
	...
	{
		{
			...
			LA5_: ;
			T7_ = (NIM_CHAR)0;
			T7_ = X5BX5D___system_7132(tail, ((NI) 1));
		...
		LA10_: ;
		{
			...
			LA15_: ;
			{
				...
				LA20_: ;
				T22_ = (NIM_CHAR*)0;
				T22_ = X5BX5D___system_7171(result, ((NI) 1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	{
		{
			...
			T24_ = substr__system_7542(path, ((NI) 0), colontmp__2);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			result.Field0 = T24_;
			T25_.len = 0; T25_.p = NIM_NIL;
			T25_ = substr__system_7554(path, (NI)(sepPos + ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			result.Field1 = T25_;
			goto LA13;
		}
				...
				i = res;
				{
					...
					} LA9: ;
					{
						if (!colontmp__6) goto LA16_;
						{
							...
							T28_ = substr__system_7542(path, ((NI) 0), colontmp__7);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							result.Field0 = T28_;
							namePos = (NI)(i + ((NI) 1));
						}
						LA20_: ;
						{
							NimStringV2 T36_;
							{
								...
								T34_ = substr__system_7542(path, namePos, (NI)(dotPos - ((NI) 1)));
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								result.Field1 = T34_;
								T35_.len = 0; T35_.p = NIM_NIL;
								T35_ = substr__system_7554(path, dotPos);
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								result.Field2 = T35_;
								goto LA29;
							}
							...
							T36_ = substr__system_7554(path, namePos);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							result.Field1 = T36_;
						} LA29: ;
						goto LA1;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3234(colontmp_, colontmp__2);
	{
		...
		colontmp__3 = (NIM_BOOL)0;
		{
			...
			LA9_: ;
			T11_ = (NIM_CHAR*)0;
			T11_ = X5BX5D___system_7171((&(*e).Sup.Sup.message), ((NI) 1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		while (1) {
			{
				NI32 err;
				{
					...
					T7_ = (NIM_BOOL)0;
					T7_ = eqeq___system_7522(T6_, ((NCSTRING) NIM_NIL));
					if (!!(T7_)) goto LA8_;
					T10_ = (int)0;
		...
		while (1) {
			{
				...
				colontmp__10 = (NIM_BOOL)0;
				{
					...
					LA69_: ;
					T71_ = (NIM_CHAR*)0;
					T71_ = X5BX5D___system_7171((&result), ((NI) 1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		while (1) {
			{
				...
				colontmp__11 = (NIM_BOOL)0;
				{
					...
					LA90_: ;
					T92_ = (NIM_CHAR*)0;
					T92_ = X5BX5D___system_7171((&result), ((NI) 1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL colontmp__4;
		{
			...
			colontmp__3 = substr__system_7542(result, ((NI) 0), sepPos);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		colontmp__4 = (NIM_BOOL)0;
		{
			...
			LA19_: ;
			T21_ = (NIM_CHAR*)0;
			T21_ = X5BX5D___system_7171((&result), ((NI) 1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__pureZos_1726(dir);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	{
		if (!result) goto LA4_;
...
{nimErr_ = nimErrorFlag();
			...
			while (1) {
				...
				i = res;
				{
					if (!(((NU8)(dir.p->data[i])) == ((NU8)(47)) || ((NU8)(dir.p->data[i])) == ((NU8)(47)))) goto LA10_;
					{
						...
						colontmp__4 = substr__system_7542(dir, ((NI) 0), (NI)(i - ((NI) 1)));
	...
	colontmp__5 = (NIM_BOOL)0;
	{
		...
		LA29_: ;
		T31_ = (NIM_CHAR)0;
		T31_ = X5BX5D___system_7132(dir, ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&(*s)), TM__yu6cxgKBBXbNsTkT9cyMd4g_59);
		n = ((NU8)(c));
		nimAddCharV1((&(*s)), TM__yu6cxgKBBXbNsTkT9cyMd4g_61.p->data[(NI)((NI32)((NI)(n & ((NI) 240))) >> (NU32)(((NI) 4)))]);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		i = (NI)0;
		colontmp_ = (NI)0;
		colontmp_ = paramCount__pureZos_1858();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		res = ((NI) 1);
		{
			while (1) {
...
{	result.len = 0; result.p = NIM_NIL;
	env = getenv(nimToCStringConv(key));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = eqeq___system_7522(env, ((NCSTRING) NIM_NIL));
		if (!T3_) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		LA13_: ;
		{
			...
			colontmp__5 = substr__system_7554(path, ((NI) 2));
			if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = paramStr__pureZos_1849(((NI) 0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmp_ = (NIM_BOOL)0;
	{
		...
		if (!colontmp_) goto LA8_;
		{
			...
			splitsX60gensym36_ = ((NI) -1);
			{
				while (1) {
					...
					LA32_: ;
					colontmp__4 = substr__system_7542(colontmp__2, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI) 1)));
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = getApplAux__pureZos_1875(TM__yu6cxgKBBXbNsTkT9cyMd4g_84);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2 colontmp_;
		if (!(result.len == ((NI) 0))) goto LA3_;
		colontmp_ = getApplHeuristic__pureZos_1879();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqsink___system_3234((&result), colontmp_);
	}
	LA3_: ;
...
appendString((&T7_), colontmp_);
		...
		T11_.len = 0; T11_.p = NIM_NIL;
		colontmp__5 = substr__system_7542(filename, ((NI) 0), (NI)(extPos - ((NI) 1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI) -1);
		{
			while (1) {
				...
				LA44_: ;
				colontmp__3 = substr__system_7542(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
...
{	result = (NIM_BOOL)0;
	...
	T2_ = (NIM_BOOL)0;
	T2_ = eqeq___system_7522(T1_, ((NCSTRING) NIM_NIL));
	result = !(T2_);
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	rawRemoveDir__pureZos_1719(dir);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, tryMoveFSObject__pureZos_1266)(NimStringV2 source, NimStringV2 dest, NIM_BOOL isDir) {
