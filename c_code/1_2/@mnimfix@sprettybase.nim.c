...
N_LIB_PRIVATE N_NIMCALL(void, replaceDeprecated_nimfixZprettybase_8)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA* oldSym, tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA* newSym);
...
{	line = sourceLine_msgs_1100(conf, info);
	...
	LA15_: ;
	T17_ = (NI)0;
	T17_ = identLen_linter_11(line, first);
	last = (NI)((NI)(first + T17_) - ((NI) 1));
	{
		...
		NimStringDesc* T26_;
		NimStringDesc* T27_;
		T20_ = dotdot__pureZunicode_840(first, last);
		T21_ = (NimStringDesc*)0;
		T21_ = X5BX5D__pureZunicode_865(line, T20_);
		T22_ = (NI)0;
		T22_ = nsuCmpIgnoreStyle(T21_, (*oldSym).s);
		if (!(T22_ == ((NI) 0))) goto LA23_;
		T25_ = (NimStringDesc*)0;
		T26_ = (NimStringDesc*)0;
		T26_ = substr_system_7809(line, ((NI) 0), (NI)(first - ((NI) 1)));
		T27_ = (NimStringDesc*)0;
		T27_ = substr_system_7821(line, (NI)(last + ((NI) 1)));
...
N_LIB_PRIVATE N_NIMCALL(void, replaceDeprecated_nimfixZprettybase_47)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* oldSym, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* newSym) {
	replaceDeprecated_nimfixZprettybase_8(conf, info, (*oldSym).name, (*newSym).name);
}
