...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isSlash_pureZpathnorm_67)(NimStringDesc* x, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ bounds);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_LIB_PRIVATE N_NIMCALL(void, unsureAsgnRef)(void** dest, void* src);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDotDot_pureZpathnorm_63)(NimStringDesc* x, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ bounds);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isDot_pureZpathnorm_59)(NimStringDesc* x, tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ bounds);
...
N_LIB_PRIVATE N_NIMCALL(tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ, next_pureZpathnorm_10)(tyObject_PathIter__tllF14xUpDWpqG9ci5sg9bMg* it, NimStringDesc* x) {
	...
	LA24_: ;
	{
		NIM_BOOL T27_;
		T27_ = (NIM_BOOL)0;
		T27_ = hasNext_pureZpathnorm_6((*it), x);
		if (!T27_) goto LA28_;
	...
	LA3_: ;
	{
		while (1) {
			...
			b = next_pureZpathnorm_10((&it), x);
			{
				...
				if (!(T14_)) goto LA15_;
				T14_ = isSlash_pureZpathnorm_67(x, b);
				LA15_: ;
				if (!T14_) goto LA16_;
				{
					NIM_BOOL T20_;
					...
					if (T20_) goto LA21_;
					T20_ = !((((NU8)((*result)->data[(NI)(((*result) ? (*result)->Sup.len : 0) - ((NI) 1))])) == ((NU8)(92)) || ((NU8)((*result)->data[(NI)(((*result) ? (*result)->Sup.len : 0) - ((NI) 1))])) == ((NU8)(47))));
					LA21_: ;
					if (!T20_) goto LA22_;
			...
			LA16_: ;
			{
				NIM_BOOL T25_;
				T25_ = (NIM_BOOL)0;
				T25_ = isDotDot_pureZpathnorm_63(x, b);
				if (!T25_) goto LA26_;
				{
					NI d;
					...
					d = ((*result) ? (*result)->Sup.len : 0);
					{
						while (1) {
							...
							if (!(T34_)) goto LA35_;
							T34_ = !((((NU8)((*result)->data[(NI)(d - ((NI) 1))])) == ((NU8)(92)) || ((NU8)((*result)->data[(NI)(d - ((NI) 1))])) == ((NU8)(47))));
							LA35_: ;
							if (!T34_) goto LA33;
							d -= ((NI) 1);
						} LA33: ;
				...
				LA30_: ;
				{
					NimStringDesc* T47_;
					{
						...
						if (!(T43_)) goto LA44_;
						T43_ = !((((NU8)((*result)->data[(NI)(((*result) ? (*result)->Sup.len : 0) - ((NI) 1))])) == ((NU8)(92)) || ((NU8)((*result)->data[(NI)(((*result) ? (*result)->Sup.len : 0) - ((NI) 1))])) == ((NU8)(47))));
						LA44_: ;
						if (!T43_) goto LA45_;
						unsureAsgnRef((void**) (&(*result)), addChar((*result), dirSep));
					}
					...
					T47_ = substr_system_7809(x, b.Field0, b.Field1);
...
appendString((*result), T47_);
			...
			LA26_: ;
			{
				NIM_BOOL T49_;
				T49_ = (NIM_BOOL)0;
				T49_ = isDot_pureZpathnorm_59(x, b);
				if (!T49_) goto LA50_;
			}
			goto LA12_;
			LA50_: ;
			{
				...
				if (!(b.Field0 <= b.Field1)) goto LA53_;
				{
					...
					if (!(T57_)) goto LA58_;
					T57_ = !((((NU8)((*result)->data[(NI)(((*result) ? (*result)->Sup.len : 0) - ((NI) 1))])) == ((NU8)(92)) || ((NU8)((*result)->data[(NI)(((*result) ? (*result)->Sup.len : 0) - ((NI) 1))])) == ((NU8)(47))));
					LA58_: ;
					if (!T57_) goto LA59_;
					unsureAsgnRef((void**) (&(*result)), addChar((*result), dirSep));
				}
				...
				T61_ = substr_system_7809(x, b.Field0, b.Field1);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, normalizePath_pureZpathnorm_131)(NimStringDesc* path, NIM_CHAR dirSep) {
	...
	state = ((NI) 0);
	addNormalizePath_pureZpathnorm_75(path, (&result), (&state), dirSep);
	return result;
}
