...
N_LIB_PRIVATE N_NOINLINE(void, invalidFormatString_pureZstrutils_2142)(void);
...
N_LIB_PRIVATE N_NIMCALL(NI, findNormalized_pureZstrutils_2130)(NimStringDesc* x, NimStringDesc** inArray, NI inArrayLen_0);
...
static N_INLINE(void, X5BX5Deq__system_7442)(NimStringDesc** s, NI i, NIM_CHAR x);
				...
				{
					{
						...
						invalidFormatString_pureZstrutils_2142();
					}
					LA12_: ;
...
appendString((*s), a[idx_2]);
					...
					LA55_: ;
					{
						...
						T69_ = substr_system_7809(formatstr, (NI)(i + ((NI) 2)), (NI)(j_2 - ((NI) 1)));
						x = findNormalized_pureZstrutils_2130(T69_, a, aLen_0);
						{
							NIM_BOOL T72_;
							T72_ = (NIM_BOOL)0;
							T72_ = (((NI) 0) <= x);
...
appendString((*s), a[(NI)(x + ((NI) 1))]);
				...
				case 95:
				{
					...
					T82_ = substr_system_7809(formatstr, (NI)(i + ((NI) 1)), (NI)(j_3 - ((NI) 1)));
					x_2 = findNormalized_pureZstrutils_2130(T82_, a, aLen_0);
					{
						NIM_BOOL T85_;
						T85_ = (NIM_BOOL)0;
						T85_ = (((NI) 0) <= x_2);
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym34_ = maxsplit;
		{
			while (1) {
				...
				LA10_: ;
				xX60gensym67_ = substr_system_7809(s, firstX60gensym34_, (NI)(lastX60gensym34_ - ((NI) 1)));
	...
	result = NIM_NIL;
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA26_: ;
				xX60gensym76_ = substr_system_7809(s, first, T25_);
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T31_ = result->Sup.len++;
	...
	LA3_: ;
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				T14_ = substr_system_7809(s, i, (NI)(j - ((NI) 1)));
	...
	LA6_: ;
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				T23_ = substr_system_7809(s, i_2, (NI)(j_2 - ((NI) 1)));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuStrip)(NimStringDesc* s, NIM_BOOL leading, NIM_BOOL trailing, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw chars) {
	...
	LA11_: ;
	result = substr_system_7809(s, first, last);
	return result;
}
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym41_ = maxsplit;
		{
			while (1) {
				...
				LA15_: ;
				xX60gensym72_ = substr_system_7809(s, firstX60gensym41_, (NI)(lastX60gensym41_ - ((NI) 1)));
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T17_ = result->Sup.len++;
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA26_: ;
				line = substr_system_7809(s, first, T25_);
				{
...
N_LIB_PRIVATE N_NIMCALL(NI, indentation_pureZstrutils_1194)(NimStringDesc* s) {
	...
	{
		if (!(((NI) (result)) == ((NI) IL64(9223372036854775807)))) goto LA47_;
		result = ((NI) 0);
	}
	LA47_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f, tyEnum_FloatFormatMode__pNvEoaqwoxKyoASD11vSgQ format, NI precision, NIM_CHAR decimalSep) {
	...
	}
	{
		...
		if (!(T17_)) goto LA18_;
		T19_ = (NIM_CHAR*)0;
		T19_ = X5BX5D__system_7427((&result), ((NI) 4));
		T17_ = ((NU8)((*T19_)) == (NU8)(43));
		LA18_: ;
		T16_ = T17_;
		if (!(T16_)) goto LA20_;
		T21_ = (NIM_CHAR*)0;
		T21_ = X5BX5D__system_7427((&result), ((NI) 3));
		T16_ = ((NU8)((*T21_)) == (NU8)(48));
		LA20_: ;
		if (!T16_) goto LA22_;
		T24_ = (NIM_CHAR*)0;
		T24_ = X5BX5D__system_7427((&result), ((NI) 2));
		X5BX5Deq__system_7442((&result), ((NI) 3), (*T24_));
		T25_ = (NIM_CHAR*)0;
		T25_ = X5BX5D__system_7427((&result), ((NI) 1));
		X5BX5Deq__system_7442((&result), ((NI) 2), (*T25_));
