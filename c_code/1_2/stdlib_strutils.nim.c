...
{nimErr_ = nimErrorFlag();
	...
	LA18_: ;
	result = substr__system_7617(s, first, last);
					...
					} LA10: ;
					{
						...
						case 123:
						{
							...
							}
							{
								...
								frag._kind_1.text = substr__system_7617(formatstr, (NI)(i + ((NI) 2)), (NI)(j_2 - ((NI) 1)));
						...
						case 95:
						{
							...
							frag._kind_1.text = substr__system_7617(formatstr, (NI)(i + ((NI) 1)), (NI)(j_3 - ((NI) 1)));
							if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
							switch (frag.kind) {
							case ((tyEnum_AddfFragmentKind__ronT8Vymtn9bA40zcNgDiHg) 0):
							case ((tyEnum_AddfFragmentKind__ronT8Vymtn9bA40zcNgDiHg) 5):
		...
		LA4_: ;
		{
			...
			i = ((NI) 0);
			{
				while (1) {
					...
					LA15_: ;
					colontmp__2 = substr__system_7617(s, i, (NI)(j - ((NI) 1)));
					if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
...
appendString((&result), by);
			...
			colontmp__3 = substr__system_7629(s, i);
			if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
...
appendString((&result), colontmp_);
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				LA23_: ;
				colontmp__5 = substr__system_7617(s, i_2, (NI)(j_2 - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&result), by);
		...
		colontmp__4 = substr__system_7629(s, i_2);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		splitsX60gensym33_ = maxsplit;
		{
			while (1) {
				...
				LA21_: ;
				xX60gensym66_ = substr__system_7617(s, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				xX60gensym75_ = substr__system_7617(s, first, colontmp_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				colontmp__5 = substr__system_7617(s, first, colontmp_);
	...
	result = ((NI) IL64(9223372036854775807));
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				colontmp__4 = substr__system_7617(s, first, colontmp_);
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmp_ = substr__system_7629(s, ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmp__2 = (NIM_BOOL)0;
	{
		NIM_CHAR* T29_;
		{
			...
			LA22_: ;
			T24_ = (NIM_CHAR*)0;
			T24_ = X5BX5D___system_7246((&result), ((NI) 4));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		LA27_: ;
		T29_ = (NIM_CHAR*)0;
		T29_ = X5BX5D___system_7246((&result), ((NI) 3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	} LA18: ;
	{
		...
		T34_ = (NIM_CHAR*)0;
		T34_ = X5BX5D___system_7246((&result), ((NI) 2));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		X5BX5Deq___system_7261((&result), ((NI) 3), (*T34_));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T35_ = (NIM_CHAR*)0;
		T35_ = X5BX5D___system_7246((&result), ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		X5BX5Deq___system_7261((&result), ((NI) 2), (*T35_));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
