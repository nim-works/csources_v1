...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, absolutePath__pureZos_1012)(NimStringV2 path, NimStringV2 root);
...
N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__BeJgrOdDsczOwEWOZbRfKA*, newOSError__pureZos_467)(NI32 errorCode, NimStringV2 additionalInfo);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__pureZos_1809)(NimStringV2 dir);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, dollar___pureZos_562)(tyTuple__UV3llMMYFckfui8YMBuUZA* x);
...
N_LIB_PRIVATE N_NIMCALL(int, exitStatusLikeShell__pureZos_1424)(int status);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__pureZos_1800)(NimStringV2 dir);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, tryMoveFSObject__pureZos_1403)(NimStringV2 source, NimStringV2 dest, NIM_BOOL isDir);
...
N_LIB_PRIVATE NIM_CONST tyArray__bgvsW9aAZ5OyR9ctiSVMMiLA ExeExts__pureZos_953 = {{3, (NimStrPayload*)&TM__yu6cxgKBBXbNsTkT9cyMd4g_109},
...
N_LIB_PRIVATE tySequence__sM4lkSb7zS6F7OVMvW9cffQ ownArgv__pureZos_1942;
N_LIB_PRIVATE NIM_BOOL ownParsedArgv__pureZos_1943;
	...
	{
		{
			...
			LA5_: ;
			T7_ = (NIM_CHAR)0;
			T7_ = X5BX5D___system_7207(tail, ((NI) 1));
		...
		LA10_: ;
		{
			...
			LA15_: ;
			{
				...
				LA20_: ;
				T22_ = (NIM_CHAR*)0;
				T22_ = X5BX5D___system_7246(result, ((NI) 1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	{
		{
			...
			T24_ = substr__system_7617(path, ((NI) 0), colontmp__2);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			result.Field0 = T24_;
			T25_.len = 0; T25_.p = NIM_NIL;
			T25_ = substr__system_7629(path, (NI)(sepPos + ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			result.Field1 = T25_;
			goto LA13;
		}
				...
				i = res;
				{
					...
					} LA9: ;
					{
						if (!colontmp__6) goto LA16_;
						{
							...
							T28_ = substr__system_7617(path, ((NI) 0), colontmp__7);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							result.Field0 = T28_;
							namePos = (NI)(i + ((NI) 1));
						}
						LA20_: ;
						{
							NimStringV2 T36_;
							{
								...
								T34_ = substr__system_7617(path, namePos, (NI)(dotPos - ((NI) 1)));
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								result.Field1 = T34_;
								T35_.len = 0; T35_.p = NIM_NIL;
								T35_ = substr__system_7629(path, dotPos);
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								result.Field2 = T35_;
								goto LA29;
							}
							...
							T36_ = substr__system_7629(path, namePos);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							result.Field1 = T36_;
						} LA29: ;
						goto LA1;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3232(colontmp_, colontmp__2);
	{
		...
		colontmp__3 = (NIM_BOOL)0;
		{
			...
			LA9_: ;
			T11_ = (NIM_CHAR*)0;
			T11_ = X5BX5D___system_7246((&(*e).Sup.Sup.message), ((NI) 1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = newOSError__pureZos_467(errorCode, additionalInfo);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			{
				{
					...
					T10_ = (NI32)0;
					T10_ = osLastError__pureZos_515();
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					raiseOSError__pureZos_512(T10_, TM__yu6cxgKBBXbNsTkT9cyMd4g_18);
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					goto LA5;
				}
				LA8_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmp_ = colontmp__2;
	result = absolutePath__pureZos_1012(path, colontmp_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
		...
		while (1) {
			{
				...
				colontmp__11 = (NIM_BOOL)0;
				{
					...
					LA85_: ;
					T87_ = (NIM_CHAR*)0;
					T87_ = X5BX5D___system_7246((&result), ((NI) 1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		while (1) {
			{
				...
				colontmp__12 = (NIM_BOOL)0;
				{
					...
					LA106_: ;
					T108_ = (NIM_CHAR*)0;
					T108_ = X5BX5D___system_7246((&result), ((NI) 1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL colontmp__4;
		{
			...
			colontmp__3 = substr__system_7617(result, ((NI) 0), sepPos);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		colontmp__4 = (NIM_BOOL)0;
		{
			...
			LA19_: ;
			T21_ = (NIM_CHAR*)0;
			T21_ = X5BX5D___system_7246((&result), ((NI) 1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__pureZos_1809(dir);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	{
		if (!result) goto LA4_;
...
{nimErr_ = nimErrorFlag();
			...
			while (1) {
				...
				i = res;
				{
					if (!(((NU8)(dir.p->data[i])) == ((NU8)(92)) || ((NU8)(dir.p->data[i])) == ((NU8)(47)))) goto LA10_;
					{
						...
						colontmp__4 = substr__system_7617(dir, ((NI) 0), (NI)(i - ((NI) 1)));
	...
	colontmp__5 = (NIM_BOOL)0;
	{
		...
		LA29_: ;
		T31_ = (NIM_CHAR)0;
		T31_ = X5BX5D___system_7207(dir, ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&(*s)), TM__yu6cxgKBBXbNsTkT9cyMd4g_57);
		n = ((NU8)(c));
		nimAddCharV1((&(*s)), TM__yu6cxgKBBXbNsTkT9cyMd4g_59.p->data[(NI)((NI64)((NI)(n & ((NI) 240))) >> (NU64)(((NI) 4)))]);
				...
				{
					{
						...
						addEscapedChar__system_7331(s, c);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						goto LA8;
					}
					LA11_: ;
...
{nimErr_ = nimErrorFlag();
	result = (NI)0;
	{
		...
		NimStringV2 colontmp__3;
		NI16* T6_;
		if (!!(ownParsedArgv__pureZos_1943)) goto LA3_;
		colontmp_.len = 0; colontmp_.p = NIM_NIL;
		T6_ = (NI16*)0;
		T6_ = Dl_1241514266_();
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
		eqsink___system_3730((&ownArgv__pureZos_1942), colontmp__2);
		ownParsedArgv__pureZos_1943 = NIM_TRUE;
		{
			LA5_:;
		}
		{
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	{
		...
		{
			NI T11_;
			T11_ = ownArgv__pureZos_1942.len;
			colontmp__4 = (i < T11_);
			{
		...
		} LA10: ;
		{
			...
			colontmp__5 = (&ownArgv__pureZos_1942.p->data[i]);
		...
		(*T20_).Sup.Sup.name = "IndexDefect";
		{
			...
			{
				NI T24_;
				T24_ = ownArgv__pureZos_1942.len;
			...
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T28_ = ownArgv__pureZos_1942.len;
...
{	result.len = 0; result.p = NIM_NIL;
	env = getenv(nimToCStringConv(key));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = eqeq___system_7597(env, ((NCSTRING) NIM_NIL));
		if (!T3_) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmp__2 = getEnv__pureZos_524(TM__yu6cxgKBBXbNsTkT9cyMd4g_85, TM__yu6cxgKBBXbNsTkT9cyMd4g_86);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmp_ = colontmp__2;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		LA13_: ;
		{
			...
			colontmp__5 = substr__system_7629(path, ((NI) 2));
			if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
...
{nimErr_ = nimErrorFlag();
			...
			{
				{
					...
					T12_ = (NI32)0;
					T12_ = osLastError__pureZos_515();
					if (NIM_UNLIKELY(*nimErr_)) goto LA4_;
					raiseOSError__pureZos_512(T12_, filename);
					if (NIM_UNLIKELY(*nimErr_)) goto LA4_;
					goto LA7;
				}
				LA10_: ;
	...
	} LA2: ;
	{
		...
		resX60gensym151_ = findFirstFile__pureZos_912(result, (&fX60gensym151_));
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
			{
				while (1) {
					...
					colontmp__4 = (NIM_BOOL)0;
					{
						NIM_BOOL T28_;
						T28_ = (NIM_BOOL)0;
						T28_ = skipFindData__pureZos_922((&fX60gensym151_));
						if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
						colontmp__4 = !(T28_);
						{
					...
					LA35_: ;
					{
						...
						errCodeX60gensym151_ = Dl_1241514154_();
						{
							...
							LA85_: ;
							raiseOSError__pureZos_512(errCodeX60gensym151_, TM__yu6cxgKBBXbNsTkT9cyMd4g_89);
							if (NIM_UNLIKELY(*nimErr_)) goto LA24_;
						}
					}
					LA80_: ;
...
appendString((&T7_), colontmp_);
		...
		T11_.len = 0; T11_.p = NIM_NIL;
		colontmp__5 = substr__system_7617(filename, ((NI) 0), (NI)(extPos - ((NI) 1)));
...
appendString((&result), TM__yu6cxgKBBXbNsTkT9cyMd4g_100);
	...
	LA7_: ;
	count += ((NI) 1);
	addQuoted__pureZos_582((&result), (*x).Field1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
...
{nimErr_ = nimErrorFlag();
	colontmp_ = (NIM_BOOL)0;
	{
		...
		LA5_: ;
		colontmp_ = contains__pureZos_535(key.p->data, key.len, 61);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	} LA2: ;
	{
		NimStringV2 colontmp__2;
		...
		T14_.Field0 = key;
		T14_.Field1 = val;
		colontmp__3 = dollar___pureZos_562((&T14_));
...
appendString((&T13_), colontmp__2);
	...
	LA9_: ;
	{
		...
		T24_.Field0 = key;
		T24_.Field1 = val;
		colontmp__5 = dollar___pureZos_562((&T24_));
		if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		colontmp__4 = colontmp__5;
		raiseOSError__pureZos_512(T23_, colontmp__4);
		if (NIM_UNLIKELY(*nimErr_)) goto LA22_;
		{
			LA22_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	path = getEnv__pureZos_524(TM__yu6cxgKBBXbNsTkT9cyMd4g_106, TM__yu6cxgKBBXbNsTkT9cyMd4g_107);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI) -1);
		{
			while (1) {
				...
				LA39_: ;
				colontmp__3 = substr__system_7617(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
					...
					{
						{
							...
							LA51_: ;
							T53_ = (NIM_CHAR)0;
							T53_ = X5BX5D___system_7207(candidate, ((NI) 1));
							if (NIM_UNLIKELY(*nimErr_)) goto LA42_;
							colontmp__4 = ((NU8)(T53_) == (NU8)(34));
						} LA48: ;
						{
							if (!colontmp__4) goto LA56_;
							colontmp__5 = substr__system_7617(candidate, ((NI) 1), (NI)(candidate.len - ((NI) 2)));
							if (NIM_UNLIKELY(*nimErr_)) goto LA42_;
							goto LA47;
						}
						LA56_: ;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = getEnv__pureZos_524(TM__yu6cxgKBBXbNsTkT9cyMd4g_113, TM__yu6cxgKBBXbNsTkT9cyMd4g_114);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{	result = (NIM_BOOL)0;
	...
	T2_ = (NIM_BOOL)0;
	T2_ = eqeq___system_7597(T1_, ((NCSTRING) NIM_NIL));
	result = !(T2_);
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
...
appendString((&T13_), TM__yu6cxgKBBXbNsTkT9cyMd4g_117);
	envToDel = T13_;
	{
		...
		T19_ = (NI32)0;
		T19_ = osLastError__pureZos_515();
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		raiseOSError__pureZos_512(T19_, key);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA17_: ;
	{
...
{nimErr_ = nimErrorFlag();
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__pureZos_512(T6_, file);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	h = findFirstFile__pureZos_912(file, (&f));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NI32 T5_;
		if (!(h == ((NI) -1))) goto LA3_;
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__pureZos_512(T5_, file);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	T6_ = (NI64)0;
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___pureZos_682)(tySequence__4eQHGndY6XBYpFOH09apV8Q* dest, tySequence__4eQHGndY6XBYpFOH09apV8Q src) {
	if ((*dest).p != src.p) {	eqdestroy___pureZos_676(dest);
	}
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = (int)0;
	T2_ = exitStatusLikeShell__pureZos_1424(T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = ((NI) (T2_));
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		T29_.Field0 = source;
		T29_.Field1 = dest;
		colontmp__4 = dollar___pureZos_562((&T29_));
		if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
		colontmp__3 = colontmp__4;
		raiseOSError__pureZos_512(T28_, colontmp__3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA27_;
		{
			LA27_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	} LA3: ;
	{
		...
		raiseOSError__pureZos_512(lastError, dir);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
	LA20_: ;
	{
...
{nimErr_ = nimErrorFlag();
		...
		{
			{
				if (!(h == ((NI) -1))) goto LA6_;
				{
					...
					T12_ = osLastError__pureZos_515();
					if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
					raiseOSError__pureZos_512(T12_, dir);
					if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
				}
				LA10_: ;
				goto LA3;
			...
			LA6_: ;
			{
				while (1) {
					...
					k = ((tyEnum_PathComponent__9c1SIU9cO1wHcl09b703A9cDrg) 0);
					{
						...
						NimStringV2 xx;
						T18_ = (NIM_BOOL)0;
						T18_ = skipFindData__pureZos_922((&f));
					...
					LA19_: ;
					{
						...
						errCode = Dl_1241514154_();
						{
							...
							LA49_: ;
							raiseOSError__pureZos_512(errCode, TM__yu6cxgKBBXbNsTkT9cyMd4g_122);
							if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
						}
					}
					LA44_: ;
	...
	rawRemoveDir__pureZos_1800(dir);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, tryMoveFSObject__pureZos_1403)(NimStringV2 source, NimStringV2 dest, NIM_BOOL isDir) {
...
{nimErr_ = nimErrorFlag();
	...
	result = !((T4_ == ((NI32) 0)));
	{
		...
		isAccessDeniedError = colontmp_;
		{
			...
			T19_.Field0 = source;
			T19_.Field1 = dest;
			colontmp__3 = dollar___pureZos_562((&T19_));
			if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
			colontmp__2 = colontmp__3;
			raiseOSError__pureZos_512(err, colontmp__2);
			if (NIM_UNLIKELY(*nimErr_)) goto LA18_;
			{
				LA18_:;
			}
...
{nimErr_ = nimErrorFlag();
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = tryMoveFSObject__pureZos_1403(source, dest, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		{
		...
		{
			{
				if (!(h == ((NI) -1))) goto LA6_;
				{
					...
					T12_ = osLastError__pureZos_515();
					if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
					raiseOSError__pureZos_512(T12_, source);
					if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
				}
				LA10_: ;
				goto LA3;
				...
				while (1) {
					...
					LA19_: ;
					{
						...
						errCode = Dl_1241514154_();
						{
							...
							LA59_: ;
							raiseOSError__pureZos_512(errCode, TM__yu6cxgKBBXbNsTkT9cyMd4g_126);
							if (NIM_UNLIKELY(*nimErr_)) goto LA13_;
						}
					}
					LA54_: ;
...
{nimErr_ = nimErrorFlag();
	...
	colontmp__2.len = 0; colontmp__2.p = NIM_NIL;
	{
		...
		T4_ = (NIM_BOOL)0;
		T4_ = tryMoveFSObject__pureZos_1403(colontmp_, colontmp__2, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!!(T4_)) goto LA5_;
