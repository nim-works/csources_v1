...
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*, llStreamOpen_llstream_69)(NimStringDesc* filename, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode) {
	...
	(*result).kind = ((tyEnum_TLLStreamKind__jVcKY16LbOamXE9bxXUD6pQ) 2);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open_systemZio_487(&(*result).f, filename, mode, ((NI) -1));
		if (!!(T3_)) goto LA4_;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, llStreamReadLine_llstream_194)(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* s, NimStringDesc** line) {
	...
	case ((tyEnum_TLLStreamKind__jVcKY16LbOamXE9bxXUD6pQ) 2):
	{
		result = readLine_systemZio_276((*s).f, line);
	}
	break;
	case ((tyEnum_TLLStreamKind__jVcKY16LbOamXE9bxXUD6pQ) 3):
	{
		result = readLine_systemZio_276(stdin, line);
	}
	break;
	}
	return result;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, readLineFromStdin_llstream_112)(NimStringDesc* prompt, NimStringDesc** line) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
	write_systemZio_220(stdout, prompt);
	result = readLine_systemZio_276(stdin, line);
	{
		if (!!(result)) goto LA3_;
		write_systemZio_220(stdout, ((NimStringDesc*) &TM__ml9aueblxGz9aYsRLKvPmpow_11));
		exit(((NI) 0));
	}
	LA3_: ;
	return result;
