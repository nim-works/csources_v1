						...
						{
							{
								...
								xX60gensym15_ = inst;
								xX60gensym16_ = key;
								if (!((NI)((NI)((NU64)(((NI) ((*xX60gensym15_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym15_).Sup.itemId.item))) == (NI)((NI)((NU64)(((NI) ((*xX60gensym16_).Sup.itemId.module))) << (NU64)(((NI) 24))) + ((NI) ((*xX60gensym16_).Sup.itemId.item))))) goto LA20_;
								result = inst;
								goto BeforeRet_;
							}
							LA20_: ;
							...
							LA26_: ;
							{
								NIM_BOOL T30_;
								T30_ = (NIM_BOOL)0;
								T30_ = sameFlags_types_2225(inst, key);
								if (!!(T30_)) goto LA31_;
								goto LA17;
							}
							LA31_: ;
									...
									res = ((NI) 1);
									{
										while (1) {
											...
											j = res;
											{
												NIM_BOOL T40_;
												T40_ = (NIM_BOOL)0;
												T40_ = compareTypes_types_2668((*inst).sons->data[j], (*key).sons->data[j], ((tyEnum_TDistinctCompare__9bNKHGs63atuMFXnAleTveg) 0), 136);
												if (!!(T40_)) goto LA41_;
												goto LA33;
											}
											LA41_: ;
...
{	result = (tyObject_TType__facALICuu8zUj0hjvbTLFg*)0;
	...
	LA5_: ;
	{
		...
		if (!(T13_)) goto LA14_;
		T13_ = sameFlags_types_2225(result, t);
		LA14_: ;
		if (!T13_) goto LA15_;
		goto BeforeRet_;
	}
	...
	}
	{
		...
		result = searchInstTypes_semtypinst_44((*(*cl).c).graph, header);
		{
			...
			if (!(T39_)) goto LA40_;
			T39_ = sameFlags_types_2225(result, t);
			LA40_: ;
			if (!T39_) goto LA41_;
			goto BeforeRet_;
		}
	...
	unsureAsgnRef((void**) (&(*cl).typeMap), (*(*cl).typeMap).nextLayer);
	{
		NIM_BOOL T69_;
		T69_ = (NIM_BOOL)0;
		T69_ = isGenericAlias_types_2205(newbody);
		if (!T69_) goto LA70_;
		newbody = skipGenericAlias_types_2219(newbody);
	}
	LA70_: ;
	...
	{
		{
			NIM_BOOL T80_;
			T80_ = (NIM_BOOL)0;
			T80_ = containsGenericType_types_3357(t);
			if (!T80_) goto LA81_;
			{
				RootObj* T87_;
...
appendString(T109_, ((NimStringDesc*) &TM__mrkrD9c2e31kE4GdQtpMdaQ_14));
			...
			case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 16):
			{
				...
				idx = (*result).sons->data[((NI) 0)];
				{
					...
					internalErrorImpl_msgs_1430((*(*(*cl).c).graph).config, unknownLineInfo_lineinfos_280, argX60gensym191_, TM__mrkrD9c2e31kE4GdQtpMdaQ_25);
				}
				LA128_: ;
			}
			break;
...
N_LIB_PRIVATE N_NIMCALL(void, checkConstructedType_semtypinst_26)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_TType__facALICuu8zUj0hjvbTLFg* typ) {
	...
	LA8_: ;
	{
		...
		T11_ = (NIM_BOOL)0;
		T12_ = (NI64)0;
		T12_ = computeSize_types_3314(conf, t);
		T11_ = (T12_ == IL64(-2));
		if (T11_) goto LA13_;
		T11_ = isTupleRecursive_types_3993(t);
		LA13_: ;
		if (!T11_) goto LA14_;
