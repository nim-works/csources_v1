...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, genEnumToStrProc_enumtostr_6)(tyObject_TType__facALICuu8zUj0hjvbTLFg* t, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info, tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen) {
	...
	T1_ = getIdent_idents_143((*g).cache, ((NimStringDesc*) &TM__9blBcbGJiuHeZYvK9bRrqffg_2));
	T2_ = nextSymId_ast_3131(idgen);
	result = newSym_ast_3444(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 12), T1_, T2_, (*t).owner, info, 0);
	T3_ = (tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA*)0;
	T3_ = getIdent_idents_143((*g).cache, ((NimStringDesc*) &TM__9blBcbGJiuHeZYvK9bRrqffg_3));
	T4_ = nextSymId_ast_3131(idgen);
	dest = newSym_ast_3444(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 3), T3_, T4_, result, info, 0);
	asgnRef((void**) (&(*dest).typ), t);
	T5_ = (tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA*)0;
	T5_ = getIdent_idents_143((*g).cache, ((NimStringDesc*) &TM__9blBcbGJiuHeZYvK9bRrqffg_4));
	T6_ = nextSymId_ast_3131(idgen);
	res = newSym_ast_3444(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 11), T5_, T6_, result, info, 0);
	asgnRef((void**) (&(*res).typ), getSysType_magicsys_60(g, info, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 28)));
	T7_ = nextTypeId_ast_3150(idgen);
	asgnRef((void**) (&(*result).typ), newType_ast_3895(((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 25), T7_, (*t).owner));
	asgnRef((void**) (&(*(*result).typ).n), newNodeI_ast_3355(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 76), info));
	rawAddSon_ast_4287((*result).typ, (*res).typ, NIM_TRUE);
	T8_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T8_ = newNodeI_ast_3355(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 152), info);
	add_ast_4796((*(*result).typ).n, T8_);
	addParam_ast_5064((*result).typ, dest);
	body = newNodeI_ast_3355(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), info);
	caseStmt = newNodeI_ast_3355(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 97), info);
	T9_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T9_ = newSymNode_ast_3715(dest);
	add_ast_4796(caseStmt, T9_);
	{
		NI i;
		NI colontmp_;
		NI i_2;
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				tyArray__AB6yfoUgfWM2NtGe9bzkCmw T20_;
				tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* T21_;
				if (!(i_2 < colontmp_)) goto LA12;
				i = i_2;
				field = (*(*(*t).n)._kind_6.sons->data[i])._kind_4.sym;
				{
					if (!((*field).ast == ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL))) goto LA15_;
					val = (*(*field).name).s;
				}
				goto LA13_;
				LA15_: ;
				{
					val = (*(*field).ast)._kind_3.strVal;
				}
				LA13_: ;
				nimZeroMem((void*)T18_, sizeof(tyArray__AB6yfoUgfWM2NtGe9bzkCmw));
				T18_[0] = newSymNode_ast_3715(field);
				nimZeroMem((void*)T19_, sizeof(tyArray__jlWPjgtbdjE069arIWHC9c9bg));
				nimZeroMem((void*)T20_, sizeof(tyArray__AB6yfoUgfWM2NtGe9bzkCmw));
				T20_[0] = newSymNode_ast_3715(res);
				T20_[1] = newStrNode_ast_3816(val, info);
				T19_[0] = newTree_ast_3391(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 74), T20_, 2);
				T18_[1] = newTree_ast_3391(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 115), T19_, 1);
				T21_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
				T21_ = newTree_ast_3391(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 85), T18_, 2);
				add_ast_4796(caseStmt, T21_);
				i_2 += ((NI) 1);
			} LA12: ;
		}
	}
	add_ast_4796(body, caseStmt);
	n = newNodeI_ast_3359(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 79), info, ((NI) 8));
	{
		NI i_3;
		NI colontmp__2;
		NI i_4;
		...
		i_4 = ((NI) 0);
		{
			while (1) {
				...
				i_3 = i_4;
				asgnRef((void**) (&(*n)._kind_6.sons->data[i_3]), newNodeI_ast_3355(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 1), info));
				i_4 += ((NI) 1);
			} LA24: ;
		}
	}
	...
	asgnRef((void**) (&(*n)._kind_6.sons->data[((NI) 6)]), body);
	asgnRef((void**) (&(*n)._kind_6.sons->data[((NI) 7)]), newSymNode_ast_3715(res));
