...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		} LA3: ;
		{
			...
			prefix = substr__system_7617(s, ((NI) 0), (NI)(le - ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
			suffix = substr__system_7629(s, (NI)(ri + ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA12_;
			{
				NimStringV2 middle;
				...
				colontmp__2 = substr__system_7617(s, (NI)(le + ((NI) 1)), (NI)(ri - ((NI) 1)));
				...
				splitsX60gensym33_ = ((NI) -1);
				{
					while (1) {
						...
						LA34_: ;
						colontmp__4 = substr__system_7617(colontmp__2, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
						if (NIM_UNLIKELY(*nimErr_)) goto LA14_;
