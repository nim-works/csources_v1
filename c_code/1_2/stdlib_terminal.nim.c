...
static N_INLINE(tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og*, getTerminal_pureZterminal_26)(void);
N_LIB_PRIVATE N_NIMCALL(tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og*, newTerminal_pureZterminal_16)(void);
N_LIB_PRIVATE N_NOINLINE(void*, newObj)(TNimType* typ, NI size);
N_LIB_PRIVATE N_NIMCALL(void, initTerminal_pureZterminal_191)(tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og* term);
...
N_LIB_PRIVATE N_NIMCALL(NI16, getAttributes_pureZterminal_187)(NI h);
...
N_LIB_PRIVATE NIM_CONST tyArray__e7dTfxuKO1YfQGLA3anCHg lookup_pureZterminal_515 = {((NI) 0),
((NI) 4),
((NI) 2),
((NI) 6),
((NI) 1),
...
((NI) 0)}
;
N_LIB_PRIVATE tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og* gTerm_pureZterminal_15;
N_LIB_PRIVATE NI16 defaultForegroundColor_pureZterminal_501 = ((NI16) -1);
N_LIB_PRIVATE NI16 defaultBackgroundColor_pureZterminal_502 = ((NI16) -1);
...
static N_NIMCALL(void, TM__CN3raB9atujkEiPpxYAdlgQ_3)(void) {
	nimGCvisit((void*)gTerm_pureZterminal_15, 0);
}
...
N_LIB_PRIVATE N_NIMCALL(void, initTerminal_pureZterminal_191)(tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og* term) {
	...
	LA13_: ;
	(*term).oldStdoutAttr = getAttributes_pureZterminal_187((*term).hStdout);
	(*term).oldStderrAttr = getAttributes_pureZterminal_187((*term).hStderr);
}
N_LIB_PRIVATE N_NIMCALL(tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og*, newTerminal_pureZterminal_16)(void) {
	...
	initTerminal_pureZterminal_191(result);
	return result;
}
static N_INLINE(NI, pluspercent__system_696)(NI x, NI y) {
	NI result;
...
static N_INLINE(tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og*, getTerminal_pureZterminal_26)(void) {
	...
	result = (tyObject_PTerminalcolonObjectType___EcU8GhMNGo9bGDXbfqZ82og*)0;
	{
		if (!(gTerm_pureZterminal_15 == 0)) goto LA3_;
		asgnRef((void**) (&gTerm_pureZterminal_15), newTerminal_pureZterminal_16());
	}
	LA3_: ;
	result = gTerm_pureZterminal_15;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, setStyle_pureZterminal_439)(FILE* f, tySet_tyEnum_Style__NXKayqTLMsAibFwNceBlpA style) {
	...
	NI16 a;
	NI32 T23_;
	termX60gensym19_ = getTerminal_pureZterminal_26();
	{
	...
	LA1_: ;
	T6_ = (NI16)0;
	T6_ = getAttributes_pureZterminal_187(h);
...
N_LIB_PRIVATE N_NIMCALL(void, resetAttributes_pureZterminal_356)(FILE* f) {
	...
	term = getTerminal_pureZterminal_26();
	{
		NI32 T5_;
		if (!(f == stderr)) goto LA3_;
		T5_ = (NI32)0;
...
N_LIB_PRIVATE N_NIMCALL(void, setForegroundColor_pureZterminal_503)(FILE* f, tyEnum_ForegroundColor__ez9ah4IgQc0AbdW68acioDg fg, NIM_BOOL bright) {
	...
	NI16 old;
	NI16 T6_;
	termX60gensym24_ = getTerminal_pureZterminal_26();
	{
		if (!(f == stderr)) goto LA3_;
	...
	old = (NI16)(T6_ & ((NI16) -8));
	{
		if (!(defaultForegroundColor_pureZterminal_501 == ((NI16) -1))) goto LA9_;
		defaultForegroundColor_pureZterminal_501 = old;
	}
	LA9_: ;
	{
	...
	LA11_: ;
	{
		...
		T20_ = (NI16)0;
		T20_ = toU16_system_301(((NI) ((NI16)(old | defaultForegroundColor_pureZterminal_501))));
		T21_ = (NI32)0;
	...
	LA18_: ;
	{
		...
		NI32 T24_;
		T23_ = (NI16)0;
		T23_ = toU16_system_301((NI)(((NI) (old)) | lookup_pureZterminal_515[(fg)- 30]));
		T24_ = (NI32)0;
