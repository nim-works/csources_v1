...
N_LIB_PRIVATE N_NIMCALL(NI, parseSaturatedNatural_pureZparseutils_326)(NimStringDesc* s, NI* b, NI start);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_StandardFormatSpecifier__NDU7AW5Eu6Q69c8cH6RDouQ, parseStandardFormatSpecifier_pureZstrformat_56)(NimStringDesc* s, NI start, NIM_BOOL ignoreUnknownSuffix) {
	...
	LA30_: ;
	parsedLength = parseSaturatedNatural_pureZparseutils_326(s, (&result.minimumWidth), i);
	i += parsedLength;
	{
		NIM_BOOL T34_;
		NI parsedLengthB;
		...
		if (!T34_) goto LA36_;
		i += ((NI) 1);
		parsedLengthB = parseSaturatedNatural_pureZparseutils_326(s, (&result.precision), i);
		i += parsedLengthB;
	}
	goto LA32_;
	LA36_: ;
