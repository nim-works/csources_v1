...
{	result = (tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag)0;
		...
		i_2 = ((NI) 1);
		{
			while (1) {
				...
				} LA14: ;
				{
					NIM_BOOL T25_;
					T25_ = (NIM_BOOL)0;
					T25_ = sameType_types_1824((*(*a).typ).sons->data[i], (*(*b).typ).sons->data[i], 0);
					if (!T25_) goto LA26_;
					{
						NIM_BOOL T30_;
						T30_ = (NIM_BOOL)0;
				...
				LA26_: ;
				{
					...
					LA38_: ;
					if (!T35_) goto LA41_;
					diff = inheritanceDiff_types_2685(bb, aa);
					{
	...
	}
	{
		if (!(result == ((tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag) 2))) goto LA61_;
		{
			NIM_BOOL T65_;
			T65_ = (NIM_BOOL)0;
			T65_ = sameTypeOrNil_types_1848((*(*a).typ).sons->data[((NI) 0)], (*(*b).typ).sons->data[((NI) 0)], 0);
			if (!!(T65_)) goto LA66_;
			{
				NIM_BOOL T70_;
				T70_ = (NIM_BOOL)0;
			...
			res = ((NI) 1);
			{
				while (1) {
					...
					t2 = skipTypes_ast_3734((*(*methods->data[i]).typ).sons->data[col], TM__zwdrTKOAAM6OvWnXdBD4GQ_21);
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = sameType_types_1824(t2, t, 0);
						if (!!(T11_)) goto LA12_;
						result = NIM_TRUE;
						goto BeforeRet_;
					}
		...
		i = ((NI) 1);
		{
			while (1) {
				...
				col = i;
				{
					...
					d = inheritanceDiff_types_2685(aa, bb);
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
