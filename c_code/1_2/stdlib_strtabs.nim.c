...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3232(colontmp_, key);
	key.len = 0; key.p = NIM_NIL;
	colontmp__2 = (&(*data).p->data[h].Field1);
	eqsink___system_3232(colontmp__2, val);
		...
		{
			{
				while (1) {
					...
					eqsink___system_3232(colontmp_, TM__ZT9crccxweoChVXn9cHcxIXQ_5);
					colontmp__2 = (&(*t).data.p->data[i].Field1);
					eqsink___system_3232(colontmp__2, TM__ZT9crccxweoChVXn9cHcxIXQ_6);
					{
						while (1) {
	...
	{
		{
			...
			result = getEnv__pureZos_524(key, TM__ZT9crccxweoChVXn9cHcxIXQ_9);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			goto LA6;
		}
		LA9_: ;
			...
			{
				{
					...
					case 123:
					{
						...
						colontmp__5 = substr__system_7617(f, (NI)(i + ((NI) 2)), (NI)(j - ((NI) 1)));
...
appendString((&result), colontmp__2);
					...
					case 95:
					{
						...
						colontmp__10 = substr__system_7617(f, (NI)(i + ((NI) 1)), (NI)(j_2 - ((NI) 1)));
