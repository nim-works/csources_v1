...
appendString((*config).commandLine, T23_);
	...
	} LA2: ;
	{
		if (!(pass == ((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 1))) goto LA31_;
		{
			...
			LA38_: ;
			if (!T35_) goto LA39_;
			liMessage_msgs_1117(config, unknownLineInfo_lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_6), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_7, NIM_FALSE);
		}
		LA39_: ;
	}
	LA31_: ;
...
static N_INLINE(NimStringDesc*, findNodeJs_nodejs_2)(void) {
	NimStringDesc* result;
	result = (NimStringDesc*)0;
	result = findExe_pureZos_794(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_16), NIM_TRUE, ExeExts_pureZos_793, 3);
	{
		if (!((result ? result->Sup.len : 0) == ((NI) 0))) goto LA3_;
		result = findExe_pureZos_794(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_17), NIM_TRUE, ExeExts_pureZos_793, 3);
	}
	LA3_: ;
	{
...
appendString(T50_, (*conf).arguments);
		...
		case ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 18) ... ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 21):
		{
			NimStringDesc* T59_;
			{
				...
				liMessage_msgs_1117(conf, unknownLineInfo_lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T58_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_24, NIM_FALSE);
			}
			LA55_: ;
		...
		default:
		{
			...
			liMessage_msgs_1117(conf, unknownLineInfo_lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T62_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__6xNBOpPeN0DsJ34t7RoSng_26, NIM_FALSE);
		}
		break;
		}
	}
