...
{	result = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	...
	partialParam = lookupParam_liftlocals_59((*(*prc).typ).n, liftDest);
	{
		...
		liMessage_msgs_1117(conf, (*liftDest).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T10_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__xMgMWEFctBTF9b4zdqZ9bcYg_3, NIM_FALSE);
		result = n;
		goto BeforeRet_;
	}
	LA7_: ;
	objType = skipTypes_ast_3734((*partialParam).typ, TM__xMgMWEFctBTF9b4zdqZ9bcYg_5);
	{
		...
		liMessage_msgs_1117(conf, (*liftDest).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T18_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__xMgMWEFctBTF9b4zdqZ9bcYg_7, NIM_FALSE);
		result = n;
		goto BeforeRet_;
	}
	LA15_: ;
