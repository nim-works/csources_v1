...
{nimErr_ = nimErrorFlag();
	result = (NU8*)0;
	p = alloc0Impl__system_1726(((NI) ((NU)((NU64)((NU)((NU64)((NU)((NU64)((NU)((NU64)(((NU) (lenInBytes))) + (NU64)(((NU) 16)))) - (NU64)(((NU) 1)))) / (NU64)(((NU) 16)))) * (NU64)(((NU) 16))))));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	p = alloc0Impl__system_1726(((NI) ((NU)((NU64)((NU)((NU64)((NU)((NU64)((NU)((NU64)(numBytes) + (NU64)(((NU) 16)))) - (NU64)(((NU) 1)))) / (NU64)(((NU) 16)))) * (NU64)(((NU) 16))))));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimZeroMem((void*)(&T1_), sizeof(tyObject_VmCell__51AJUI5ZGwYQ0qXgveCtIA));
	T1_.typ = typ;
	T1_.count = ((NI) 1);
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				start = ((NI) (ptrdiff_t) (cell.p));
				{
					...
					T11_ = (NIM_BOOL)0;
					T11_ = contains__pureZtimes_2681(T10_, rp);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					if (!T11_) goto LA12_;
					result = id;
					goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmp_ = (NIM_BOOL)0;
	{
		...
		colontmp_ = contains__pureZtimes_2681(T3_, slot);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		{
