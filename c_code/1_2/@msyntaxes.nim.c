...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, parsePipe_syntaxes_38)(NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* inputStream, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	...
	s = llStreamOpen_llstream_69(filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0));
	{
		...
		LA9_: ;
		{
			...
			T24_ = substr_system_7821(line, i);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*, applyFilter_syntaxes_126)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* stdin_0) {
	...
	}
	{
		if (!!((f == ((tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ) 0)))) goto LA8_;
		{
			...
			if (!T12_) goto LA13_;
			liMessage_msgs_1117((*p).lex.config, unknownLineInfo_lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 81), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_11, NIM_FALSE);
			msgWriteln_msgs_647((*p).lex.config, (*result).s, 0);
			liMessage_msgs_1117((*p).lex.config, unknownLineInfo_lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 82), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_12, NIM_FALSE);
		}
		LA13_: ;
	}
	LA8_: ;
...
appendString(T6_, filename);
		liMessage_msgs_1117(config, unknownLineInfo_lineinfos_280, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T6_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_3, NIM_FALSE);
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	LA4_: ;
