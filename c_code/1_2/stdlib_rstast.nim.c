...
{nimErr_ = nimErrorFlag();
	...
	{
		eqdestroy___system_3226((&(*dest)._kind_2.labelFmt));
	}
	break;
	case ((tyEnum_RstNodeKind__DNoJcMFu9cjq4EGXsLl82CQ) 28):
	{
		eqdestroy___system_3226((&(*dest)._kind_3.lineIndent));
	}
	break;
	case ((tyEnum_RstNodeKind__DNoJcMFu9cjq4EGXsLl82CQ) 52):
	{
		eqdestroy___system_3226((&(*dest)._kind_4.adType));
	}
	break;
	...
	eqdestroy___system_3226((&(*dest).anchor));
...
{nimErr_ = nimErrorFlag();
	...
	(*T1_).sons = colontmp_;
	colontmp__2.len = 0; colontmp__2.p = NIM_NIL;
	eqcopy___system_3229((&colontmp__2), anchor);
