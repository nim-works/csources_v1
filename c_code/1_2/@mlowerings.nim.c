...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, genLen_lowerings_710)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	{
		...
		T7_ = lastOrd_types_1470((*g).config, T6_);
...
appendString(T5_, name);
		liMessage_msgs_1117((*g).config, info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T5_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__mTxj9crs9bTRS87wn5yEjeFA_11, NIM_FALSE);
	}
	goto LA1_;
	LA3_: ;
	{
