				...
				while (1) {
					...
					n = (*list)._kind_6.sons->data[i];
					{
						...
						if (!(((NI) 2) <= T7_)) goto LA8_;
						{
							...
							internalErrorImpl_msgs_1430((*g).config, unknownLineInfo_lineinfos_280, argX60gensym10_, TM__MWLujk8qP0XkmYs4m9cuPow_5);
						}
						LA14_: ;
...
break;
						...
						LA19_: ;
						{
							...
							tyTuple__7q7q3E6Oj24ZNVJb9aonhAg T42_;
							{
								...
								internalErrorImpl_msgs_1430((*g).config, unknownLineInfo_lineinfos_280, argX60gensym23_, TM__MWLujk8qP0XkmYs4m9cuPow_23);
							}
							LA40_: ;
						...
						{
							{
								...
								internalErrorImpl_msgs_1430((*g).config, unknownLineInfo_lineinfos_280, argX60gensym44_, TM__MWLujk8qP0XkmYs4m9cuPow_26);
							}
							LA100_: ;
						}
						LA30_: ;
