...
appendString((&T8_), cache);
			...
			secureHash__stdZsha49_840(colontmp__3.p->data, colontmp__3.len, h);
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			T9_.len = 0; T9_.p = NIM_NIL;
			colontmp__8 = dollar___stdZsha49_888(h);
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
...
appendString((&T9_), colontmp__4);
			...
			colontmp__9 = (NIM_BOOL)0;
			{
				...
				T11_ = globalOptions__frontZoptions_3926(conf);
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
				...
				LA14_: ;
				colontmp__9 = open__systemZio_449(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			} LA10: ;
			{
				...
				colontmp__10 = readAll__systemZio_407(f);
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
				colontmp__11 = ((NI) 0);
				...
				eqdestroy___system_3228((&colontmp_));
				eqdestroy___system_3228((&workingDir));
				goto BeforeRet_;
			}
			LA18_: ;
					...
					*nimErr_ = NIM_FALSE;
					{
						...
						eqsink___pureZosproc_1495((&result), colontmp__18);
					}
					LA45_: ;
					popCurrentException();
					LA41_:;
		...
		}
		{
			...
			eqdestroy___pureZosproc_220(&p_2);
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObj(nimBorrowCurrentException()->Sup.m_type, "|IOError|CatchableError|Exception|RootObj|")||isObj(nimBorrowCurrentException()->Sup.m_type, "|OSError|CatchableError|Exception|RootObj|")) {
				...
				*nimErr_ = NIM_FALSE;
				...
				eqsink___pureZosproc_1495((&result), colontmp__25);
				popCurrentException();
				LA66_:;
			}
		}
