...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, absolutePath__pureZos_893)(NimStringV2 path, NimStringV2 root);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__pureZos_1720)(NimStringV2 dir);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplAux__pureZos_1869)(NimStringV2 procPath);
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHeuristic__pureZos_1873)(void);
...
N_LIB_PRIVATE N_NIMCALL(void, createSymlink__pureZos_1178)(NimStringV2 src, NimStringV2 dest);
N_LIB_PRIVATE N_NIMCALL(NimStringV2, expandSymlink__pureZos_1184)(NimStringV2 symlinkPath);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__pureZos_1713)(NimStringV2 dir);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, tryMoveFSObject__pureZos_1260)(NimStringV2 source, NimStringV2 dest, NIM_BOOL isDir);
...
N_LIB_PRIVATE NIM_CONST tyArray__Wex9cTiLLztRmCSkLU7RNiA ExeExts__pureZos_812 = {{0, (NimStrPayload*)&TM__yu6cxgKBBXbNsTkT9cyMd4g_4}}
;
static const struct {
...
{nimErr_ = nimErrorFlag();
	...
	result = absolutePath__pureZos_893(path, colontmp_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
		...
		while (1) {
			{
				...
				colontmp__10 = (NIM_BOOL)0;
				{
					...
					LA69_: ;
					T71_ = (NIM_CHAR*)0;
					T71_ = X5BX5D___system_7204((&result), ((NI) 1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		while (1) {
			{
				...
				colontmp__11 = (NIM_BOOL)0;
				{
					...
					LA90_: ;
					T92_ = (NIM_CHAR*)0;
					T92_ = X5BX5D___system_7204((&result), ((NI) 1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__pureZos_1720(dir);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	{
		if (!result) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		i = (NI)0;
		colontmp_ = (NI)0;
		colontmp_ = paramCount__pureZos_1852();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		res = ((NI) 1);
		{
			while (1) {
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = paramStr__pureZos_1843(((NI) 0));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	colontmp_ = (NIM_BOOL)0;
	{
		...
		if (!colontmp_) goto LA8_;
		{
			...
			splitsX60gensym36_ = ((NI) -1);
			{
				while (1) {
					...
					LA32_: ;
					colontmp__4 = substr__system_7575(colontmp__2, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI) 1)));
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	result = getApplAux__pureZos_1869(TM__yu6cxgKBBXbNsTkT9cyMd4g_84);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NimStringV2 colontmp_;
		if (!(result.len == ((NI) 0))) goto LA3_;
		colontmp_ = getApplHeuristic__pureZos_1873();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		eqsink___system_3234((&result), colontmp_);
	}
	LA3_: ;
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		NIM_BOOL T8_;
		T8_ = (NIM_BOOL)0;
		T8_ = contains__pureZos_820(exe.p->data, exe.len, 47);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!T8_) goto LA9_;
		{
			...
			i = ((NI) 0);
			{
				while (1) {
					...
					colontmp_ = nosaddFileExt(exe, (*extX60gensym80_));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
					eqsink___system_3234((&result), colontmp_);
					{
						NIM_BOOL T20_;
		...
		splitsX60gensym33_ = ((NI) -1);
		{
			while (1) {
				...
				eqsink___system_3234((&candidate), colontmp__3);
				{
					...
					LA50_: ;
					colontmp__5 = expandTilde__pureZos_742(candidate);
...
{nimErr_ = nimErrorFlag();
	...
	T2_ = (int)0;
	T2_ = exitStatusLikeShell__pureZos_1273(T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = ((NI) (T2_));
	}BeforeRet_: ;
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	LA18_: ;
	{
		...
		} LA21: ;
		{
			...
			T30_ = expandSymlink__pureZos_1184(source);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			colontmp__4 = dest;
			dest.len = 0; dest.p = NIM_NIL;
			createSymlink__pureZos_1178(T30_, colontmp__4);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			goto LA20;
		}
		LA28_: ;
		...
		s = (FILE*)0;
		{
			...
			NI32 T36_;
			T33_ = (NIM_BOOL)0;
			T33_ = open__systemZio_449(&s, source, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!!(T33_)) goto LA34_;
			T36_ = (NI32)0;
		...
		LA34_: ;
		{
			...
			NI32 T42_;
			T39_ = (NIM_BOOL)0;
			T39_ = open__systemZio_449(&d, dest, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1), ((NI) -1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!!(T39_)) goto LA40_;
...
{nimErr_ = nimErrorFlag();
	...
	rawRemoveDir__pureZos_1713(dir);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, tryMoveFSObject__pureZos_1260)(NimStringV2 source, NimStringV2 dest, NIM_BOOL isDir) {
...
{nimErr_ = nimErrorFlag();
	...
	colontmp__2.len = 0; colontmp__2.p = NIM_NIL;
	{
		...
		T4_ = (NIM_BOOL)0;
		T4_ = tryMoveFSObject__pureZos_1260(colontmp_, colontmp__2, NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!!(T4_)) goto LA5_;
		colontmp__3.len = 0; colontmp__3.p = NIM_NIL;
		colontmp__3.len = 0; colontmp__3.p = NIM_NIL;
...
{nimErr_ = nimErrorFlag();
	...
	colontmp__2.len = 0; colontmp__2.p = NIM_NIL;
	{
		...
		eqcopy___system_3231((&colontmp__2), dest);
		T4_ = (NIM_BOOL)0;
		T4_ = tryMoveFSObject__pureZos_1260(colontmp_, colontmp__2, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		if (!!(T4_)) goto LA5_;
