...
N_LIB_PRIVATE N_NIMCALL(void, write_systemZio_304)(FILE* f, NimStringDesc** a, NI aLen_0);
...
N_LIB_PRIVATE N_NIMCALL(void, close_ndi_31)(tyObject_NdiFile__9cEuXfAnHp9bnWFK409cMtsEw* f, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	{
		...
		(*f).f = open_systemZio_430((*f).filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1), ((NI) 8000));
		{
			NimStringDesc* T9_;
