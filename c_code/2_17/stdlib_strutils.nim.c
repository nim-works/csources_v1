	...
	LA3_: ;
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				T14_ = substr_system_7773(s, i, (NI)(j - ((NI) 1)));
	...
	LA6_: ;
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				T23_ = substr_system_7773(s, i_2, (NI)(j_2 - ((NI) 1)));
...
appendString((*s), a[idx_2]);
					...
					LA55_: ;
					{
						...
						T69_ = substr_system_7773(formatstr, (NI)(i + ((NI) 2)), (NI)(j_2 - ((NI) 1)));
...
appendString((*s), a[(NI)(x + ((NI) 1))]);
				...
				case 95:
				{
					...
					T82_ = substr_system_7773(formatstr, (NI)(i + ((NI) 1)), (NI)(j_3 - ((NI) 1)));
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym34_ = maxsplit;
		{
			while (1) {
				...
				LA10_: ;
				xX60gensym67_ = substr_system_7773(s, firstX60gensym34_, (NI)(lastX60gensym34_ - ((NI) 1)));
	...
	result = NIM_NIL;
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA26_: ;
				xX60gensym76_ = substr_system_7773(s, first, T25_);
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T31_ = result->Sup.len++;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuStrip)(NimStringDesc* s, NIM_BOOL leading, NIM_BOOL trailing, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw chars) {
	...
	LA11_: ;
	result = substr_system_7773(s, first, last);
	return result;
}
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym41_ = maxsplit;
		{
			while (1) {
				...
				LA15_: ;
				xX60gensym72_ = substr_system_7773(s, firstX60gensym41_, (NI)(lastX60gensym41_ - ((NI) 1)));
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T17_ = result->Sup.len++;
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA26_: ;
				line = substr_system_7773(s, first, T25_);
				{
