...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalTemplateArgs_evaltempl_197)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NIM_BOOL fromHlo) {
	...
	LA12_: ;
	{
		...
		liMessage_msgs_1118(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__N0xGjswvcjwwH43PvVNJAg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__N0xGjswvcjwwH43PvVNJAg_6, NIM_FALSE);
	}
	LA16_: ;
	{
		NimStringDesc* T22_;
		...
		liMessage_msgs_1118(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T23_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__N0xGjswvcjwwH43PvVNJAg_8, NIM_FALSE);
	}
	LA20_: ;
		...
		res_2 = colontmp_;
		{
			while (1) {
				...
				default_1 = (*(*(*(*(*s).typ).n)._kind_6.sons->data[i_2])._kind_4.sym).ast;
				{
					...
					LA33_: ;
					if (!T32_) goto LA34_;
					liMessage_msgs_1118(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__N0xGjswvcjwwH43PvVNJAg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__N0xGjswvcjwwH43PvVNJAg_9, NIM_FALSE);
		...
		s = (*templ)._kind_4.sym;
		{
			...
			LA35_: ;
			{
				...
				RootObj* T55_;
				{
					...
					internalErrorImpl_msgs_1431((*c).config, unknownLineInfo_lineinfos_280, argX60gensym7_, TM__N0xGjswvcjwwH43PvVNJAg_13);
				}
				LA53_: ;
				T55_ = (RootObj*)0;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, evalTemplate_evaltempl_275)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* tmpl, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* genSymOwner, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* ic, NI* instID, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen, NIM_BOOL fromHlo) {
	...
	(*conf).evalTemplateCounter += ((NI) 1);
	{
		...
		liMessage_msgs_1118(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__N0xGjswvcjwwH43PvVNJAg_2), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 2), TM__N0xGjswvcjwwH43PvVNJAg_3, NIM_FALSE);
		result = n;
	}
	LA3_: ;
...
appendString(T16_, T17_);
			liMessage_msgs_1118(conf, (*result).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T16_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__N0xGjswvcjwwH43PvVNJAg_17, NIM_FALSE);
		}
		LA10_: ;
	}
	goto LA5_;
