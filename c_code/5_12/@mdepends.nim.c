...
struct tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw {
  RootObj Sup;
tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA* dotGraph;
};
...
static N_NIMCALL(void, Marker_tyRef__RAhtsUA2w9btaU8K3v0RQAg)(void* p, NI op);
...
static N_NIMCALL(void, Marker_tyRef__Z9cBOJWNt0CSRvLG1Nw4Uvg)(void* p, NI op);
...
N_LIB_PRIVATE N_NIMCALL(void, addDependencyAux_depends_17)(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw* b, NimStringDesc* importing, NimStringDesc* imported);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent__depends_21)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent__depends_75)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0);
...
N_LIB_PRIVATE TNimType NTItgen__4jLZHF07vYxUK3tt7TCvdA_;
...
N_LIB_PRIVATE TNimType NTIpgen__RAhtsUA2w9btaU8K3v0RQAg_;
extern TNimType NTIrootobj__ytyiCJqK439aF9cIibuRVpAg_;
N_LIB_PRIVATE TNimType NTIbackend58objecttype__Wif8sNhW63ukfJmVEqpOVw_;
extern TNimType NTIrope__4hi0XQqK9aLiPuWT9acsXm9aQ_;
N_LIB_PRIVATE TNimType NTIbackend__Z9cBOJWNt0CSRvLG1Nw4Uvg_;
STRING_LITERAL(TM__yPaXWsjYzX34ek6cfhmMUw_3, "\"$1\" -> \"$2\";$n", 15);
STRING_LITERAL(TM__yPaXWsjYzX34ek6cfhmMUw_4, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TM__yPaXWsjYzX34ek6cfhmMUw_5, "dot", 3);
extern tyObject_GcHeap__1TRH1TZMaVZTnLNcIHuNFQ gch_system_5209;
static N_NIMCALL(void, Marker_tyRef__RAhtsUA2w9btaU8K3v0RQAg)(void* p, NI op) {
	tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA* a;
	a = (tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA*)p;
...
static N_NIMCALL(void, Marker_tyRef__Z9cBOJWNt0CSRvLG1Nw4Uvg)(void* p, NI op) {
	tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw* a;
	a = (tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw*)p;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w*, myOpen_depends_80)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* module, tyObject_IdGeneratorcolonObjectType___9a3T65u6nPPLrld0SrEa57Q* idgen) {
	...
	g = (tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA*) newObj((&NTIpgen__RAhtsUA2w9btaU8K3v0RQAg_), sizeof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA));
	(*g).Sup.Sup.m_type = (&NTItgen__4jLZHF07vYxUK3tt7TCvdA_);
	...
	asgnRef((void**) (&(*g).graph), graph);
	{
		...
		T5_ = (tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw*) newObj((&NTIbackend__Z9cBOJWNt0CSRvLG1Nw4Uvg_), sizeof(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw));
		(*T5_).Sup.m_type = (&NTIbackend58objecttype__Wif8sNhW63ukfJmVEqpOVw_);
		asgnRef((void**) (&(*T5_).dotGraph), ((tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*) NIM_NIL));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent__depends_21)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0) {
	...
	result = runtimeFormat_ropes_271(((NimStringDesc*) &TM__yPaXWsjYzX34ek6cfhmMUw_3), args, argsLen_0);
	return result;
}
static N_INLINE(void, nimSetMem_systemZmemory_7)(void* a, int v, NI size) {
	void* T1_;
...
N_LIB_PRIVATE N_NIMCALL(void, addDependencyAux_depends_17)(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw* b, NimStringDesc* importing, NimStringDesc* imported) {
	...
	T1_[0] = rope_ropes_109(importing);
	T1_[1] = rope_ropes_109(imported);
	T2_ = (tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*)0;
	T2_ = percent__depends_21(T1_, 2);
	add_ropes_159(&(*b).dotGraph, T2_);
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, addDotDependency_depends_26)(tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = n;
	g = ((tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA*) (c));
	b = (*((tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw**) (&((*(*g).graph).backend))));
	switch ((*n).kind) {
	...
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					imported = getModuleName_modulepaths_10((*g).config, (*n)._kind_6.sons->data[i]);
					addDependencyAux_depends_17(b, (*(*(*g).module).name).s, imported);
					i_2 += ((NI) 1);
				} LA4: ;
			}
		}
	...
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 117):
	{
		...
		imported_2 = getModuleName_modulepaths_10((*g).config, (*n)._kind_6.sons->data[((NI) 0)]);
		addDependencyAux_depends_17(b, (*(*(*g).module).name).s, imported_2);
	}
	break;
	...
	{
		{
			...
			i_4 = ((NI) 0);
			{
				while (1) {
					...
					T10_ = addDotDependency_depends_26(c, (*n)._kind_6.sons->data[i_3]);
					(void)(T10_);
					i_4 += ((NI) 1);
				} LA9: ;
			}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*, percent__depends_75)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA** args, NI argsLen_0) {
	tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA* result;
	result = (tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*)0;
	result = runtimeFormat_ropes_271(((NimStringDesc*) &TM__yPaXWsjYzX34ek6cfhmMUw_4), args, argsLen_0);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, generateDot_depends_71)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NimStringDesc* project) {
	...
	splitFile_pathutils_26(project, (&T2_));
	T1_[0] = rope_ropes_109(T2_.Field1);
	T1_[1] = (*b).dotGraph;
	T3_ = (tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA*)0;
	T3_ = percent__depends_75(T1_, 2);
	T4_ = (NimStringDesc*)0;
	T4_ = noschangeFileExt(project, ((NimStringDesc*) &TM__yPaXWsjYzX34ek6cfhmMUw_5));
	T5_ = (NIM_BOOL)0;
	T5_ = writeRope_ropes_241(T3_, T4_);
	(void)(T5_);
}
N_LIB_PRIVATE N_NIMCALL(void, compiler_dependsDatInit000)(void) {
static TNimNode* TM__yPaXWsjYzX34ek6cfhmMUw_2_3[3];
static TNimNode TM__yPaXWsjYzX34ek6cfhmMUw_0[5];
NTItgen__4jLZHF07vYxUK3tt7TCvdA_.size = sizeof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA);
NTItgen__4jLZHF07vYxUK3tt7TCvdA_.align = NIM_ALIGNOF(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA);
NTItgen__4jLZHF07vYxUK3tt7TCvdA_.kind = 17;
NTItgen__4jLZHF07vYxUK3tt7TCvdA_.base = (&NTItpasscontext__Hb6rFM0ecvtlLf2kv9aU75w_);
TM__yPaXWsjYzX34ek6cfhmMUw_2_3[0] = &TM__yPaXWsjYzX34ek6cfhmMUw_0[1];
TM__yPaXWsjYzX34ek6cfhmMUw_0[1].kind = 1;
TM__yPaXWsjYzX34ek6cfhmMUw_0[1].offset = offsetof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA, module);
TM__yPaXWsjYzX34ek6cfhmMUw_0[1].typ = (&NTIpsym__dG2QVH5Z69aMUY38zTqWxaA_);
TM__yPaXWsjYzX34ek6cfhmMUw_0[1].name = "module";
TM__yPaXWsjYzX34ek6cfhmMUw_2_3[1] = &TM__yPaXWsjYzX34ek6cfhmMUw_0[2];
TM__yPaXWsjYzX34ek6cfhmMUw_0[2].kind = 1;
TM__yPaXWsjYzX34ek6cfhmMUw_0[2].offset = offsetof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA, config);
TM__yPaXWsjYzX34ek6cfhmMUw_0[2].typ = (&NTIconfigref__a8lycfSA25OQltN3OMeBsA_);
TM__yPaXWsjYzX34ek6cfhmMUw_0[2].name = "config";
TM__yPaXWsjYzX34ek6cfhmMUw_2_3[2] = &TM__yPaXWsjYzX34ek6cfhmMUw_0[3];
TM__yPaXWsjYzX34ek6cfhmMUw_0[3].kind = 1;
TM__yPaXWsjYzX34ek6cfhmMUw_0[3].offset = offsetof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA, graph);
TM__yPaXWsjYzX34ek6cfhmMUw_0[3].typ = (&NTImodulegraph__KfdHSsl8vyUCSI9b3inBcww_);
TM__yPaXWsjYzX34ek6cfhmMUw_0[3].name = "graph";
TM__yPaXWsjYzX34ek6cfhmMUw_0[0].len = 3; TM__yPaXWsjYzX34ek6cfhmMUw_0[0].kind = 2; TM__yPaXWsjYzX34ek6cfhmMUw_0[0].sons = &TM__yPaXWsjYzX34ek6cfhmMUw_2_3[0];
NTItgen__4jLZHF07vYxUK3tt7TCvdA_.node = &TM__yPaXWsjYzX34ek6cfhmMUw_0[0];
NTIpgen__RAhtsUA2w9btaU8K3v0RQAg_.size = sizeof(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA*);
NTIpgen__RAhtsUA2w9btaU8K3v0RQAg_.align = NIM_ALIGNOF(tyObject_TGen__4jLZHF07vYxUK3tt7TCvdA*);
NTIpgen__RAhtsUA2w9btaU8K3v0RQAg_.kind = 22;
NTIpgen__RAhtsUA2w9btaU8K3v0RQAg_.base = (&NTItgen__4jLZHF07vYxUK3tt7TCvdA_);
NTIpgen__RAhtsUA2w9btaU8K3v0RQAg_.marker = Marker_tyRef__RAhtsUA2w9btaU8K3v0RQAg;
NTIbackend58objecttype__Wif8sNhW63ukfJmVEqpOVw_.size = sizeof(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw);
NTIbackend58objecttype__Wif8sNhW63ukfJmVEqpOVw_.align = NIM_ALIGNOF(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw);
NTIbackend58objecttype__Wif8sNhW63ukfJmVEqpOVw_.kind = 17;
NTIbackend58objecttype__Wif8sNhW63ukfJmVEqpOVw_.base = (&NTIrootobj__ytyiCJqK439aF9cIibuRVpAg_);
TM__yPaXWsjYzX34ek6cfhmMUw_0[4].kind = 1;
TM__yPaXWsjYzX34ek6cfhmMUw_0[4].offset = offsetof(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw, dotGraph);
TM__yPaXWsjYzX34ek6cfhmMUw_0[4].typ = (&NTIrope__4hi0XQqK9aLiPuWT9acsXm9aQ_);
TM__yPaXWsjYzX34ek6cfhmMUw_0[4].name = "dotGraph";
NTIbackend58objecttype__Wif8sNhW63ukfJmVEqpOVw_.node = &TM__yPaXWsjYzX34ek6cfhmMUw_0[4];
NTIbackend__Z9cBOJWNt0CSRvLG1Nw4Uvg_.size = sizeof(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw*);
NTIbackend__Z9cBOJWNt0CSRvLG1Nw4Uvg_.align = NIM_ALIGNOF(tyObject_BackendcolonObjectType___Wif8sNhW63ukfJmVEqpOVw*);
NTIbackend__Z9cBOJWNt0CSRvLG1Nw4Uvg_.kind = 22;
NTIbackend__Z9cBOJWNt0CSRvLG1Nw4Uvg_.base = (&NTIbackend58objecttype__Wif8sNhW63ukfJmVEqpOVw_);
NTIbackend__Z9cBOJWNt0CSRvLG1Nw4Uvg_.marker = Marker_tyRef__Z9cBOJWNt0CSRvLG1Nw4Uvg;
}
