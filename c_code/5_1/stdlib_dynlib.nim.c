...
N_LIB_PRIVATE N_NIMCALL(void, libCandidates_pureZdynlib_37)(NimStringDesc* s, tySequence__sM4lkSb7zS6F7OVMvW9cffQ** dest) {
	...
	ri = nsuFindChar(s, 41, ((NI) ((NI)(le + ((NI) 1)))), ((NI) 0));
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		prefix = substr_system_7743(s, ((NI) 0), (NI)(le - ((NI) 1)));
		suffix = substr_system_7755(s, (NI)(ri + ((NI) 1)));
		{
			...
			colontmp_ = substr_system_7743(s, (NI)(le + ((NI) 1)), (NI)(ri - ((NI) 1)));
			...
			splitsX60gensym34_ = ((NI) -1);
			{
				while (1) {
					...
					LA16_: ;
					middle = substr_system_7743(colontmp_, firstX60gensym34_, (NI)(lastX60gensym34_ - ((NI) 1)));
