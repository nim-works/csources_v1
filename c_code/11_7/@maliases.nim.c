...
{	result = (tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w)0;
	...
	LA5_: ;
	{
		...
		xX60gensym7_ = a;
		T9_ = (NIM_BOOL)0;
		T9_ = containsOrIncl_astalgo_402(marker, (NI)((NI)((NU32)(((NI) ((*xX60gensym7_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym7_).Sup.itemId.item))));
		if (!T9_) goto LA10_;
		goto BeforeRet_;
	}
	LA10_: ;
	{
		NIM_BOOL T14_;
		T14_ = (NIM_BOOL)0;
		T14_ = compareTypes_types_2659(a, b, ((tyEnum_TDistinctCompare__9bNKHGs63atuMFXnAleTveg) 1), 0);
		if (!T14_) goto LA15_;
		...
		case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 45):
		{
			result = isPartOf_aliases_129((*a)._kind_6.sons->data[((NI) 0)], (*b)._kind_6.sons->data[((NI) 0)]);
			{
				if (!!((result == ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 0)))) goto LA67_;
				{
					...
					if (!!(((NI)((NI)((NU32)(((NI) ((*xX60gensym38_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym38_).Sup.itemId.item))) == (NI)((NI)((NU32)(((NI) ((*xX60gensym40_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym40_).Sup.itemId.item)))))) goto LA71_;
					result = ((tyEnum_TAnalysisResult__p9a9bcrXoRmLT4eUuwrDq9b4w) 0);
				}
				LA71_: ;
			}
