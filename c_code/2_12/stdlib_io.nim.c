...
N_LIB_PRIVATE N_NIMCALL(NI64, rawFileSize_systemZio_333)(FILE* file);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllFile_systemZio_341)(FILE* file, NI64 len);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllBuffer_systemZio_328)(FILE* file);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, setInheritable_systemZio_234)(int f, NIM_BOOL inheritable);
...
N_LIB_PRIVATE NIM_CONST tyArray__Djap3EijveoDksCG9bY8s5w FormatOpen_systemZio_371 = {"rbe",
"wbe",
"w+be",
"r+be",
"abe"}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, open_systemZio_389)(FILE** f, NimStringDesc* filename, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode, NI bufSize) {
	...
	void* p;
{	result = (NIM_BOOL)0;
	p = fopen(nimToCStringConv(filename), FormatOpen_systemZio_371[(mode)- 0]);
	{
		FILE* f2;
		struct stat res;
		...
		f2 = ((FILE*) (p));
		{
			...
			T7_ = (NIM_BOOL)0;
			T8_ = (int)0;
			T8_ = getFileHandle_systemZio_228(f2);
			T9_ = (int)0;
			T9_ = fstat(T8_, (&res));
			T7_ = (((NI32) 0) <= T9_);
			if (!(T7_)) goto LA10_;
...
N_LIB_PRIVATE N_NIMCALL(FILE*, open_systemZio_430)(NimStringDesc* filename, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode, NI bufSize) {
	...
	result = (FILE*)0;
	{
		...
		NimStringDesc* T7_;
		T3_ = (NIM_BOOL)0;
		T3_ = open_systemZio_389(&result, filename, mode, bufSize);
		if (!!(T3_)) goto LA4_;
				...
				while (1) {
					{
						...
						T10_ = (NIM_BOOL)0;
						T10_ = eqeq__system_7715(T9_, ((NCSTRING) NIM_NIL));
						fgetsSuccess = !(T10_);
						{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllFile_systemZio_341)(FILE* file, NI64 len) {
	...
	bytes = readBuffer_systemZio_144(file, ((void*) ((&result->data[((NI) 0)]))), ((NI) (len)));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = endOfFile_systemZio_337(file);
		if (!T3_) goto LA4_;
		{
	...
	LA4_: ;
	{
		...
		T11_ = readAllBuffer_systemZio_328(file);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAll_systemZio_350)(FILE* file) {
	...
	result = (NimStringDesc*)0;
	{
		...
		len = rawFileSize_systemZio_333(file);
	}
	goto LA1_;
	LA3_: ;
	{
	...
	LA1_: ;
	{
		...
		result = readAllFile_systemZio_341(file, len);
	}
	goto LA6_;
	LA8_: ;
	{
		result = readAllBuffer_systemZio_328(file);
	}
	LA6_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readFile_systemZio_469)(NimStringDesc* filename) {
	...
	f = ((FILE*) NIM_NIL);
	{
		...
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_7.status = setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_7.context);
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_7.status == 0) {
		result = readAll_systemZio_350(f);
		popSafePoint();
		}
		else {
			popSafePoint();
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readLine_systemZio_271)(FILE* f) {
	...
	result = rawNewString(((NI) 80));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = readLine_systemZio_238(f, (&result));
		if (!!(T3_)) goto LA4_;
...
N_LIB_PRIVATE N_NIMCALL(void, writeFile_systemZio_474)(NimStringDesc* filename, NimStringDesc* content) {
	...
	f = ((FILE*) NIM_NIL);
	{
		...
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_9.status = setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_9.context);
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ*, readLines_systemZio_492)(NimStringDesc* filename, NI n) {
	...
	f = ((FILE*) NIM_NIL);
	{
		...
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_10.status = setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_10.context);
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_10.status == 0) {
		result = newSeq_systemZio_501(n);
		{
			NI i;
			NI colontmp_;
			NI res;
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = res;
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = readLine_systemZio_238(f, (&result->data[i]));
						if (!!(T11_)) goto LA12_;
						raiseEOF_systemZio_117();
					}
					LA12_: ;
...
{	result = (NIM_BOOL)0;
	oshandle = filehandle;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = setInheritable_systemZio_234(oshandle, NIM_FALSE);
		if (!!(T3_)) goto LA4_;
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	LA4_: ;
	(*f) = fdopen(filehandle, FormatOpen_systemZio_371[(mode)- 0]);
