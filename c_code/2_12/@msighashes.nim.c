...
{	{
	...
	{
		{
			...
			normalizedType = skipGenericAlias_types_2210(t);
			{
				NI i_3;
				NI colontmp__2;
				NI T39_;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 14):
	{
		...
		LA70_: ;
		{
			...
			xX60gensym38_ = t;
			ampeq__sighashes_18(c, ((NI64) ((NI)((NI)((NU32)(((NI) ((*xX60gensym38_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym38_).Sup.itemId.item))))));
		}
		LA68_: ;
		{
			NIM_BOOL T113_;
...
{	nimZeroMem((void*)Result, sizeof(tyArray__qtqsWM5aXmcpMIVmvq3kAA));
	hcX60gensym93_ = (NI)0;
	xX60gensym92_ = sym;
	indexX60gensym93_ = rawGet_sighashes_619((*graph).symBodyHashes, (NI)((NI)((NU32)(((NI) ((*xX60gensym92_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym92_).Sup.itemId.item))), (&hcX60gensym93_));
	...
	md5Final_pureZmd53_166((&c), Result);
	xX60gensym97_ = sym;
	X5BX5Deq__sighashes_960((&(*graph).symBodyHashes), (NI)((NI)((NU32)(((NI) ((*xX60gensym97_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym97_).Sup.itemId.item))), Result);
	{
		...
		md5Final_pureZmd53_166((&c), Result);
		xX60gensym111_ = sym;
		X5BX5Deq__sighashes_960((&(*graph).symBodyHashes), (NI)((NI)((NU32)(((NI) ((*xX60gensym111_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym111_).Sup.itemId.item))), Result);
	}
	LA7_: ;
	}BeforeRet_: ;
}
