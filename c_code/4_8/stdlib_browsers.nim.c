...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, prepare_pureZbrowsers_6)(NimStringDesc* s) {
	...
	LA4_: ;
	{
		...
		T9_ = (NimStringDesc*)0;
		T9_ = absolutePath_pureZos_742(s, T8_);
	...
	LA6_: ;
	{
		...
		splitsX60gensym34_ = ((NI) -1);
		{
			while (1) {
				...
				LA17_: ;
				b = substr_system_7713(colontmp_, firstX60gensym34_, (NI)(lastX60gensym34_ - ((NI) 1)));
				pushSafePoint(&TM__CZNeKGdQ8AWxD1HSDIq5DQ_7);
				TM__CZNeKGdQ8AWxD1HSDIq5DQ_7.status = _setjmp(TM__CZNeKGdQ8AWxD1HSDIq5DQ_7.context);
