			...
			res = ((NI) 0);
			{
				while (1) {
					...
					m = v_2;
					{
						...
						T19_ = substr_system_7725(reprEnum((NI)m, (&NTItmagic__shZhZOdbVC5nnFvcXQAImg_)), ((NI) 1));
		...
		a = ((NI) 0);
		{
			while (1) {
				...
				b = nsuFindChar(str, marker, ((NI) (a)), ((NI) 0));
				{
					...
					sub = substr_system_7725(str, a);
				}
				goto LA14_;
				LA16_: ;
				{
					sub = substr_system_7713(str, a, (NI)(b - ((NI) 1)));
				}
				LA14_: ;
				{
				...
				c = nsuFindChar(str, marker, ((NI) ((NI)(b + ((NI) 1)))), ((NI) 0));
				{
					...
					sub = substr_system_7725(str, (NI)(b + ((NI) 1)));
				}
				goto LA28_;
				LA30_: ;
				{
					sub = substr_system_7713(str, (NI)(b + ((NI) 1)), (NI)(c - ((NI) 1)));
				}
				LA28_: ;
				{
					NIM_BOOL amb;
