...
appendString(T7_, T8_);
		...
		f = (FILE*)0;
		{
			...
			if (!(T11_)) goto LA12_;
			T11_ = open_systemZio_391(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
			LA12_: ;
			if (!T11_) goto LA13_;
			colontmp_ = readAll_systemZio_352(f);
			colontmp__2 = ((NI) 0);
		...
		readSuccessful = NIM_TRUE;
		{
			...
			writeFile_systemZio_476(filename, (*Result).Field0);
		}
		LA24_: ;
		popSafePoint();
		}
