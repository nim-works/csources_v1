...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, setInheritable_systemZio_235)(int f, NIM_BOOL inheritable);
N_LIB_PRIVATE N_NIMCALL(int, getOsFileHandle_systemZio_232)(FILE* f);
...
N_LIB_PRIVATE N_NIMCALL(NI64, rawFileSize_systemZio_335)(FILE* file);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllFile_systemZio_343)(FILE* file, NI64 len);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllBuffer_systemZio_330)(FILE* file);
...
N_LIB_PRIVATE NIM_CONST tyArray__Djap3EijveoDksCG9bY8s5w FormatOpen_systemZio_373 = {"rb",
"wb",
"w+b",
"r+b",
"ab"}
...
N_LIB_PRIVATE N_NIMCALL(void, write_systemZio_205)(FILE* f, NimStringDesc* s) {
	{
		NI T3_;
		T3_ = (NI)0;
		T3_ = writeBuffer_systemZio_176(f, ((void*) (nimToCStringConv(s))), ((NI) ((s ? s->Sup.len : 0))));
		if (!!((T3_ == (s ? s->Sup.len : 0)))) goto LA4_;
		raiseEIO_systemZio_96(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_5));
	}
	LA4_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, open_systemZio_391)(FILE** f, NimStringDesc* filename, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode, NI bufSize) {
	...
	void* p;
{	result = (NIM_BOOL)0;
	p = fopen(nimToCStringConv(filename), FormatOpen_systemZio_373[(mode)- 0]);
	{
		FILE* f2;
		struct stat res;
		...
		f2 = ((FILE*) (p));
		{
			...
			T7_ = (NIM_BOOL)0;
			T8_ = (int)0;
			T8_ = getFileHandle_systemZio_229(f2);
			T9_ = (int)0;
			T9_ = fstat(T8_, (&res));
			T7_ = (((NI32) 0) <= T9_);
			if (!(T7_)) goto LA10_;
		...
		LA11_: ;
		{
			...
			NIM_BOOL T16_;
			T15_ = (int)0;
			T15_ = getOsFileHandle_systemZio_232(f2);
			T16_ = (NIM_BOOL)0;
			T16_ = setInheritable_systemZio_235(T15_, NIM_FALSE);
			if (!!(T16_)) goto LA17_;
			close_systemZio_218(f2);
			result = NIM_FALSE;
			goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(FILE*, open_systemZio_432)(NimStringDesc* filename, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg mode, NI bufSize) {
	...
	result = (FILE*)0;
	{
		...
		NimStringDesc* T7_;
		T3_ = (NIM_BOOL)0;
		T3_ = open_systemZio_391(&result, filename, mode, bufSize);
		if (!!(T3_)) goto LA4_;
				...
				while (1) {
					{
						...
						T10_ = (NIM_BOOL)0;
						T10_ = eqeq__system_7693(T9_, ((NCSTRING) NIM_NIL));
						fgetsSuccess = !(T10_);
						{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAllFile_systemZio_343)(FILE* file, NI64 len) {
	...
	bytes = readBuffer_systemZio_144(file, ((void*) ((&result->data[((NI) 0)]))), ((NI) (len)));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = endOfFile_systemZio_339(file);
		if (!T3_) goto LA4_;
		{
	...
	LA4_: ;
	{
		...
		T11_ = readAllBuffer_systemZio_330(file);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAll_systemZio_352)(FILE* file) {
	...
	result = (NimStringDesc*)0;
	{
		...
		len = rawFileSize_systemZio_335(file);
	}
	goto LA1_;
	LA3_: ;
	{
	...
	LA1_: ;
	{
		...
		result = readAllFile_systemZio_343(file, len);
	}
	goto LA6_;
	LA8_: ;
	{
		result = readAllBuffer_systemZio_330(file);
	}
	LA6_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readFile_systemZio_471)(NimStringDesc* filename) {
	...
	f = ((FILE*) NIM_NIL);
	{
		...
		result = readAll_systemZio_352(f);
		popSafePoint();
		}
		else {
			popSafePoint();
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readLine_systemZio_273)(FILE* f) {
	...
	result = rawNewString(((NI) 80));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = readLine_systemZio_240(f, (&result));
		if (!!(T3_)) goto LA4_;
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = res;
					{
						NIM_BOOL T11_;
						T11_ = (NIM_BOOL)0;
						T11_ = readLine_systemZio_240(f, (&result->data[i]));
						if (!!(T11_)) goto LA12_;
						raiseEOF_systemZio_117();
					}
					LA12_: ;
...
{	result = (NIM_BOOL)0;
	oshandle = filehandle;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = setInheritable_systemZio_235(oshandle, NIM_FALSE);
		if (!!(T3_)) goto LA4_;
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	LA4_: ;
	(*f) = fdopen(filehandle, FormatOpen_systemZio_373[(mode)- 0]);
...
N_LIB_PRIVATE N_NIMCALL(void, setFilePos_systemZio_438)(FILE* f, NI64 pos, tyEnum_FileSeekPos__I9aQjuvWxs8BspGbxwsngWw relativeTo) {
	{
		...
		if (!!((T3_ == ((NI32) 0)))) goto LA4_;
		raiseEIO_systemZio_96(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_11));
	}
	LA4_: ;
}
N_LIB_PRIVATE N_NIMCALL(NI64, getFilePos_systemZio_451)(FILE* f) {
	...
	result = ftello(f);
	{
		...
		raiseEIO_systemZio_96(((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_12));
	}
	LA3_: ;
	return result;
}
