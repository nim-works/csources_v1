...
N_LIB_PRIVATE N_NIMCALL(NI, myhash_pureZstrtabs_101)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {
	...
	{
		result = hash_pureZhashes_291(key);
	}
	break;
	case ((tyEnum_StringTableMode__G9c4wVDFIzf0xHmQvxso9a9cQ) 1):
	{
		result = hashIgnoreCase_pureZhashes_365(key);
	}
	break;
	case ((tyEnum_StringTableMode__G9c4wVDFIzf0xHmQvxso9a9cQ) 2):
	{
		result = hashIgnoreStyle_pureZhashes_302(key);
	}
	break;
	}
	return result;
		...
		while (1) {
			if (!(i < (f ? f->Sup.len : 0))) goto LA2;
			{
				...
				case 123:
				{
					...
					T13_ = substr_system_7713(f, (NI)(i + ((NI) 2)), (NI)(j - ((NI) 1)));
...
appendString(result, T14_);
				...
				case 95:
				{
					...
					T20_ = substr_system_7713(f, (NI)(i + ((NI) 1)), (NI)(j_2 - ((NI) 1)));
