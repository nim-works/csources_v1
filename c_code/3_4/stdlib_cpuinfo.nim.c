...
#define nimfr_(x, y)
#define nimln_(x, y)
typedef int tyArray__bNYpESPCY8JI9aeo9cc9bF9bqA[4];
#include <sys/types.h>
...
N_LIB_PRIVATE N_NIMCALL(NI, ncpicountProcessors)(void) {
	NI result;
	tyArray__bNYpESPCY8JI9aeo9cc9bF9bqA mib;
	NI numCPU;
	size_t len;
	int T1_;
	result = (NI)0;
	nimZeroMem((void*)mib, sizeof(tyArray__bNYpESPCY8JI9aeo9cc9bF9bqA));
	numCPU = (NI)0;
	mib[(((NI) 0))- 0] = ((int) 6);
	mib[(((NI) 1))- 0] = ((int) 25);
	len = ((size_t) 8);
