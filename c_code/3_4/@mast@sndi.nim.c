...
{nimErr_ = nimErrorFlag();
	T1_ = (NIM_BOOL)0;
	T1_ = isEmpty__frontZoptions_7847(filename);
...
appendString((&(*f).buf), TM__QVKrxgdkvZgAHGFrhgVOcA_5);
	...
	write__systemZio_364((*f).f, T2_, 2);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	{
		...
		T5_ = (FILE*)0;
		T5_ = open__systemZio_495((*f).filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1), ((NI) 8000));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*f).f = T5_;
		{
			NimStringV2 colontmp_;
