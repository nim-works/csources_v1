...
appendString((&T9_), colontmp__4);
			...
			colontmp__9 = (NIM_BOOL)0;
			{
				...
				LA14_: ;
				colontmp__9 = open__systemZio_451(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			} LA10: ;
			{
				...
				colontmp__10 = readAll__systemZio_409(f);
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
				colontmp__11 = ((NI) 0);
					...
					*nimErr_ = NIM_FALSE;
					{
						...
						eqsink___pureZosproc_1461((&result), colontmp__18);
					}
					LA45_: ;
					popCurrentException();
					LA41_:;
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObj(nimBorrowCurrentException()->Sup.m_type, "|IOError|CatchableError|Exception|RootObj|")||isObj(nimBorrowCurrentException()->Sup.m_type, "|OSError|CatchableError|Exception|RootObj|")) {
				...
				*nimErr_ = NIM_FALSE;
				...
				eqsink___pureZosproc_1461((&result), colontmp__25);
				popCurrentException();
				LA66_:;
			}
		}
