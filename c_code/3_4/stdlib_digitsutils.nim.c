...
static N_INLINE(void, addChars__stdZprivateZdigitsutils_112)(NimStringV2* result, tyArray__mf9b1MxcbbO8m6k6hFxfAZQ x, NI start, NI n);
static N_INLINE(void, copyMem__system_1708)(void* dest, void* source, NI size);
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size);
static N_INLINE(NIM_BOOL*, nimErrorFlag)(void);
N_LIB_PRIVATE NIM_CONST tyArray__xsuWitWNns1oLZx3sgozKQ digits100__stdZprivateZdigitsutils_2 = {48,
48,
48,
49,
48,
...
57}
;
N_LIB_PRIVATE NIM_CONST tyArray__cNnYwm38pticEaUrUwcIVQ trailingZeros100__stdZprivateZdigitsutils_1 = {((NI8) 2),
((NI8) 0),
((NI8) 0),
((NI8) 0),
((NI8) 0),
...
{nimErr_ = nimErrorFlag();
	...
	copyMem__system_1708(((void*) ((&(*result).p->data[old]))), ((void*) ((&x[(start)- 0]))), ((NI) (n)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
}
static N_INLINE(void, addIntImpl__stdZprivateZdigitsutils_71)(NimStringV2* result, NU64 x) {
	tyArray__mf9b1MxcbbO8m6k6hFxfAZQ tmp;
	NU64 num;
	NI next;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	...
	next = ((NI) 23);
	{
		while (1) {
			...
			NU64 index;
			{
				if (!!(((NU64)(100ULL) <= (NU64)(num)))) goto LA5_;
				goto LA2;
			}
			LA5_: ;
			originNum = num;
	...
	}
	{
		NU64 index_2;
		{
			if (!((NU64)(num) < (NU64)(10ULL))) goto LA10_;
...
{nimErr_ = nimErrorFlag();
	numX60gensym3_ = (NU64)0;
	{
		{
			NI baseX60gensym3_;
			if (!(x < IL64(0))) goto LA4_;
			{
				{
					if (!(x == (IL64(-9223372036854775807) - IL64(1)))) goto LA9_;
