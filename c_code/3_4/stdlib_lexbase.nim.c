...
N_LIB_PRIVATE N_NIMCALL(void, skipUtf8Bom__pureZlexbase_112)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L);
N_LIB_PRIVATE N_NIMCALL(NI, fillBaseLexer__pureZlexbase_68)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L, NI pos);
...
{nimErr_ = nimErrorFlag();
	...
	toCopy = (NI)((*L).buf.len - (NI)((*L).sentinel + ((NI) 1)));
	{
		...
		moveMem__system_1712(T5_, ((void*) ((&(*L).buf.p->data[(NI)((*L).sentinel + ((NI) 1))]))), ((NI) (toCopy)));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	T6_ = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
	T6_ = (*L).input;
	T7_ = dotdot___pureZunicode_935(toCopy, (NI)((NI)((NI)(toCopy + (*L).sentinel) + ((NI) 1)) - ((NI) 1)));
	charsRead = readDataStr__pureZstreams_81(T6_, (&(*L).buf), T7_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			...
			while (1) {
				{
					while (1) {
						...
						colontmp_ = (NIM_BOOL)0;
						{
							...
							LA20_: ;
							colontmp_ = !((((*L).refillChars[(NU)(((NU8)((*L).buf.p->data[s])))>>3] &(1U<<((NU)(((NU8)((*L).buf.p->data[s])))&7U)))!=0));
						} LA17: ;
						{
				...
				{
					tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ* T31_;
					tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA T32_;
					{
						if (!(((NI) 0) <= s)) goto LA29_;
						(*L).sentinel = s;
						goto LA13;
					}
					LA29_: ;
					...
					T31_ = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
					T31_ = (*L).input;
					T32_ = dotdot___pureZunicode_935(oldBufLen, (NI)((*L).buf.len - ((NI) 1)));
					charsRead = readDataStr__pureZstreams_81(T31_, (&(*L).buf), T32_);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					{
						if (!(charsRead < oldBufLen)) goto LA35_;
						nimPrepareStrMutationV2((&(*L).buf));
...
N_LIB_PRIVATE N_NIMCALL(void, skipUtf8Bom__pureZlexbase_112)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L) {
	...
	{
		{
			colontmp_ = ((NU8)((*L).buf.p->data[((NI) 0)]) == (NU8)(239));
			{
				if (!!(colontmp_)) goto LA5_;
				goto LA2;
			}
			LA5_: ;
			colontmp_ = ((NU8)((*L).buf.p->data[((NI) 1)]) == (NU8)(187));
		} LA2: ;
		...
		LA9_: ;
		colontmp__2 = ((NU8)((*L).buf.p->data[((NI) 2)]) == (NU8)(191));
	} LA1: ;
	{
...
{nimErr_ = nimErrorFlag();
	colontmp_ = &(*L).input;
	eqcopy___pureZstreams_630(colontmp_, input, NIM_TRUE);
	(*L).bufpos = ((NI) 0);
	(*L).offsetBase = ((NI) 0);
	nimCopyMem((void*)(*L).refillChars, (NIM_CONST void*)refillChars, 32);
	colontmp__2 = (&(*L).buf);
	colontmp__3 = mnewString(((NI) (bufLen)));
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		result = fillBaseLexer__pureZlexbase_68(L, result);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA3_: ;
	(*L).lineStart = result;
