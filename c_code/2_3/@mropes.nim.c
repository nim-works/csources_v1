...
appendString(T58_, frmt);
			...
			} LA59: ;
			{
				...
				T70_ = substr_system_7723(frmt, start, (NI)(i - ((NI) 1)));
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, equalsFile_ropes_453)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA* r, NimStringDesc* filename) {
	...
	result = (NIM_BOOL)0;
	f = (FILE*)0;
	result = open_systemZio_389(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
	{
		if (!result) goto LA3_;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, writeRope_ropes_241)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA* head, NimStringDesc* filename) {
	...
	f = (FILE*)0;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = open_systemZio_389(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1), ((NI) -1));
		if (!T3_) goto LA4_;
		{
