	...
	{
		{
			...
			LA5_: ;
			T7_ = (NIM_CHAR)0;
			T7_ = X5BX5D___system_7153(tail, ((NI) 1));
		...
		LA10_: ;
		{
			...
			LA15_: ;
			{
				...
				LA20_: ;
				T22_ = (NIM_CHAR*)0;
				T22_ = X5BX5D___system_7192(result, ((NI) 1));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	{
		{
			...
			T24_ = substr__system_7563(path, ((NI) 0), colontmp__2);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			result.Field0 = T24_;
			T25_.len = 0; T25_.p = NIM_NIL;
			T25_ = substr__system_7575(path, (NI)(sepPos + ((NI) 1)));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			result.Field1 = T25_;
			goto LA13;
		}
				...
				i = res;
				{
					...
					} LA9: ;
					{
						if (!colontmp__6) goto LA16_;
						{
							...
							T28_ = substr__system_7563(path, ((NI) 0), colontmp__7);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							result.Field0 = T28_;
							namePos = (NI)(i + ((NI) 1));
						}
						LA20_: ;
						{
							NimStringV2 T36_;
							{
								...
								T34_ = substr__system_7563(path, namePos, (NI)(dotPos - ((NI) 1)));
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								result.Field1 = T34_;
								T35_.len = 0; T35_.p = NIM_NIL;
								T35_ = substr__system_7575(path, dotPos);
								if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
								result.Field2 = T35_;
								goto LA29;
							}
							...
							T36_ = substr__system_7575(path, namePos);
							if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
							result.Field1 = T36_;
						} LA29: ;
						goto LA1;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___system_3234(colontmp_, colontmp__2);
	{
		...
		colontmp__3 = (NIM_BOOL)0;
		{
			...
			LA9_: ;
			T11_ = (NIM_CHAR*)0;
			T11_ = X5BX5D___system_7192((&(*e).Sup.Sup.message), ((NI) 1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		while (1) {
			{
				NI32 err;
				{
					...
					T7_ = (NIM_BOOL)0;
					T7_ = eqeq___system_7543(T6_, ((NCSTRING) NIM_NIL));
					if (!!(T7_)) goto LA8_;
					T10_ = (int)0;
		...
		while (1) {
			{
				...
				colontmp__10 = (NIM_BOOL)0;
				{
					...
					LA69_: ;
					T71_ = (NIM_CHAR*)0;
					T71_ = X5BX5D___system_7192((&result), ((NI) 1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		...
		while (1) {
			{
				...
				colontmp__11 = (NIM_BOOL)0;
				{
					...
					LA90_: ;
					T92_ = (NIM_CHAR*)0;
					T92_ = X5BX5D___system_7192((&result), ((NI) 1));
					if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		NIM_BOOL colontmp__4;
		{
			...
			colontmp__3 = substr__system_7563(result, ((NI) 0), sepPos);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		...
		colontmp__4 = (NIM_BOOL)0;
		{
			...
			LA19_: ;
			T21_ = (NIM_CHAR*)0;
			T21_ = X5BX5D___system_7192((&result), ((NI) 1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
			...
			while (1) {
				...
				i = res;
				{
					if (!(((NU8)(dir.p->data[i])) == ((NU8)(47)) || ((NU8)(dir.p->data[i])) == ((NU8)(47)))) goto LA10_;
					{
						...
						colontmp__4 = substr__system_7563(dir, ((NI) 0), (NI)(i - ((NI) 1)));
	...
	colontmp__5 = (NIM_BOOL)0;
	{
		...
		LA29_: ;
		T31_ = (NIM_CHAR)0;
		T31_ = X5BX5D___system_7153(dir, ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				...
				{
					{
						...
						addEscapedChar__system_7277(s, c);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						goto LA8;
					}
					LA11_: ;
...
{	result.len = 0; result.p = NIM_NIL;
	env = getenv(nimToCStringConv(key));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = eqeq___system_7543(env, ((NCSTRING) NIM_NIL));
		if (!T3_) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		LA13_: ;
		{
			...
			colontmp__5 = substr__system_7575(path, ((NI) 2));
			if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		...
		if (!colontmp_) goto LA8_;
		{
			...
			splitsX60gensym36_ = ((NI) -1);
			{
				while (1) {
					...
					LA32_: ;
					colontmp__4 = substr__system_7563(colontmp__2, firstX60gensym36_, (NI)(lastX60gensym36_ - ((NI) 1)));
...
appendString((&T7_), colontmp_);
		...
		T11_.len = 0; T11_.p = NIM_NIL;
		colontmp__5 = substr__system_7563(filename, ((NI) 0), (NI)(extPos - ((NI) 1)));
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		...
		splitsX60gensym33_ = ((NI) -1);
		{
			while (1) {
				...
				LA44_: ;
				colontmp__3 = substr__system_7563(path, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
...
{	result = (NIM_BOOL)0;
	...
	T2_ = (NIM_BOOL)0;
	T2_ = eqeq___system_7543(T1_, ((NCSTRING) NIM_NIL));
	result = !(T2_);
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
