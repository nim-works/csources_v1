...
{nimErr_ = nimErrorFlag();
	...
	LA18_: ;
	result = substr__system_7563(s, first, last);
		...
		LA4_: ;
		{
			...
			i = ((NI) 0);
			{
				while (1) {
					...
					LA15_: ;
					colontmp__2 = substr__system_7563(s, i, (NI)(j - ((NI) 1)));
					if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
...
appendString((&result), by);
			...
			colontmp__3 = substr__system_7575(s, i);
			if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
...
appendString((&result), colontmp_);
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				LA23_: ;
				colontmp__5 = substr__system_7563(s, i_2, (NI)(j_2 - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&result), by);
		...
		colontmp__4 = substr__system_7575(s, i_2);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		splitsX60gensym33_ = maxsplit;
		{
			while (1) {
				...
				LA21_: ;
				xX60gensym66_ = substr__system_7563(s, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				xX60gensym75_ = substr__system_7563(s, first, colontmp_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				colontmp__5 = substr__system_7563(s, first, colontmp_);
	...
	result = ((NI) 2147483647);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				colontmp__4 = substr__system_7563(s, first, colontmp_);
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmp_ = substr__system_7575(s, ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
