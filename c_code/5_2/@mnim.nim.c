...
static N_INLINE(NimStringDesc*, findNodeJs_nodejs_2)(void) {
	NimStringDesc* result;
	result = (NimStringDesc*)0;
	result = findExe_pureZos_644(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_16), NIM_TRUE, ExeExts_pureZos_643, 1);
	{
		if (!((result ? result->Sup.len : 0) == ((NI) 0))) goto LA3_;
		result = findExe_pureZos_644(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_17), NIM_TRUE, ExeExts_pureZos_643, 1);
	}
	LA3_: ;
	{
