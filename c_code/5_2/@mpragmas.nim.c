...
N_LIB_PRIVATE N_NIMCALL(void, setExternName_pragmas_238)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, NimStringDesc* extname, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	LA3_: ;
	{
		NIM_BOOL T6_;
		T6_ = (NIM_BOOL)0;
		T6_ = contains_pureZos_651(extname->data, (extname ? extname->Sup.len : 0), 36);
		if (!!(T6_)) goto LA7_;
...
appendString(T13_, ((NimStringDesc*) &TM__tPA3StZ6VsKyoznyrIfFxg_18));
	...
	LA1_: ;
	{
		...
		if (!(T16_)) goto LA17_;
		T18_ = (NIM_BOOL)0;
		T18_ = contains_pureZos_651(extname->data, (extname ? extname->Sup.len : 0), 36);
		T16_ = !(T18_);
		LA17_: ;
		if (!T16_) goto LA19_;
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					m = v_2;
					{
						...
						T19_ = substr_system_7766(reprEnum((NI)m, (&NTItmagic__shZhZOdbVC5nnFvcXQAImg_)), ((NI) 1));
		...
		a = ((NI) 0);
		{
			while (1) {
				...
				b = nsuFindChar(str, marker, ((NI) (a)), ((NI) 0));
				{
					...
					sub = substr_system_7766(str, a);
				}
				goto LA14_;
				LA16_: ;
				{
					sub = substr_system_7754(str, a, (NI)(b - ((NI) 1)));
				}
				LA14_: ;
				{
				...
				c = nsuFindChar(str, marker, ((NI) ((NI)(b + ((NI) 1)))), ((NI) 0));
				{
					...
					sub = substr_system_7766(str, (NI)(b + ((NI) 1)));
				}
				goto LA28_;
				LA30_: ;
				{
					sub = substr_system_7754(str, (NI)(b + ((NI) 1)), (NI)(c - ((NI) 1)));
				}
				LA28_: ;
				{
					NIM_BOOL amb;
