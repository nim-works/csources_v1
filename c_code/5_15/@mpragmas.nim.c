...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isPowerOfTwo_pureZmath_174)(NI x);
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq__pragmas_1672)(tySequence__ehmV9bTklH2Gt9cXHV9c0HLeQ** s, tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA x, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw** b, NI bLen_0) {
	...
	LA3_: ;
	{
		NI shiftX60gensym635_;
		NI newLenX60gensym635_;
		NI T9_;
		shiftX60gensym635_ = (NI)(bLen_0 - ((((NI) 0) >= L) ? ((NI) 0) : L));
		T9_ = ((*s) ? (*s)->Sup.len : 0);
		newLenX60gensym635_ = (NI)(T9_ + shiftX60gensym635_);
		{
			if (!(((NI) 0) < shiftX60gensym635_)) goto LA12_;
			unsureAsgnRef((void**) (&(*s)), (tySequence__ehmV9bTklH2Gt9cXHV9c0HLeQ*) setLengthSeqV2(&((*s))->Sup, (&NTItnodeseq__ehmV9bTklH2Gt9cXHV9c0HLeQ_), ((NI) (newLenX60gensym635_))));
			{
				NI iX60gensym635_;
				NI colontmp_;
				NI colontmp__2;
				...
				colontmp_ = (NI)0;
				colontmp__2 = (NI)0;
				colontmp_ = (NI)(newLenX60gensym635_ - ((NI) 1));
				...
				res = colontmp_;
				{
					while (1) {
						...
						iX60gensym635_ = res;
						asgnRef((void**) (&(*s)->data[iX60gensym635_]), (*s)->data[(NI)(iX60gensym635_ - shiftX60gensym635_)]);
						res -= ((NI) 1);
					} LA16: ;
				}
			}
		...
		{
			{
				...
				NI colontmp__4;
				NI res_2;
				iX60gensym635__2 = (NI)0;
				colontmp__3 = (NI)0;
				colontmp__4 = (NI)0;
				colontmp__3 = (NI)(a + bLen_0);
				colontmp__4 = (NI)(newLenX60gensym635_ - ((NI) 1));
				res_2 = colontmp__3;
				{
					while (1) {
						if (!(res_2 <= colontmp__4)) goto LA20;
						iX60gensym635__2 = res_2;
						asgnRef((void**) (&(*s)->data[iX60gensym635__2]), (*s)->data[(NI)(iX60gensym635__2 - shiftX60gensym635_)]);
						res_2 += ((NI) 1);
					} LA20: ;
				}
			}
		...
		LA10_: ;
		{
			...
			i_3 = ((NI) 0);
			{
				while (1) {
					...
					iX60gensym635__3 = i_3;
					asgnRef((void**) (&(*s)->data[(NI)(a + iX60gensym635__3)]), b[iX60gensym635__3]);
					i_3 += ((NI) 1);
				} LA23: ;
			}
		}
...
N_LIB_PRIVATE N_NIMCALL(void, setExternName_pragmas_238)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, NimStringDesc* extname, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	LA3_: ;
	{
		NIM_BOOL T6_;
		T6_ = (NIM_BOOL)0;
		T6_ = contains_pureZos_660(extname->data, (extname ? extname->Sup.len : 0), 36);
		if (!!(T6_)) goto LA7_;
...
appendString(T13_, ((NimStringDesc*) &TM__tPA3StZ6VsKyoznyrIfFxg_18));
	...
	LA1_: ;
	{
		...
		if (!(T16_)) goto LA17_;
		T18_ = (NIM_BOOL)0;
		T18_ = contains_pureZos_660(extname->data, (extname ? extname->Sup.len : 0), 36);
		T16_ = !(T18_);
		LA17_: ;
		if (!T16_) goto LA19_;
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					m = v_2;
					{
						...
						T19_ = substr_system_7747(reprEnum((NI)m, (&NTItmagic__shZhZOdbVC5nnFvcXQAImg_)), ((NI) 1));
...
N_LIB_PRIVATE N_NIMCALL(void, processCompile_pragmas_1073)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	LA1_: ;
	{
		...
		found = slash__pureZos_121(T17_, s);
		{
			...
			T19_ = (int)0;
			T19_ = glob(nimToCStringConv(found), ((int) 0), NIM_NIL, (&fX60gensym138_));
			resX60gensym138_ = ((NI) (T19_));
			...
			{
				if (!(resX60gensym138_ == ((NI) 0))) goto LA22_;
				{
					NI iX60gensym138_;
					NI colontmp_;
					NI res;
					iX60gensym138_ = (NI)0;
					colontmp_ = (NI)0;
					colontmp_ = (NI)(fX60gensym138_.gl_pathc - ((NI) 1));
					res = ((NI) 0);
					{
						while (1) {
							...
							pathX60gensym138_ = cstrToNimstr(fX60gensym138_.gl_pathv[iX60gensym138_]);
							{
								...
								NimStringDesc* T33_;
								T29_ = (NIM_BOOL)0;
								T29_ = nosfileExists(pathX60gensym138_);
								if (!T29_) goto LA30_;
								f = pathX60gensym138_;
		...
		a = ((NI) 0);
		{
			while (1) {
				...
				b = nsuFindChar(str, marker, ((NI) (a)), ((NI) 0));
				{
					...
					sub = substr_system_7747(str, a);
				}
				goto LA14_;
				LA16_: ;
				{
					sub = substr_system_7735(str, a, (NI)(b - ((NI) 1)));
				}
				LA14_: ;
				{
				...
				c = nsuFindChar(str, marker, ((NI) ((NI)(b + ((NI) 1)))), ((NI) 0));
				{
					...
					sub = substr_system_7747(str, (NI)(b + ((NI) 1)));
				}
				goto LA28_;
				LA30_: ;
				{
					sub = substr_system_7735(str, (NI)(b + ((NI) 1)), (NI)(c - ((NI) 1)));
				}
				LA28_: ;
				{
					NIM_BOOL amb;
...
appendString(T63_, reprEnum((NI)(*(*(*c).graph).config).backend, (&NTItbackend__4OBsgZ9cscH2JLUE5Wcz01g_)));
			...
			case ((tyEnum_TSpecialWord__ycbpMCRV6Cd2eBh3X9biEiw) 104):
			{
				...
				alignment = expectIntLit_pragmas_375(c, it);
				{
					NIM_BOOL T105_;
					T105_ = (NIM_BOOL)0;
					T105_ = isPowerOfTwo_pureZmath_174(alignment);
