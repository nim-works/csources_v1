...
{	result = (NIM_BOOL)0;
	{
		...
		xX60gensym7_ = ret;
		T3_ = (NIM_BOOL)0;
		T3_ = containsOrIncl_astalgo_402(marker, (NI)((NI)((NU32)(((NI) ((*xX60gensym7_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym7_).Sup.itemId.item))));
		if (!T3_) goto LA4_;
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	...
	LA8_: ;
	{
		NIM_BOOL T12_;
		T12_ = (NIM_BOOL)0;
		T12_ = compareTypes_types_2659(arg, ret, ((tyEnum_TDistinctCompare__9bNKHGs63atuMFXnAleTveg) 1), 0);
		if (!T12_) goto LA13_;
		result = NIM_TRUE;
		goto BeforeRet_;
	}
					...
					while (1) {
						...
						LA18_: ;
						{
							...
							argType = (*(*n)._kind_6.sons->data[i]).typ;
							{
								...
								if (!(T24_)) goto LA25_;
								T26_ = (NIM_BOOL)0;
								T26_ = isCompileTimeOnly_types_3516(argType);
								T24_ = !(T26_);
								LA25_: ;
								T23_ = T24_;
								if (!(T23_)) goto LA27_;
