...
{	result = (tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog)0;
	{
		...
		xX60gensym87_ = t;
		T3_ = (NIM_BOOL)0;
		T3_ = containsOrIncl_astalgo_402(marker, (NI)((NI)((NU32)(((NI) ((*xX60gensym87_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym87_).Sup.itemId.item))));
		if (!T3_) goto LA4_;
		result = ((tyEnum_ViewTypeKind__3S4FAWaxPP9ahVaUnMsznog) 0);
		goto BeforeRet_;
	}
...
{	result = (tyObject_TType__facALICuu8zUj0hjvbTLFg*)0;
	...
	LA3_: ;
	{
		...
		xX60gensym6_ = typ;
		T7_ = (NIM_BOOL)0;
		T7_ = containsOrIncl_astalgo_402(marker, (NI)((NI)((NU32)(((NI) ((*xX60gensym6_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym6_).Sup.itemId.item))));
		if (!T7_) goto LA8_;
		result = ((tyObject_TType__facALICuu8zUj0hjvbTLFg*) NIM_NIL);
		goto BeforeRet_;
	}
