...
N_LIB_PRIVATE N_NIMCALL(tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ*, createStream_pureZosproc_598)(int* handle, tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg fileMode);
...
STRING_LITERAL(TM__HZdw8BhppcTQo8DIK46LSg_12, "osproc.nim(1357, 22) `false` unreachable!", 41);
...
{	result = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
	{
		...
		T5_ = createStream_pureZosproc_598((&(*p).inHandle), ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1));
...
{	result = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
	{
		...
		T5_ = (tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ*)0;
		T5_ = createStream_pureZosproc_598((&(*p).outHandle), ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0));
...
{	result = (NI)0;
			...
			while (1) {
				...
				count = wait_for_objects_etc((&info), ((int) 1), ((NU32) 8), ((NI64) (timeout)));
				{
					...
					err = ((int) (count));
					{
						if (!(err == ETIMEDOUT)) goto LA25_;
						{
							...
							raiseOSError_pureZos_405(T32_, ((NimStringDesc*) NIM_NIL));
						}
						LA30_: ;
						{
							pid_t T35_;
				...
				LA21_: ;
				{
					if (!(((NI) 0) < count)) goto LA43_;
					{
						...
						T50_ = (NI32)0;
						T50_ = osLastError_pureZos_408();
						raiseOSError_pureZos_405(T50_, ((NimStringDesc*) NIM_NIL));
					}
					LA48_: ;
					(*p).exitFlag = NIM_TRUE;
					(*p).exitStatus = status_2;
				...
				{
					{
						...
						failedAssertImpl_systemZassertions_56(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_12));
					}
					LA54_: ;
				}
				LA19_: ;
	...
	LA6_: ;
	T56_ = (int)0;
	T56_ = exitStatusLikeShell_pureZos_1098((*p).exitStatus);
	result = ((NI) (T56_));
	}BeforeRet_: ;
	return result;
}
