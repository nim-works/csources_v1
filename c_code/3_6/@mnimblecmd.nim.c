...
N_LIB_PRIVATE N_NIMCALL(void, getPathVersionChecksum_nimblecmd_171)(NimStringDesc* p, tyTuple__7q7q3E6Oj24ZNVJb9aonhAg* Result) {
	...
	checksumSeparatorIndex = nsuRFindChar(p, 45, ((NI) 0), ((NI) -1));
	{
		...
		unsureAsgnRef((void**) (&(*Result).Field2), substr_system_7756(p, (NI)(checksumSeparatorIndex + ((NI) 1))));
		{
			NIM_BOOL T7_;
			T7_ = (NIM_BOOL)0;
	...
	versionSeparatorIndex = nsuRFindStr(p, ((NimStringDesc*) &TM__asNQM9aynXXg9ccUABbReyew_5), ((NI) 0), (NI)(checksumSeparatorIndex - ((NI) 1)));
	{
		...
		unsureAsgnRef((void**) (&(*Result).Field1), substr_system_7744(p, (NI)(versionSeparatorIndex + ((NI) 1)), (NI)(checksumSeparatorIndex - ((NI) 1))));
	}
	goto LA11_;
	LA13_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath_nimblecmd_2053)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	resultX60gensym38_ = NIM_NIL;
	{
		...
		T2_ = (int)0;
		T2_ = glob(nimToCStringConv(colontmp_), ((int) 0), NIM_NIL, (&fX60gensym130_));
		resX60gensym130_ = ((NI) (T2_));
		...
		{
			if (!(resX60gensym130_ == ((NI) 0))) goto LA5_;
			{
				NI iX60gensym130_;
				NI colontmp__2;
				NI res;
				iX60gensym130_ = (NI)0;
				colontmp__2 = (NI)0;
				colontmp__2 = (NI)(fX60gensym130_.gl_pathc - ((NI) 1));
				res = ((NI) 0);
				{
					while (1) {
						NimStringDesc* pathX60gensym130_;
						...
						pathX60gensym130_ = cstrToNimstr(fX60gensym130_.gl_pathv[iX60gensym130_]);
						{
							...
							xX60gensym38_ = pathX60gensym130_;
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							case ((NI) 0):
							{
								...
								LA49_: ;
								{
									...
									if (!T52_) goto LA53_;
									k_2 = getSymlinkFileKind_pureZos_1253(path);
								}
								goto LA42_;
								LA53_: ;
								LA42_: ;
