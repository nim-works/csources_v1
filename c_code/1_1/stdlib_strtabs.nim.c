	...
	{
		{
			...
			result = getEnv__pureZos_512(key, TM__ZT9crccxweoChVXn9cHcxIXQ_9);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			goto LA6;
		}
		LA9_: ;
			...
			{
				{
					...
					case 123:
					{
						...
						colontmp__5 = substr__system_7605(f, (NI)(i + ((NI) 2)), (NI)(j - ((NI) 1)));
...
appendString((&result), colontmp__2);
					...
					case 95:
					{
						...
						colontmp__10 = substr__system_7605(f, (NI)(i + ((NI) 1)), (NI)(j_2 - ((NI) 1)));
