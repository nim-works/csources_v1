...
N_LIB_PRIVATE N_NIMCALL(NI, rawGet_pureZstrtabs_121)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key);
N_LIB_PRIVATE N_NIMCALL(NI, myhash_pureZstrtabs_101)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key);
N_LIB_PRIVATE N_NIMCALL(NI, hash_pureZhashes_279)(NimStringDesc* x);
N_LIB_PRIVATE N_NIMCALL(NI, hashIgnoreCase_pureZhashes_353)(NimStringDesc* x);
N_LIB_PRIVATE N_NIMCALL(NI, hashIgnoreStyle_pureZhashes_290)(NimStringDesc* x);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, myCmp_pureZstrtabs_105)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* a, NimStringDesc* b);
...
static N_INLINE(NI, nextTry_pureZstrtabs_117)(NI h, NI maxHash);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, mustRehash_pureZstrtabs_110)(NI length, NI counter);
N_LIB_PRIVATE N_NIMCALL(void, enlarge_pureZstrtabs_199)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t);
N_LIB_PRIVATE N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_LIB_PRIVATE N_NIMCALL(void, rawInsert_pureZstrtabs_187)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, tySequence__xv3aaFd3JCw8NbmALHiezQ** data, NimStringDesc* key, NimStringDesc* val);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getValue_pureZstrtabs_317)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, tySet_tyEnum_FormatFlag__F4vlKAV4d0Kt9aXmu9cVNBrg flags, NimStringDesc* key);
...
N_LIB_PRIVATE N_NIMCALL(void, raiseFormatException_pureZstrtabs_314)(NimStringDesc* s);
...
N_LIB_PRIVATE N_NIMCALL(NI, myhash_pureZstrtabs_101)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {
	...
	{
		result = hash_pureZhashes_279(key);
	}
	break;
	case ((tyEnum_StringTableMode__G9c4wVDFIzf0xHmQvxso9a9cQ) 1):
	{
		result = hashIgnoreCase_pureZhashes_353(key);
	}
	break;
	case ((tyEnum_StringTableMode__G9c4wVDFIzf0xHmQvxso9a9cQ) 2):
	{
		result = hashIgnoreStyle_pureZhashes_290(key);
	}
	break;
	}
	return result;
...
{	result = (NI)0;
	T1_ = (NI)0;
	T1_ = myhash_pureZstrtabs_101(t, key);
	...
	h = (NI)(T1_ & T2_);
	{
		while (1) {
			...
			if (!(*t).data->data[h].Field2) goto LA4;
			{
				NIM_BOOL T7_;
				T7_ = (NIM_BOOL)0;
				T7_ = myCmp_pureZstrtabs_105(t, (*t).data->data[h].Field0, key);
				if (!T7_) goto LA8_;
				result = h;
				goto BeforeRet_;
			}
			...
			h = nextTry_pureZstrtabs_117(h, T10_);
		} LA4: ;
	}
	result = ((NI) -1);
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, nsthasKey)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {
	...
	result = (NIM_BOOL)0;
	T1_ = (NI)0;
	T1_ = rawGet_pureZstrtabs_121(t, key);
	result = (((NI) 0) <= T1_);
	return result;
}
static N_INLINE(void, nimCopyMem)(void* dest, void* source, NI size) {
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc**, nstTake)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {
	...
	indexX60gensym3_ = rawGet_pureZstrtabs_121(t, key);
	{
...
N_LIB_PRIVATE N_NIMCALL(void, rawInsert_pureZstrtabs_187)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, tySequence__xv3aaFd3JCw8NbmALHiezQ** data, NimStringDesc* key, NimStringDesc* val) {
	...
	h = (NI)(T1_ & T2_);
	{
		while (1) {
			...
			h = nextTry_pureZstrtabs_117(h, T5_);
		} LA4: ;
	}
	T6_ = (NimStringDesc*)0;
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = res;
				{
					...
					rawInsert_pureZstrtabs_187(t, (&n), T10_, T11_);
				}
				LA8_: ;
				res += ((NI) 1);
			} LA5: ;
...
N_LIB_PRIVATE N_NIMCALL(void, nstPut)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key, NimStringDesc* val) {
	NI index;
	index = rawGet_pureZstrtabs_121(t, key);
	{
		NimStringDesc* T5_;
	...
	{
		{
			...
			T10_ = (NIM_BOOL)0;
			T10_ = mustRehash_pureZstrtabs_110(T9_, (*t).counter);
			if (!T10_) goto LA11_;
			enlarge_pureZstrtabs_199(t);
		}
		LA11_: ;
		rawInsert_pureZstrtabs_187(t, (&(*t).data), key, val);
		(*t).counter += ((NI) 1);
	}
	LA1_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, del_pureZstrtabs_356)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t, NimStringDesc* key) {
	...
	NI msk;
	NI T1_;
	i = rawGet_pureZstrtabs_121(t, key);
				...
				while (1) {
					...
					asgnRef((void**) (&(*t).data->data[i].Field1), ((NimStringDesc*) NIM_NIL));
					{
						while (1) {
							...
							LA13_: ;
							T15_ = (NI)0;
							T15_ = myhash_pureZstrtabs_101(t, (*t).data->data[i].Field0);
							r = (NI)(T15_ & msk);
							{
								NIM_BOOL T18_;
								NIM_BOOL T19_;
...
{	result = (NimStringDesc*)0;
	{
		...
		T3_ = nsthasKey(t, key);
		if (!T3_) goto LA4_;
		result = getOrDefault_pureZstrtabs_173(t, key, ((NimStringDesc*) NIM_NIL));
		goto BeforeRet_;
	}
	LA4_: ;
	{
		if (!((flags &((NU8)1<<((NU)(((tyEnum_FormatFlag__F4vlKAV4d0Kt9aXmu9cVNBrg) 0))&7U)))!=0)) goto LA8_;
		result = getEnv_pureZos_475(key, ((NimStringDesc*) NIM_NIL));
	}
	goto LA6_;
	LA8_: ;
	{
...
appendString(T19_, key);
		...
		LA17_: ;
		{
			...
			raiseFormatException_pureZstrtabs_314(key);
		}
		goto LA15_;
		LA21_: ;
		LA15_: ;
		...
		while (1) {
			if (!(i < (f ? f->Sup.len : 0))) goto LA2;
			{
				...
				case 123:
				{
					...
					T13_ = substr_system_7798(f, (NI)(i + ((NI) 2)), (NI)(j - ((NI) 1)));
					T14_ = (NimStringDesc*)0;
					T14_ = getValue_pureZstrtabs_317(t, flags, T13_);
...
appendString(result, T14_);
				...
				case 95:
				{
					...
					T20_ = substr_system_7798(f, (NI)(i + ((NI) 1)), (NI)(j_2 - ((NI) 1)));
					T21_ = (NimStringDesc*)0;
					T21_ = getValue_pureZstrtabs_317(t, flags, T20_);
