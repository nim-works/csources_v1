...
N_LIB_PRIVATE N_NIMCALL(NI32, resolveMod_passes_160)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* module, NimStringDesc* relativeTo) {
	...
	NimStringDesc* fullPath;
	result = (NI32)0;
	fullPath = findModule_options_4499(conf, module, relativeTo);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isEmpty_options_4484(fullPath);
		if (!T3_) goto LA4_;
		result = ((NI32) -1);
	}
	goto LA1_;
...
{	result = (NIM_BOOL)0;
	...
	openPasses_passes_85(graph, a, module, idgen);
	{
		...
		s = llStreamOpen_llstream_69(filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0));
		{
			...
			liMessage_msgs_1117((*graph).config, unknownLineInfo_lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 4), filename, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Tko7U9cii9bC6Kt2otnwMmCg_5, NIM_FALSE);
			result = NIM_FALSE;
			goto BeforeRet_;
		}
		LA12_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, registerPass_passes_61)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tyTuple__4o9cW9aUwdGqgZI9bSHHYnbaQ p) {
	NI T6_;
	{
		...
		internalErrorImpl_msgs_1430((*g).config, unknownLineInfo_lineinfos_289, argX60gensym1_, TM__Tko7U9cii9bC6Kt2otnwMmCg_13);
	}
	LA4_: ;
