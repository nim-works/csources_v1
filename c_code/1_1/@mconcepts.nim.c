...
{	result = (NIM_BOOL)0;
	...
	{
		{
			...
			if (!T29_) goto LA31_;
			{
				...
				NI T38_;
				T35_ = (NIM_BOOL)0;
				T35_ = sameType_types_1815((*f).sons->data[((NI) 0)], (*a).sons->data[((NI) 0)], 0);
				if (!(T35_)) goto LA36_;
				T37_ = (NI)0;
				T37_ = len_ast_4001(f);
				T38_ = (NI)0;
	...
	case ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 12):
	{
		...
		LA55_: ;
		{
			...
			LA60_: ;
			{
				...
				xX60gensym32_ = old;
				T87_ = (NIM_BOOL)0;
				T87_ = containsOrIncl_astalgo_402((&(*m).marker), (NI)((NI)((NU32)(((NI) ((*xX60gensym32_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym32_).Sup.itemId.item))));
				if (!!(T87_)) goto LA88_;
	...
	{
		result = sameType_types_1815(f, a, 0);
	}
	break;
...
appendString(T14_, T15_);
		liMessage_msgs_1117((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T14_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__yT8oP4IKFRSvia7t9bb5q3Q_7, NIM_FALSE);
		result = n;
	}
	break;
	}
