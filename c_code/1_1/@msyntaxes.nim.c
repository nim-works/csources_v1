...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, setupParser_syntaxes_209)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, NI32 fileIdx, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config);
...
N_LIB_PRIVATE N_NIMCALL(NI, utf8Bom_syntaxes_22)(NimStringDesc* s);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, containsShebang_syntaxes_25)(NimStringDesc* s, NI i);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*, evalPipe_syntaxes_145)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* start);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
static N_INLINE(NIM_BOOL, equalMem_system_1735)(void* a, void* b, NI size);
static N_INLINE(int, nimCmpMem)(void* a, void* b, NI size);
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*, applyFilter_syntaxes_126)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* stdin_0);
N_LIB_PRIVATE N_NIMCALL(tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ, getFilter_syntaxes_69)(tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA* ident);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA*, getCallee_syntaxes_108)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n);
...
STRING_LITERAL(TM__Furs9bKK6tVLoyofH3f4bRw_2, "cannot open file: ", 18);
STRING_LITERAL(TM__Furs9bKK6tVLoyofH3f4bRw_4, "/home/saem/Development/nim/nimskull-csource-gen/compiler/syntaxes.nim", 69);
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__Furs9bKK6tVLoyofH3f4bRw_3 = {((NimStringDesc*) &TM__Furs9bKK6tVLoyofH3f4bRw_4),
((NI) 126),
((NI) 14)}
;
STRING_LITERAL(TM__Furs9bKK6tVLoyofH3f4bRw_5, "|", 1);
N_LIB_PRIVATE TNimType NTIfilterkind__1V25DjEfp9cP03SoY6ytxhQ_;
STRING_LITERAL(TM__Furs9bKK6tVLoyofH3f4bRw_9, "invalid filter: ", 16);
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__Furs9bKK6tVLoyofH3f4bRw_10 = {((NimStringDesc*) &TM__Furs9bKK6tVLoyofH3f4bRw_4),
((NI) 74),
((NI) 14)}
;
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__Furs9bKK6tVLoyofH3f4bRw_11 = {((NimStringDesc*) &TM__Furs9bKK6tVLoyofH3f4bRw_4),
((NI) 91),
((NI) 16)}
;
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__Furs9bKK6tVLoyofH3f4bRw_12 = {((NimStringDesc*) &TM__Furs9bKK6tVLoyofH3f4bRw_4),
((NI) 93),
((NI) 16)}
;
static N_INLINE(void, nimSetMem_systemZmemory_7)(void* a, int v, NI size) {
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, parsePipe_syntaxes_38)(NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* inputStream, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	...
	s = llStreamOpen_llstream_69(filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0));
	{
		...
		NI i;
		NI linenumber;
		if (!!((s == ((tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*) NIM_NIL)))) goto LA3_;
		line = rawNewString(((NI) 80));
		T5_ = (NIM_BOOL)0;
		T5_ = llStreamReadLine_llstream_194(s, (&line));
		(void)(T5_);
		i = utf8Bom_syntaxes_22(line);
		linenumber = ((NI) 1);
		{
			NIM_BOOL T8_;
			NIM_BOOL T11_;
			T8_ = (NIM_BOOL)0;
			T8_ = containsShebang_syntaxes_25(line, i);
			if (!T8_) goto LA9_;
			T11_ = (NIM_BOOL)0;
			T11_ = llStreamReadLine_llstream_194(s, (&line));
			(void)(T11_);
			i = ((NI) 0);
			linenumber += ((NI) 1);
		}
		LA9_: ;
		{
			...
			T24_ = substr_system_7810(line, i);
			T25_ = (tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*)0;
			T25_ = llStreamOpen_llstream_30(T24_);
			openParser_parser_131((&p), filename, T25_, cache, config);
			result = parseAll_parser_37((&p));
			closeParser_parser_39((&p));
		}
		LA18_: ;
		llStreamClose_llstream_110(s);
	}
	LA3_: ;
	return result;
}
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = v;
					{
						NI T7_;
						T7_ = (NI)0;
						T7_ = nsuCmpIgnoreStyle((*ident).s, reprEnum((NI)i, (&NTIfilterkind__1V25DjEfp9cP03SoY6ytxhQ_)));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TIdent__1LTsGP7bSxg45u9aHcxh6OA*, getCallee_syntaxes_108)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	LA8_: ;
	{
		...
		T12_ = renderTree_renderer_46(n, 0);
		T11_ = rawNewString((T12_ ? T12_->Sup.len : 0) + 16);
appendString(T11_, ((NimStringDesc*) &TM__Furs9bKK6tVLoyofH3f4bRw_9));
appendString(T11_, T12_);
		liMessage_msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T11_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__Furs9bKK6tVLoyofH3f4bRw_10, NIM_FALSE);
	}
	LA1_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*, applyFilter_syntaxes_126)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* filename, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* stdin_0) {
	...
	T1_ = getCallee_syntaxes_108((*p).lex.config, n);
	f = getFilter_syntaxes_69(T1_);
	switch (f) {
	...
	{
		result = filterTmpl_filter95tmpl_191((*p).lex.config, stdin_0, filename, n);
	}
	break;
	case ((tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ) 3):
	{
		result = filterStrip_filters_98((*p).lex.config, stdin_0, filename, n);
	}
	break;
	case ((tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ) 2):
	{
		result = filterReplace_filters_109((*p).lex.config, stdin_0, filename, n);
	}
	break;
	}
	{
		if (!!((f == ((tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ) 0)))) goto LA8_;
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = hasHint_options_515((*p).lex.config, ((tyEnum_TMsgKind__7VIi6mabc7hDxpCmSMYIug) 81));
			if (!T12_) goto LA13_;
			liMessage_msgs_1117((*p).lex.config, unknownLineInfo_lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 81), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_11, NIM_FALSE);
			msgWriteln_msgs_647((*p).lex.config, (*result).s, 0);
			liMessage_msgs_1117((*p).lex.config, unknownLineInfo_lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 82), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_12, NIM_FALSE);
		}
		LA13_: ;
	}
	LA8_: ;
...
{	result = (tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*)0;
	...
	LA3_: ;
	{
		...
		T7_ = T8_;
		if (!(T7_)) goto LA10_;
		T7_ = eqStrings((*(*(*n)._kind_6.sons->data[((NI) 0)])._kind_5.ident).s, ((NimStringDesc*) &TM__Furs9bKK6tVLoyofH3f4bRw_5));
		LA10_: ;
		if (!T7_) goto LA11_;
		{
			NI i;
			...
			res = ((NI) 1);
			{
				while (1) {
					...
					i = res;
					{
						...
						result = evalPipe_syntaxes_145(p, (*n)._kind_6.sons->data[i], filename, result);
					}
					goto LA16_;
					LA18_: ;
					{
						result = applyFilter_syntaxes_126(p, (*n)._kind_6.sons->data[i], filename, result);
					}
					LA16_: ;
					res += ((NI) 1);
				} LA15: ;
	...
	LA11_: ;
	{
		...
		result = evalPipe_syntaxes_145(p, (*n)._kind_6.sons->data[((NI) 0)], filename, result);
	}
	goto LA5_;
	LA22_: ;
	{
		result = applyFilter_syntaxes_126(p, n, filename, result);
	}
	LA5_: ;
	}BeforeRet_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, openParser_syntaxes_189)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, NI32 fileIdx, tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* inputstream, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	...
	tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* s;
	filename = toFullPathConsiderDirty_msgs_571(config, fileIdx);
	pipe = parsePipe_syntaxes_38(filename, inputstream, cache, config);
	unsureAsgnRef((void**) (&(*p).lex.config), config);
	{
		if (!!((pipe == ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL)))) goto LA3_;
		s = evalPipe_syntaxes_145(p, pipe, filename, inputstream);
	}
	goto LA1_;
	LA3_: ;
	{
	...
	LA1_: ;
	openParser_parser_125(p, fileIdx, s, cache, config);
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, setupParser_syntaxes_209)(tyObject_Parser__kUTcqfBOdi2S1yCsNNzzUw* p, NI32 fileIdx, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	NIM_BOOL result;
	NimStringDesc* filename;
...
appendString(T6_, ((NimStringDesc*) &TM__Furs9bKK6tVLoyofH3f4bRw_2));
appendString(T6_, filename);
		liMessage_msgs_1117(config, unknownLineInfo_lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T6_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__Furs9bKK6tVLoyofH3f4bRw_3, NIM_FALSE);
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	LA4_: ;
	T7_ = (tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g*)0;
	T7_ = llStreamOpen_llstream_63(f);
	openParser_syntaxes_189(p, fileIdx, T7_, cache, config);
	result = NIM_TRUE;
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, parseFile_syntaxes_217)(NI32 fileIdx, tyObject_IdentCachecolonObjectType___TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* config) {
	...
	objectInit((&p), (&NTIparser__kUTcqfBOdi2S1yCsNNzzUw_));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = setupParser_syntaxes_209((&p), fileIdx, cache, config);
		if (!T3_) goto LA4_;
		result = parseAll_parser_37((&p));
		closeParser_parser_39((&p));
	}
...
static TNimNode* TM__Furs9bKK6tVLoyofH3f4bRw_6_4[4];
NI TM__Furs9bKK6tVLoyofH3f4bRw_8;
static char* NIM_CONST TM__Furs9bKK6tVLoyofH3f4bRw_7[4] = {
"none", 
"stdtmpl", 
"replace", 
"strip"};
static TNimNode TM__Furs9bKK6tVLoyofH3f4bRw_0[5];
NTIfilterkind__1V25DjEfp9cP03SoY6ytxhQ_.size = sizeof(tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ);
NTIfilterkind__1V25DjEfp9cP03SoY6ytxhQ_.align = NIM_ALIGNOF(tyEnum_FilterKind__1V25DjEfp9cP03SoY6ytxhQ);
NTIfilterkind__1V25DjEfp9cP03SoY6ytxhQ_.kind = 14;
NTIfilterkind__1V25DjEfp9cP03SoY6ytxhQ_.base = 0;
NTIfilterkind__1V25DjEfp9cP03SoY6ytxhQ_.flags = 3;
for (TM__Furs9bKK6tVLoyofH3f4bRw_8 = 0; TM__Furs9bKK6tVLoyofH3f4bRw_8 < 4; TM__Furs9bKK6tVLoyofH3f4bRw_8++) {
TM__Furs9bKK6tVLoyofH3f4bRw_0[TM__Furs9bKK6tVLoyofH3f4bRw_8+0].kind = 1;
TM__Furs9bKK6tVLoyofH3f4bRw_0[TM__Furs9bKK6tVLoyofH3f4bRw_8+0].offset = TM__Furs9bKK6tVLoyofH3f4bRw_8;
TM__Furs9bKK6tVLoyofH3f4bRw_0[TM__Furs9bKK6tVLoyofH3f4bRw_8+0].name = TM__Furs9bKK6tVLoyofH3f4bRw_7[TM__Furs9bKK6tVLoyofH3f4bRw_8];
TM__Furs9bKK6tVLoyofH3f4bRw_6_4[TM__Furs9bKK6tVLoyofH3f4bRw_8] = &TM__Furs9bKK6tVLoyofH3f4bRw_0[TM__Furs9bKK6tVLoyofH3f4bRw_8+0];
}
TM__Furs9bKK6tVLoyofH3f4bRw_0[4].len = 4; TM__Furs9bKK6tVLoyofH3f4bRw_0[4].kind = 2; TM__Furs9bKK6tVLoyofH3f4bRw_0[4].sons = &TM__Furs9bKK6tVLoyofH3f4bRw_6_4[0];
NTIfilterkind__1V25DjEfp9cP03SoY6ytxhQ_.node = &TM__Furs9bKK6tVLoyofH3f4bRw_0[4];
}
