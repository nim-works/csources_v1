								...
								while (1) {
									...
									f = checkModuleName_modulepaths_21((*graph).config, (*a)._kind_6.sons->data[i_3], NIM_TRUE);
									{
										if (!!((f == ((NI32) -1)))) goto LA19_;
										{
											...
											liMessage_msgs_1117((*graph).config, (*a).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T27_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__wGDfi9c1BEw7VBzRnDQgLpQ_4, NIM_FALSE);
										}
										goto LA21_;
										LA24_: ;
										{
...
N_LIB_PRIVATE N_NIMCALL(NI, colonanonymous__reorder_439)(tyObject_DepNcolonObjectType___eVONEEaK4II8kv8La51d2Q* xX60gensym51_, tyObject_DepNcolonObjectType___eVONEEaK4II8kv8La51d2Q* yX60gensym51_) {
	...
	it = yX60gensym51_;
	bX60gensym51_ = (*it).id;
	result = cmp_system_7507(aX60gensym51_, bX60gensym51_);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, haveSameKind_reorder_358)(tySequence__76wc9cnTOK9c6epudv8uYE0w* dns) {
	NIM_BOOL result;
			...
			while (1) {
				...
				LA8_: ;
				{
					...
					LA16_: ;
					{
						...
						liMessage_msgs_1117(conf, (*(*cs->data[((NI) 0)]).pnode).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 67), wmsg, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__wGDfi9c1BEw7VBzRnDQgLpQ_13, NIM_FALSE);
						i_3 = ((NI) 0);
						{
							while (1) {
								NI T25_;
