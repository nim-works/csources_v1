...
appendString(T58_, frmt);
			...
			} LA59: ;
			{
				...
				T70_ = substr_system_7798(frmt, start, (NI)(i - ((NI) 1)));
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, equalsFile_ropes_453)(tyObject_RopeObj__OFzf0kSiPTcNreUIeJgWVA* r, NimStringDesc* filename) {
	...
	result = (NIM_BOOL)0;
	f = (FILE*)0;
	result = open_systemZio_487(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
	{
		if (!result) goto LA3_;
