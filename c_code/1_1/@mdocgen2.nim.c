...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, close_docgen50_27)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	groupedToc = NIM_TRUE;
	{
		...
		TM__87tQLGE73DKq5cz9cph1IqQ_4.status = setjmp(TM__87tQLGE73DKq5cz9cph1IqQ_4.context);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*, closeJson_docgen50_48)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TPassContext__Hb6rFM0ecvtlLf2kv9aU75w* p, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	groupedToc = NIM_TRUE;
	{
		...
		TM__87tQLGE73DKq5cz9cph1IqQ_6.status = setjmp(TM__87tQLGE73DKq5cz9cph1IqQ_6.context);
