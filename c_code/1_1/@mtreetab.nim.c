...
N_LIB_PRIVATE N_NIMCALL(NI, nodeTableRawGet_treetab_85)(tyObject_TNodeTable__wN7B39cKxLpMkvKNm9bduZ0A t, NI k, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* key);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, treesEquivalent_treetab_37)(tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* b);
...
N_LIB_PRIVATE N_NIMCALL(tySequence__vhmj4KkIKPinmRXny9c2Q6Q*, newSeq_treetab_163)(NI len);
N_LIB_PRIVATE N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_LIB_PRIVATE N_NIMCALL(void, nodeTableRawInsert_treetab_119)(tySequence__vhmj4KkIKPinmRXny9c2Q6Q** data, NI k, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* key, NI val);
...
{	result = (NI)0;
	...
	{
		result = emarkamp__pureZhashes_3(result, (*(*n)._kind_5.ident).h);
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 3):
	{
		...
		result = emarkamp__pureZhashes_3(result, (NI)((NI)((NU32)(((NI) ((*xX60gensym0_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym0_).Sup.itemId.item))));
	}
	break;
	...
	{
		{
			...
			LA12_: ;
			if (!T11_) goto LA13_;
			result = emarkamp__pureZhashes_3(result, ((NI) ((*n)._kind_1.intVal)));
		}
		LA13_: ;
	}
	break;
	...
	{
		{
			...
			if (!T18_) goto LA20_;
			T22_ = (NI)0;
			T22_ = toInt_system_1708((*n)._kind_2.floatVal);
			result = emarkamp__pureZhashes_3(result, T22_);
		}
		LA20_: ;
	}
	break;
	case ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 20) ... ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 22):
	{
		NI T24_;
		T24_ = (NI)0;
		T24_ = hash_pureZhashes_279((*n)._kind_3.strVal);
		result = emarkamp__pureZhashes_3(result, T24_);
	}
	break;
	default:
	{
		{
			...
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					T29_ = (NI)0;
					T29_ = hashTree_treetab_5((*n)._kind_6.sons->data[i]);
					result = emarkamp__pureZhashes_3(result, T29_);
					i_2 += ((NI) 1);
				} LA28: ;
			}
		}
					...
					i_2 = ((NI) 0);
					{
						while (1) {
							...
							i = i_2;
							{
								NIM_BOOL T30_;
								T30_ = (NIM_BOOL)0;
								T30_ = treesEquivalent_treetab_37((*a)._kind_6.sons->data[i], (*b)._kind_6.sons->data[i]);
								if (!!(T30_)) goto LA31_;
								goto BeforeRet_;
							}
							LA31_: ;
	...
	h = (NI)(k & T1_);
	{
		while (1) {
			...
			if (!!((t.data->data[h].key == ((tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*) NIM_NIL)))) goto LA3;
			{
				...
				if (!(T6_)) goto LA7_;
				T6_ = treesEquivalent_treetab_37(t.data->data[h].key, key);
				LA7_: ;
				if (!T6_) goto LA8_;
				result = h;
				goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(tySequence__vhmj4KkIKPinmRXny9c2Q6Q*, newSeq_treetab_163)(NI len) {
	...
	result = (tySequence__vhmj4KkIKPinmRXny9c2Q6Q*)0;
...
N_LIB_PRIVATE N_NIMCALL(NI, nodeTableTestOrSet_treetab_198)(tyObject_TNodeTable__wN7B39cKxLpMkvKNm9bduZ0A* t, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* key, NI val) {
	NI result;
	NI k;
	NI index;
	result = (NI)0;
	k = hashTree_treetab_5(key);
	index = nodeTableRawGet_treetab_85((*t), k, key);
	{
	...
	{
		{
			...
			n = newSeq_treetab_163(((NI) ((NI)(T12_ * ((NI) 2)))));
			{
				NI i;
				NI colontmp_;
				NI T14_;
				...
				res = ((NI) 0);
				{
					while (1) {
						...
						i = res;
						{
							...
							nodeTableRawInsert_treetab_119((&n), (*t).data->data[i].h, (*t).data->data[i].key, (*t).data->data[i].val);
						}
						LA19_: ;
						res += ((NI) 1);
					} LA16: ;
		...
		LA10_: ;
		nodeTableRawInsert_treetab_119((&(*t).data), k, key, val);
		result = val;
		(*t).counter += ((NI) 1);
	}
	LA1_: ;
