...
N_LIB_PRIVATE N_NIMCALL(NI, findNormalized__pureZstrutils_2250)(NimStringV2 x, NimStringV2* inArray, NI inArrayLen_0);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___pureZstrutils_2393)(tyObject_AddfFragment__avS6pb2zPQEKGAAnW9a9aRGQ* dest) {
	...
	{
		eqdestroy___system_3226((&(*dest)._kind_1.text));
	}
	break;
...
{nimErr_ = nimErrorFlag();
	...
	LA18_: ;
	result = substr__system_7605(s, first, last);
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___pureZstrutils_1103)(NimStringV2* s, tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA x, NimStringV2 b) {
	...
	L = (NI)((NI)(x.b - a) + ((NI) 1));
	{
		NI shiftX60gensym456_;
		NI newLenX60gensym456_;
		{
		...
		LA4_: ;
		shiftX60gensym456_ = (NI)(b.len - ((((NI) 0) >= L) ? ((NI) 0) : L));
		newLenX60gensym456_ = (NI)((*s).len + shiftX60gensym456_);
		{
			{
				if (!(((NI) 0) < shiftX60gensym456_)) goto LA16_;
				setLengthStrV2((&(*s)), ((NI) (newLenX60gensym456_)));
				{
					NI iX60gensym456_;
					NI colontmp_;
					NI colontmp__2;
					...
					colontmp_ = (NI)0;
					colontmp__2 = (NI)0;
					colontmp_ = (NI)(newLenX60gensym456_ - ((NI) 1));
					...
					res = colontmp_;
					{
						while (1) {
							...
							iX60gensym456_ = res;
							nimPrepareStrMutationV2((&(*s)));
							(*s).p->data[iX60gensym456_] = (*s).p->data[(NI)(iX60gensym456_ - shiftX60gensym456_)];
							(*s).p->data[(NI)(iX60gensym456_ - shiftX60gensym456_)] = 0;
							res -= ((NI) 1);
						} LA20: ;
					}
				}
			...
			LA16_: ;
			{
				...
				NI colontmp__4;
				NI res_2;
				iX60gensym456__2 = (NI)0;
				colontmp__3 = (NI)0;
				colontmp__4 = (NI)0;
				colontmp__3 = (NI)(a + b.len);
				colontmp__4 = (NI)(newLenX60gensym456_ - ((NI) 1));
				res_2 = colontmp__3;
				{
					while (1) {
						{
						...
						LA30_: ;
						iX60gensym456__2 = res_2;
						nimPrepareStrMutationV2((&(*s)));
						(*s).p->data[iX60gensym456__2] = (*s).p->data[(NI)(iX60gensym456__2 - shiftX60gensym456_)];
						(*s).p->data[(NI)(iX60gensym456__2 - shiftX60gensym456_)] = 0;
						res_2 += ((NI) 1);
					} LA27: ;
				}
			}
		...
		} LA13: ;
		{
			...
			i_3 = ((NI) 0);
			{
				while (1) {
					...
					LA37_: ;
					iX60gensym456__3 = i_3;
					nimPrepareStrMutationV2((&(*s)));
					(*s).p->data[(NI)(a + iX60gensym456__3)] = b.p->data[iX60gensym456__3];
					i_3 += ((NI) 1);
				} LA34: ;
			}
		}
...
appendString((&T122_), TM__JGc9b9bh2D3nTdUR7TGyq8aA_11);
						...
						invalidFormatString__pureZstrutils_2262(colontmp__13);
						if (NIM_UNLIKELY(*nimErr_)) goto LA121_;
						{
							LA121_:;
						}
...
appendString((&(*s)), fr._kind_1.text);
				...
				{
					NI x;
					x = findNormalized__pureZstrutils_2250(fr._kind_1.text, a, aLen_0);
					if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
					{
...
appendString((&(*s)), a[(NI)(x + ((NI) 1))]);
						...
						LA135_: ;
						invalidFormatString__pureZstrutils_2262(TM__JGc9b9bh2D3nTdUR7TGyq8aA_13);
						if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
					} LA127: ;
				}
				break;
		...
		LA4_: ;
		{
			...
			i = ((NI) 0);
			{
				while (1) {
					...
					LA15_: ;
					colontmp__2 = substr__system_7605(s, i, (NI)(j - ((NI) 1)));
					if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
...
appendString((&result), by);
			...
			colontmp__3 = substr__system_7617(s, i);
			if (NIM_UNLIKELY(*nimErr_)) goto LA10_;
...
appendString((&result), colontmp_);
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				LA23_: ;
				colontmp__5 = substr__system_7605(s, i_2, (NI)(j_2 - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
appendString((&result), by);
		...
		colontmp__4 = substr__system_7617(s, i_2);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		splitsX60gensym33_ = maxsplit;
		{
			while (1) {
				...
				LA21_: ;
				xX60gensym66_ = substr__system_7605(s, firstX60gensym33_, (NI)(lastX60gensym33_ - ((NI) 1)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	result.len = 0; result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(0, sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				xX60gensym75_ = substr__system_7605(s, first, colontmp_);
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				colontmp__5 = substr__system_7605(s, first, colontmp_);
...
{nimErr_ = nimErrorFlag();
	...
	result = ((NI) 2147483647);
	{
		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				colontmp__4 = substr__system_7605(s, first, colontmp_);
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
				eqsink___system_3232((&line), colontmp__4);
				{
					NI i;
					NIM_CHAR c;
					NI i_2;
	...
	{
		if (!(((NI) (result)) == ((NI) 2147483647))) goto LA67_;
		result = ((NI) 0);
	}
	LA67_: ;
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmp_ = substr__system_7617(s, ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
{nimErr_ = nimErrorFlag();
	...
	colontmp__2 = (NIM_BOOL)0;
	{
		NIM_CHAR* T29_;
		{
			...
			LA22_: ;
			T24_ = (NIM_CHAR*)0;
			T24_ = X5BX5D___system_7234((&result), ((NI) 4));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			colontmp_ = ((NU8)((*T24_)) == (NU8)(43));
		} LA19: ;
		...
		LA27_: ;
		T29_ = (NIM_CHAR*)0;
		T29_ = X5BX5D___system_7234((&result), ((NI) 3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		colontmp__2 = ((NU8)((*T29_)) == (NU8)(48));
	} LA18: ;
	{
		NIM_CHAR* T34_;
		NIM_CHAR* T35_;
		...
		T34_ = (NIM_CHAR*)0;
		T34_ = X5BX5D___system_7234((&result), ((NI) 2));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		X5BX5Deq___system_7249((&result), ((NI) 3), (*T34_));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		T35_ = (NIM_CHAR*)0;
		T35_ = X5BX5D___system_7234((&result), ((NI) 1));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		X5BX5Deq___system_7249((&result), ((NI) 2), (*T35_));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
