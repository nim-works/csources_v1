...
N_LIB_PRIVATE N_NIMCALL(void, fixupDispatcher_cgmeth_240)(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* meth, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* disp, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	...
	LA13_: ;
	{
		...
		liMessage_msgs_1117(conf, (*meth).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 52), T21_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_4, NIM_FALSE);
		{
			...
			while (1) {
				...
				case ((tyEnum_MethodResult__qJetbm7aUauL2eZA6Gt5Ag) 2):
				{
					...
					checkMethodEffects_sempass50_4495(g, disp, s);
					{
						...
						LA11_: ;
						if (!T10_) goto LA12_;
						liMessage_msgs_1117((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_6), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_7, NIM_FALSE);
					}
					LA12_: ;
					goto BeforeRet_;
				}
...
appendString(T26_, T27_);
		liMessage_msgs_1117((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T26_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_10, NIM_FALSE);
	}
	goto LA22_;
	LA24_: ;
	{
		if (!!((((*s).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag__K9ay6LWMat9bUiT9bIbMxpDHw) 20))&63U)))!=0))) goto LA29_;
		liMessage_msgs_1117((*g).config, (*s).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 33), ((NimStringDesc*) NIM_NIL), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_11, NIM_FALSE);
	}
	goto LA22_;
	LA29_: ;
	LA22_: ;
	...
	source = skipTypes_ast_3734((*n).typ, TM__zwdrTKOAAM6OvWnXdBD4GQ_13);
	{
		...
		LA9_: ;
		{
			...
			add_ast_4796(result, n);
			{
				...
				internalErrorImpl_msgs_1430(conf, (*n).info, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_14), TM__zwdrTKOAAM6OvWnXdBD4GQ_15);
			}
			LA16_: ;
		}
		goto LA7_;
		LA12_: ;
		{
			...
			add_ast_4796(result, n);
			{
				...
				internalErrorImpl_msgs_1430(conf, (*n).info, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_16), TM__zwdrTKOAAM6OvWnXdBD4GQ_17);
			}
			LA23_: ;
		}
		goto LA7_;
...
appendString(T9_, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_19));
		liMessage_msgs_1117(conf, (*n).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T9_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__zwdrTKOAAM6OvWnXdBD4GQ_20, NIM_FALSE);
	}
	LA1_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, genDispatcher_cgmeth_392)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* g, tySequence__eHqUwlHGGaPw0TDPDeL79cQ* methods, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* relevantCols) {
	...
	ands = getSysMagic_magicsys_29(g, unknownLineInfo_lineinfos_289, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_22), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 109));
	iss = getSysMagic_magicsys_29(g, unknownLineInfo_lineinfos_289, ((NimStringDesc*) &TM__zwdrTKOAAM6OvWnXdBD4GQ_23), ((tyEnum_TMagic__shZhZOdbVC5nnFvcXQAImg) 15));
	boolType = getSysType_magicsys_60(g, unknownLineInfo_lineinfos_289, ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 1));
	{
		NI col;
		NI i;
		col = (NI)0;
