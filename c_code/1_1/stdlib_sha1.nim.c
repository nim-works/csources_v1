...
N_LIB_PRIVATE N_NIMCALL(void, transform_stdZsha49_27)(tyObject_Sha1State__cBZm1tX9aK4Wngq1jVLZUow* ctx);
static N_INLINE(void, bigEndian32_pureZendians_65)(void* outp, void* inp);
static N_INLINE(void, swapEndian32_pureZendians_25)(void* outp, void* inp);
...
static N_INLINE(void, bigEndian64_pureZendians_62)(void* outp, void* inp);
static N_INLINE(void, swapEndian64_pureZendians_13)(void* outp, void* inp);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, eqeq__stdZsha49_924)(tyArray__YtcvxHNKV4YiecPE9ap1mcA x, tyArray__YtcvxHNKV4YiecPE9ap1mcA y);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isValidSha1Hash_stdZsha49_949)(NimStringDesc* s) {
	...
	if (!(T1_)) goto LA2_;
	T1_ = allCharsInSet_pureZstrutils_1341(s, TM__SpWH4VocI3fFoiOGE4MzWw_2);
	LA2_: ;
	result = T1_;
	return result;
}
...
static N_INLINE(void, swapEndian32_pureZendians_25)(void* outp, void* inp) {
	...
	copyMem_system_1727(((void*) ((&tmpX60gensym1_))), inp, ((NI) 4));
	tmpX60gensym1_ = __builtin_bswap32(tmpX60gensym1_);
	copyMem_system_1727(outp, ((void*) ((&tmpX60gensym1_))), ((NI) 4));
}
static N_INLINE(void, bigEndian32_pureZendians_65)(void* outp, void* inp) {
	swapEndian32_pureZendians_25(outp, inp);
}
N_LIB_PRIVATE N_NIMCALL(void, transform_stdZsha49_27)(tyObject_Sha1State__cBZm1tX9aK4Wngq1jVLZUow* ctx) {
	...
	e = (*ctx).state[(((NI) 4))- 0];
	{
		while (1) {
			if (!(t < ((NI) 15))) goto LA2;
			bigEndian32_pureZendians_65(((void*) ((&w[((NI)(t + ((NI) 0)))- 0]))), ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 0)) * ((NI) 4)))- 0]))));
			...
			bigEndian32_pureZendians_65(((void*) ((&w[((NI)(t + ((NI) 1)))- 0]))), ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 1)) * ((NI) 4)))- 0]))));
			...
			bigEndian32_pureZendians_65(((void*) ((&w[((NI)(t + ((NI) 2)))- 0]))), ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 2)) * ((NI) 4)))- 0]))));
			...
			bigEndian32_pureZendians_65(((void*) ((&w[((NI)(t + ((NI) 3)))- 0]))), ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 3)) * ((NI) 4)))- 0]))));
			...
			bigEndian32_pureZendians_65(((void*) ((&w[((NI)(t + ((NI) 4)))- 0]))), ((void*) ((&(*ctx).buf[((NI)((NI)(t + ((NI) 4)) * ((NI) 4)))- 0]))));
...
N_LIB_PRIVATE N_NIMCALL(void, update_stdZsha49_777)(tyObject_Sha1State__cBZm1tX9aK4Wngq1jVLZUow* ctx, NIM_CHAR* data, NI dataLen_0) {
	...
	len = dataLen_0;
	{
		...
		copyMem_system_1727(((void*) ((&(*ctx).buf[(i)- 0]))), ((void*) ((&data[j]))), ((NI) ((NI)(((NI) 64) - i))));
		len -= (NI)(((NI) 64) - i);
		j += (NI)(((NI) 64) - i);
		transform_stdZsha49_27(ctx);
		i = ((NI) 0);
	}
	LA3_: ;
	{
		while (1) {
			...
			copyMem_system_1727(((void*) ((&(*ctx).buf[(((NI) 0))- 0]))), ((void*) ((&data[j]))), ((NI) 64));
			len -= ((NI) 64);
			j += ((NI) 64);
			transform_stdZsha49_27(ctx);
		} LA6: ;
...
static N_INLINE(void, swapEndian64_pureZendians_13)(void* outp, void* inp) {
	...
	copyMem_system_1727(((void*) ((&tmpX60gensym0_))), inp, ((NI) 8));
	tmpX60gensym0_ = __builtin_bswap64(tmpX60gensym0_);
	copyMem_system_1727(outp, ((void*) ((&tmpX60gensym0_))), ((NI) 8));
}
static N_INLINE(void, bigEndian64_pureZendians_62)(void* outp, void* inp) {
	swapEndian64_pureZendians_13(outp, inp);
}
N_LIB_PRIVATE N_NIMCALL(void, finalize_stdZsha49_821)(tyObject_Sha1State__cBZm1tX9aK4Wngq1jVLZUow* ctx, tyArray__YtcvxHNKV4YiecPE9ap1mcA Result) {
	NU64 cnt;
	...
	update_stdZsha49_777(ctx, ((NimStringDesc*) &TM__SpWH4VocI3fFoiOGE4MzWw_3)->data, (((NimStringDesc*) &TM__SpWH4VocI3fFoiOGE4MzWw_3) ? ((NimStringDesc*) &TM__SpWH4VocI3fFoiOGE4MzWw_3)->Sup.len : 0));
	{
		while (1) {
			if (!!(((NI)((*ctx).count % ((NI) 64)) == ((NI) 56)))) goto LA2;
			update_stdZsha49_777(ctx, ((NimStringDesc*) &TM__SpWH4VocI3fFoiOGE4MzWw_4)->data, (((NimStringDesc*) &TM__SpWH4VocI3fFoiOGE4MzWw_4) ? ((NimStringDesc*) &TM__SpWH4VocI3fFoiOGE4MzWw_4)->Sup.len : 0));
		} LA2: ;
	}
	nimZeroMem((void*)tmp, sizeof(tyArray__1NlJ8ipZDU6GZ9bDFAyQjfQ));
	bigEndian64_pureZendians_62(((void*) ((&tmp[(((NI) 0))- 0]))), ((void*) ((&cnt))));
	update_stdZsha49_777(ctx, tmp, 8);
	{
		NI i;
		NI i_2;
		i = (NI)0;
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = i_2;
				bigEndian32_pureZendians_65(((void*) ((&(*ctx).state[(i)- 0]))), ((void*) ((&(*ctx).state[(i)- 0]))));
				i_2 += ((NI) 1);
			} LA5: ;
		}
	}
	copyMem_system_1727(((void*) ((&Result[(((NI) 0))- 0]))), ((void*) ((&(*ctx).state[(((NI) 0))- 0]))), ((NI) 20));
}
N_LIB_PRIVATE N_NIMCALL(void, secureHash_stdZsha49_840)(NIM_CHAR* str, NI strLen_0, tyArray__YtcvxHNKV4YiecPE9ap1mcA Result) {
	...
	update_stdZsha49_777((&state), str, strLen_0);
	finalize_stdZsha49_821((&state), Result);
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
	{
	...
	result = ((NimStringDesc*) NIM_NIL);
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				v = colontmp_[(i)- 0];
				T4_ = (NimStringDesc*)0;
				T4_ = toHex_pureZstrutils_1792(((NI) (v)), ((NI) 2));
...
N_LIB_PRIVATE N_NIMCALL(void, secureHashFile_stdZsha49_871)(NimStringDesc* filename, tyArray__YtcvxHNKV4YiecPE9ap1mcA Result) {
	...
	f = open_systemZio_518(filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
	state = newSha1State_stdZsha49_10();
	buffer = mnewString(((NI) 8192));
	{
		while (1) {
			NI length;
			length = readChars_systemZio_156(f, buffer->data, (buffer ? buffer->Sup.len : 0));
			{
			...
			update_stdZsha49_777((&state), buffer->data, (buffer ? buffer->Sup.len : 0));
			{
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, eqeq__stdZsha49_920)(tyArray__YtcvxHNKV4YiecPE9ap1mcA a, tyArray__YtcvxHNKV4YiecPE9ap1mcA b) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
	result = eqeq__stdZsha49_924(a, b);
	return result;
}
