...
STRING_LITERAL(TM__fVT8Frbe1eY8sI6VOwxZZg_4, "/home/saem/Development/nim/nimskull-csource-gen/compiler/plugins/itersgen.nim", 77);
...
((NI) 14)}
;
static NIM_CONST tySet_tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag TM__fVT8Frbe1eY8sI6VOwxZZg_9 = {
0x00, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00}
;
STRING_LITERAL(TM__fVT8Frbe1eY8sI6VOwxZZg_10, "type must be a non-generic ref|ptr to object with state field", 61);
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__fVT8Frbe1eY8sI6VOwxZZg_11 = {((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_4),
((NI) 29),
((NI) 14)}
;
...
{	result = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	...
	iter = (*n)._kind_6.sons->data[((NI) 1)];
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		liMessage_msgs_1117((*(*c).graph).config, (*iter).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_2), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_3, NIM_FALSE);
		goto BeforeRet_;
	}
	LA5_: ;
	{
		if (!((*(*n)._kind_6.sons->data[((NI) 2)]).typ == 0)) goto LA9_;
		liMessage_msgs_1117((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 2)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_5), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_6, NIM_FALSE);
		goto BeforeRet_;
	}
	LA9_: ;
	{
		if (!!(((*(*n)._kind_6.sons->data[((NI) 3)]).kind == ((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 2)))) goto LA13_;
		liMessage_msgs_1117((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 3)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_7), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_8, NIM_FALSE);
		goto BeforeRet_;
	}
	LA13_: ;
	t = skipTypes_ast_3734((*(*n)._kind_6.sons->data[((NI) 2)]).typ, TM__fVT8Frbe1eY8sI6VOwxZZg_9);
	{
		NIM_BOOL T17_;
		...
		T19_ = lastSon_ast_3742(t);
		T17_ = !(((*T19_).kind == ((tyEnum_TTypeKind__9a3YiReNVD0IJHWFKgXRe9ag) 17)));
		LA18_: ;
		if (!T17_) goto LA20_;
		liMessage_msgs_1117((*(*c).graph).config, (*(*n)._kind_6.sons->data[((NI) 2)]).info, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__fVT8Frbe1eY8sI6VOwxZZg_10), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 0), TM__fVT8Frbe1eY8sI6VOwxZZg_11, NIM_FALSE);
		goto BeforeRet_;
	}
	LA20_: ;
	T22_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T22_ = getBody_modulegraphs_11241((*c).graph, (*iter)._kind_4.sym);
	body = liftIterToProc_lambdalifting_5051((*c).graph, (*iter)._kind_4.sym, T22_, t, (*c).Sup.idgen);
	T23_ = nextSymId_ast_3131((*c).Sup.idgen);
	prc = newSym_ast_3444(((tyEnum_TSymKind__cNCW9acsSznmEccl1fgQwkw) 12), (*(*n)._kind_6.sons->data[((NI) 3)])._kind_5.ident, T23_, (*(*iter)._kind_4.sym).owner, (*(*iter)._kind_4.sym).info, 0);
	T24_ = nextTypeId_ast_3150((*c).Sup.idgen);
	asgnRef((void**) (&(*prc).typ), copyType_ast_4045((*(*iter)._kind_4.sym).typ, T24_, prc));
	(*(*prc).typ).flags &= ~(((NU64)1) << ((((tyEnum_TTypeFlag__x2m5g1NpbmDig4wLT3Ylhw) 12)) & 63));
	T25_ = (tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*)0;
	T25_ = getEnvParam_lambdalifting_131((*iter)._kind_4.sym);
	T26_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T26_ = newSymNode_ast_3715(T25_);
	add_ast_4796((*(*prc).typ).n, T26_);
	rawAddSon_ast_4287((*prc).typ, t, NIM_TRUE);
	orig = (*(*iter)._kind_4.sym).ast;
	T27_ = (tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw*)0;
	T27_ = newSymNode_ast_3715(prc);
	asgnRef((void**) (&(*prc).ast), newProcNode_ast_3820(((tyEnum_TNodeKind__G4E4Gxe7oI2Cm03rkiOzQw) 79), (*n).info, body, (*orig)._kind_6.sons->data[((NI) 3)], T27_, (*(*c).graph).emptyNode, (*(*c).graph).emptyNode, (*orig)._kind_6.sons->data[((NI) 4)], (*(*c).graph).emptyNode));
	add_ast_4796((*prc).ast, (*(*(*iter)._kind_4.sym).ast)._kind_6.sons->data[((NI) 7)]);
	addInterfaceDecl_lookups_879(c, prc);
	}BeforeRet_: ;
	return result;
}
