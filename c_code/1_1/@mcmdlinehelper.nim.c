...
N_LIB_PRIVATE N_NIMCALL(void, processCmdLineAndProjectPath_cmdlinehelper_32)(tyObject_NimProgcolonObjectType___bzPe2PlnnyJH4wKrjRuvwg* self, tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	...
	LA10_: ;
	{
		...
		setFromProjectName_options_4077(conf, (*conf).projectName);
	}
	goto LA1_;
	LA13_: ;
	{
		...
		asgnRef((void**) (&(*conf).projectPath), canonicalizePath_options_4073(conf, T16_));
	}
	LA1_: ;
}
...
{	result = (NIM_BOOL)0;
	...
	(*self).processCmdLine.ClE_0? (*self).processCmdLine.ClP_0(((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 1), ((NimStringDesc*) NIM_NIL), conf, (*self).processCmdLine.ClE_0):((TM__BxyDeRCaUtiykBhMyyq9cqA_11)((*self).processCmdLine.ClP_0))(((tyEnum_TCmdLinePass__IiBn9cB6WYIMDHOT44O82wA) 1), ((NimStringDesc*) NIM_NIL), conf);
	{
		...
		liMessage_msgs_1117(conf, unknownLineInfo_lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), ((NimStringDesc*) &TM__BxyDeRCaUtiykBhMyyq9cqA_12), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__BxyDeRCaUtiykBhMyyq9cqA_13, NIM_FALSE);
	}
	LA29_: ;
