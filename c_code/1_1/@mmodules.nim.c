...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, getPackage_modules_22)(tyObject_ModuleGraphcolonObjectType___RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx) {
	...
	pck = getPackageName_options_4132((*graph).config, filename);
	{
	...
	LA9_: ;
	{
		...
		LA15_: ;
		{
			...
			LA24_: ;
			if (!T23_) goto LA25_;
			pck3 = fakePackageName_options_4137((*graph).config, filename);
...
appendString(T8_, (*(*result).name).s);
		liMessage_msgs_1117((*graph).config, unknownLineInfo_lineinfos_289, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 14), T8_, ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__M5T16KOkc0tDi9bZeKl6v1w_3, NIM_FALSE);
	}
	LA6_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, wantMainModule_modules_2883)(tyObject_ConfigRefcolonObjectType___LaK09ayL9alwKUad7rts0rTw* conf) {
	NimStringDesc* T6_;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isEmpty_options_4484((*conf).projectFull);
		if (!T3_) goto LA4_;
		liMessage_msgs_1117(conf, gCmdLineInfo_msgs_404, ((tyEnum_TMsgKind__29cbg2fC1z5iM1PAI28kR5w) 1), ((NimStringDesc*) &TM__M5T16KOkc0tDi9bZeKl6v1w_10), ((tyEnum_TErrorHandling__q4fXoCN3Xdcm6SS9cUkWkWw) 1), TM__M5T16KOkc0tDi9bZeKl6v1w_11, NIM_FALSE);
	}
	LA4_: ;
	T6_ = (NimStringDesc*)0;
