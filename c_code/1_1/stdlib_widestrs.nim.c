...
N_LIB_PRIVATE N_NIMCALL(NI16*, newWideCString_systemZwidestrs_231)(NCSTRING source, NI L) {
	...
	NI d;
	result = (NI16*)0;
	result = (NI16*) newObj((&NTIwidecstringobj__4HwedE75WPfqZSQ0Cq2OUg_), ((NI) ((NI)((NI)(L * ((NI) 2)) + ((NI) 2)))));
	d = ((NI) 0);
	{
		NI ch;
		NI i;
		...
		result_2 = (NI)0;
		{
			while (1) {
				...
				LA45_: ;
				{
					NI ch_2;
					ch_2 = (NI)(ch - ((NI) 65536));
					result[d] = ((NI16) (((NU16) ((NI)((NI)((NI32)(ch_2) >> (NU32)(((NI) 10))) + ((NI) 55296))))));
					d += ((NI) 1);
...
N_LIB_PRIVATE N_NIMCALL(NI16*, newWideCString_systemZwidestrs_257)(NimStringDesc* s) {
	NI16* result;
	result = (NI16*)0;
	result = newWideCString_systemZwidestrs_231(nimToCStringConv(s), (s ? s->Sup.len : 0));
	return result;
}
static N_INLINE(NI, nimCStrLen)(NCSTRING a) {
	NI result;
...
{	result = (NI16*)0;
	...
	LA3_: ;
	result = newWideCString_systemZwidestrs_231(s, (s ? nimCStrLen(s) : 0));
	}BeforeRet_: ;
	return result;
}
