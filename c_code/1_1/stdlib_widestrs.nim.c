		...
		result_2 = (NI)0;
		{
			while (1) {
				...
				LA6_: ;
				{
					...
					LA11_: ;
					{
						if (!((NI)((NI32)(((NU8)(source[i]))) >> (NU32)(((NI) 5))) == ((NI) 6))) goto LA15_;
						{
							{
					...
					LA15_: ;
					{
						if (!((NI)((NI32)(((NU8)(source[i]))) >> (NU32)(((NI) 4))) == ((NI) 14))) goto LA24_;
						{
							{
					...
					LA24_: ;
					{
						if (!((NI)((NI32)(((NU8)(source[i]))) >> (NU32)(((NI) 3))) == ((NI) 30))) goto LA33_;
						{
							{
				...
				ch = result_2;
				{
					...
					LA57_: ;
					ch_2 = (NI)(ch - ((NI) 65536));
					result.data.p->data[d] = ((NI16) (((NU16) ((NI)((NI)((NI32)(ch_2) >> (NU32)(((NI) 10))) + ((NI) 55296))))));
					d += ((NI) 1);
