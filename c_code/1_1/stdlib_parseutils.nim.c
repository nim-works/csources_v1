...
N_LIB_PRIVATE N_NIMCALL(NI, rawParseUInt__pureZparseutils_393)(NimStringV2 s, NU64* b, NI start);
...
{nimErr_ = nimErrorFlag();
	...
	colontmp_ = (NIM_BOOL)0;
	{
		colontmp_ = (res < IL64(-2147483648));
		{
			if (!colontmp_) goto LA4_;
			goto LA1;
		}
		LA4_: ;
		colontmp_ = (IL64(2147483647) < res);
	} LA1: ;
	{
	...
	} LA10: ;
	{
		...
		(*b) = ((NI) 0);
		{
			while (1) {
				...
				{
					{
						if (!((*b) <= (NI)((NI)(((NI) 2147483647) - c) / ((NI) 10)))) goto LA33_;
						(*b) = (NI)((NI)((*b) * ((NI) 10)) + c);
						goto LA30;
					}
					LA33_: ;
