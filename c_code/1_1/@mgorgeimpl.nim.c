...
appendString(T7_, T8_);
		filename = toGeneratedFile_options_4224(conf, T7_, ((NimStringDesc*) &TM__69a9b06YSkBJW7wqzuZfJ29aQ_4));
		f = (FILE*)0;
		{
			NIM_BOOL T11_;
			...
			if (!(T11_)) goto LA12_;
			T11_ = open_systemZio_487(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
			LA12_: ;
			if (!T11_) goto LA13_;
			colontmp_ = readAll_systemZio_443(f);
			colontmp__2 = ((NI) 0);
		...
		readSuccessful = NIM_TRUE;
		{
			...
			writeFile_systemZio_567(filename, (*Result).Field0);
		}
		LA24_: ;
		popSafePoint();
		}
