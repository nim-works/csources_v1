...
N_LIB_PRIVATE N_NIMCALL(void, openDefaultBrowserImpl_pureZbrowsers_8)(NimStringDesc* url);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, prepare_pureZbrowsers_5)(NimStringDesc* s);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, prepare_pureZbrowsers_5)(NimStringDesc* s) {
	...
	LA4_: ;
	{
		...
		T9_ = (NimStringDesc*)0;
		T9_ = absolutePath_pureZos_743(s, T8_);
...
N_LIB_PRIVATE N_NIMCALL(void, openDefaultBrowserImpl_pureZbrowsers_8)(NimStringDesc* url) {
	...
	T1_ = (NimStringDesc*)0;
	T2_ = (NimStringDesc*)0;
	T2_ = prepare_pureZbrowsers_5(url);
	T3_ = (NimStringDesc*)0;
...
N_LIB_PRIVATE N_NIMCALL(void, openDefaultBrowser_pureZbrowsers_10)(NimStringDesc* url) {
	...
	LA3_: ;
	openDefaultBrowserImpl_pureZbrowsers_8(url);
}
