...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, llStreamReadLine_llstream_194)(tyObject_TLLStream__a5oZYQ9aTktYME2449ayEi6g* s, NimStringDesc** line) {
	...
	case ((tyEnum_TLLStreamKind__jVcKY16LbOamXE9bxXUD6pQ) 3):
	{
		result = readLine_systemZio_238(__stdinp, line);
	}
	break;
	}
	return result;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, readLineFromStdin_llstream_112)(NimStringDesc* prompt, NimStringDesc** line) {
	NIM_BOOL result;
	result = (NIM_BOOL)0;
	write_systemZio_205(__stdoutp, prompt);
	result = readLine_systemZio_238(__stdinp, line);
	{
		if (!!(result)) goto LA3_;
		write_systemZio_205(__stdoutp, ((NimStringDesc*) &TM__ml9aueblxGz9aYsRLKvPmpow_11));
		exit(((NI) 0));
	}
	LA3_: ;
	return result;
