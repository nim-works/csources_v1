...
{	result = (pid_t)0;
	...
	nimZeroMem((void*)(&fops), sizeof(posix_spawn_file_actions_t));
	{
		...
		T6_ = (NI32)0;
		T6_ = osLastError_pureZos_399();
		raiseOSError_pureZos_396(T6_, ((NimStringDesc*) NIM_NIL));
	}
	LA4_: ;
	{
		int T9_;
		...
		T12_ = (NI32)0;
		T12_ = osLastError_pureZos_399();
		raiseOSError_pureZos_396(T12_, ((NimStringDesc*) NIM_NIL));
	}
	LA10_: ;
	mask = (sigset_t)0;
	{
		...
		T18_ = (NI32)0;
		T18_ = osLastError_pureZos_399();
		raiseOSError_pureZos_396(T18_, ((NimStringDesc*) NIM_NIL));
	}
	LA16_: ;
	{
		int T21_;
		...
		T24_ = (NI32)0;
		T24_ = osLastError_pureZos_399();
		raiseOSError_pureZos_396(T24_, ((NimStringDesc*) NIM_NIL));
	}
	LA22_: ;
	{
		if (!(((*data).options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 6))&7U)))!=0)) goto LA27_;
		{
			...
			T34_ = (NI32)0;
			T34_ = osLastError_pureZos_399();
			raiseOSError_pureZos_396(T34_, ((NimStringDesc*) NIM_NIL));
		}
		LA32_: ;
	}
	LA27_: ;
	...
	LA37_: ;
	{
		...
		T44_ = (NI32)0;
		T44_ = osLastError_pureZos_399();
		raiseOSError_pureZos_396(T44_, ((NimStringDesc*) NIM_NIL));
	}
	LA42_: ;
	{
		if (!!((((*data).options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0))) goto LA47_;
		{
			...
			raiseOSError_pureZos_396(T54_, ((NimStringDesc*) NIM_NIL));
		}
		LA52_: ;
		{
			int T57_;
			...
			T60_ = (NI32)0;
			T60_ = osLastError_pureZos_399();
			raiseOSError_pureZos_396(T60_, ((NimStringDesc*) NIM_NIL));
		}
		LA58_: ;
		{
			int T63_;
			...
			T66_ = (NI32)0;
			T66_ = osLastError_pureZos_399();
			raiseOSError_pureZos_396(T66_, ((NimStringDesc*) NIM_NIL));
		}
		LA64_: ;
		{
			int T69_;
			...
			T72_ = (NI32)0;
			T72_ = osLastError_pureZos_399();
			raiseOSError_pureZos_396(T72_, ((NimStringDesc*) NIM_NIL));
		}
		LA70_: ;
		{
			int T75_;
			...
			T78_ = (NI32)0;
			T78_ = osLastError_pureZos_399();
			raiseOSError_pureZos_396(T78_, ((NimStringDesc*) NIM_NIL));
		}
		LA76_: ;
		{
			if (!(((*data).options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 3))&7U)))!=0)) goto LA81_;
			{
				...
				T88_ = (NI32)0;
				T88_ = osLastError_pureZos_399();
				raiseOSError_pureZos_396(T88_, ((NimStringDesc*) NIM_NIL));
			}
			LA86_: ;
		}
		goto LA79_;
		...
		{
			{
				...
				T95_ = (NI32)0;
				T95_ = osLastError_pureZos_399();
				raiseOSError_pureZos_396(T95_, ((NimStringDesc*) NIM_NIL));
			}
			LA93_: ;
		}
		LA79_: ;
	...
	(void)(T107_);
	{
		...
		raiseOSError_pureZos_396(res, (*data).sysCommand);
	}
	LA110_: ;
	result = pid;
	goto BeforeRet_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingDir, NimStringDesc** args, NI argsLen_0, tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* env, tySet_tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA options) {
	...
	(*result).exitFlag = NIM_TRUE;
	{
		if (!!(((options &((NU8)1<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0))) goto LA3_;
		{
			...
			if (!T7_) goto LA14_;
			T16_ = (NI32)0;
			T16_ = osLastError_pureZos_399();
			raiseOSError_pureZos_396(T16_, ((NimStringDesc*) NIM_NIL));
		}
		LA14_: ;
	}
	LA3_: ;
...
{	result = (NI)0;
	...
	LA3_: ;
	{
		...
		status = ((int) 1);
		{
			...
			T15_ = (NI32)0;
			T15_ = osLastError_pureZos_399();
			raiseOSError_pureZos_396(T15_, ((NimStringDesc*) NIM_NIL));
		}
		LA13_: ;
		(*p).exitFlag = NIM_TRUE;
		(*p).exitStatus = status;
			...
			while (1) {
				...
				count = wait_for_objects_etc((&info), ((int) 1), ((NU32) 8), ((NI64) (timeout)));
				{
					...
					err = ((int) (count));
					{
						if (!(err == ETIMEDOUT)) goto LA25_;
						{
							...
							raiseOSError_pureZos_396(T32_, ((NimStringDesc*) NIM_NIL));
						}
						LA30_: ;
						{
							pid_t T35_;
							...
							T38_ = (NI32)0;
							T38_ = osLastError_pureZos_399();
							raiseOSError_pureZos_396(T38_, ((NimStringDesc*) NIM_NIL));
						}
						LA36_: ;
						(*p).exitFlag = NIM_TRUE;
					...
					LA25_: ;
					{
						...
						raiseOSError_pureZos_396(err, ((NimStringDesc*) NIM_NIL));
					}
					goto LA23_;
					LA40_: ;
					LA23_: ;
				...
				LA21_: ;
				{
					if (!(((NI) 0) < count)) goto LA43_;
					{
						...
						T50_ = (NI32)0;
						T50_ = osLastError_pureZos_399();
						raiseOSError_pureZos_396(T50_, ((NimStringDesc*) NIM_NIL));
					}
					LA48_: ;
					(*p).exitFlag = NIM_TRUE;
					(*p).exitStatus = status_2;
