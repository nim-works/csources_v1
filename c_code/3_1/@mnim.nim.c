...
N_LIB_PRIVATE N_NIMCALL(void, openDefaultBrowser_pureZbrowsers_10)(NimStringDesc* url);
...
static N_INLINE(NimStringDesc*, findNodeJs_nodejs_2)(void) {
	NimStringDesc* result;
	result = (NimStringDesc*)0;
	result = findExe_pureZos_663(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_16), NIM_TRUE, ExeExts_pureZos_662, 1);
	{
		if (!((result ? result->Sup.len : 0) == ((NI) 0))) goto LA3_;
		result = findExe_pureZos_663(((NimStringDesc*) &TM__6xNBOpPeN0DsJ34t7RoSng_17), NIM_TRUE, ExeExts_pureZos_662, 1);
	}
	LA3_: ;
	{
...
appendString(T50_, (*conf).arguments);
		...
		case ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 18) ... ((tyEnum_Command__0zjcIQ623TIRGPdtjLwTFA) 21):
		{
			...
			openDefaultBrowser_pureZbrowsers_10(T59_);
		}
		break;
		default:
		{
