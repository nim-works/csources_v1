...
57}
;
N_LIB_PRIVATE NIM_CONST tyArray__k7wgHIN8mKeRF236nmwvnQ trailingZeros100_stdZprivateZdigitsutils_1 = {((NI8) 2),
((NI8) 0),
((NI8) 0),
((NI8) 0),
((NI8) 0),
...
static N_INLINE(void, addIntImpl_stdZprivateZdigitsutils_59)(NimStringDesc** result, NU64 x) {
	...
	next = ((NI) 23);
	{
		while (1) {
			...
			tmp[((NI)(next - ((NI) 1)))- 0] = digits100_stdZprivateZdigitsutils_2[(index)- 0];
			next -= ((NI) 2);
		} LA2: ;
	}
	{
	...
	LA5_: ;
	{
		...
		tmp[((NI)(next - ((NI) 1)))- 0] = digits100_stdZprivateZdigitsutils_2[(index_2)- 0];
		next -= ((NI) 1);
	}
	LA3_: ;
	addChars_stdZprivateZdigitsutils_100(result, tmp, next, (NI)(((NI) 24) - next));
}
N_LIB_PRIVATE N_NIMCALL(void, addInt_stdZprivateZdigitsutils_164)(NimStringDesc** result, NU64 x) {
