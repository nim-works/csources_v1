...
N_LIB_PRIVATE N_NIMCALL(void, setExternName_pragmas_238)(tyObject_TContext__C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ* s, NimStringDesc* extname, tyObject_TLineInfo__WGx4rAexNXnczy1Avn646Q info) {
	...
	LA3_: ;
	{
		NIM_BOOL T6_;
		T6_ = (NIM_BOOL)0;
		T6_ = contains_pureZos_633(extname->data, (extname ? extname->Sup.len : 0), 36);
		if (!!(T6_)) goto LA7_;
...
appendString(T13_, ((NimStringDesc*) &TM__tPA3StZ6VsKyoznyrIfFxg_18));
	...
	LA1_: ;
	{
		...
		if (!(T16_)) goto LA17_;
		T18_ = (NIM_BOOL)0;
		T18_ = contains_pureZos_633(extname->data, (extname ? extname->Sup.len : 0), 36);
		T16_ = !(T18_);
		LA17_: ;
		if (!T16_) goto LA19_;
		...
		found = slash__pureZos_121(T17_, s);
		{
			...
			if (TM__tPA3StZ6VsKyoznyrIfFxg_79.status == 0) {
			{
				if (!(resX60gensym137_ == ((NI) 0))) goto LA22_;
				{
					...
					colontmp_ = (NI32)0;
					colontmp_ = (NI32)(fX60gensym137_.gl_pathc - ((NI32) 1));
					res = ((NI32) 0);
					{
						while (1) {
