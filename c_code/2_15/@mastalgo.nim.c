...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, toStrMaxPrecision_astalgo_920)(NF f) {
	...
	default:
	{
		addFloatRoundtrip_system_3127((&result), f);
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_7));
	...
	value_astalgo_1078(this_0, ((NI64) ((NI)((NI)((NU32)(((NI) ((*xX60gensym118_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym118_).Sup.itemId.item))))));
	{
...
appendString((*this_0).res, ((NimStringDesc*) &TM__uRgrUHgaDgkYkoMPsaodqw_7));
	...
	value_astalgo_1078(this_0, ((NI64) ((NI)((NI)((NU32)(((NI) ((*xX60gensym113_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym113_).Sup.itemId.item))))));
	{
	...
	h = (NI)(key & T1_);
	{
		while (1) {
			...
			if (!!((t.data->data[h].key == ((tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w*) NIM_NIL)))) goto LA3;
			{
				...
				if (!((NI)((NI)((NU32)(((NI) ((*xX60gensym174_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym174_).itemId.item))) == key)) goto LA6_;
				result = h;
				goto BeforeRet_;
			}
			LA6_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, idTableRawInsert_astalgo_3905)(tySequence__Mh9agqM29bm9aP5AUL1x7dZGA** data, tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w* key, RootObj* val) {
	...
	xX60gensym182_ = key;
	T1_ = (((*data) ? (*data)->Sup.len : 0)-1);
	h = (NI)((NI)((NI)((NU32)(((NI) ((*xX60gensym182_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym182_).itemId.item))) & T1_);
	{
		while (1) {
			NI T4_;
...
N_LIB_PRIVATE N_NIMCALL(void, idTablePut_astalgo_70)(tyObject_TIdTable__9aiv9bp2t5icFNINcg9c4xi1Q* t, tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w* key, RootObj* val) {
	...
	xX60gensym191_ = key;
	index = idTableRawGet_astalgo_3813((*t), (NI)((NI)((NU32)(((NI) ((*xX60gensym191_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym191_).itemId.item))));
	{
...
N_LIB_PRIVATE N_NIMCALL(RootObj*, idTableGet_astalgo_64)(tyObject_TIdTable__9aiv9bp2t5icFNINcg9c4xi1Q t, tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w* key) {
	...
	result = (RootObj*)0;
	xX60gensym177_ = key;
	index = idTableRawGet_astalgo_3813(t, (NI)((NI)((NU32)(((NI) ((*xX60gensym177_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym177_).itemId.item))));
	{
		if (!(((NI) 0) <= index)) goto LA3_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*, nextIdentExcluding_astalgo_3432)(tyObject_TIdentIter__Oi4goG2ACEsy9cyTe6OCPrA* ti, tyObject_TStrTable__f07aOS3dr28kGa5wcE29aFA tab, tyObject_PackedSet__IhxwDBRi51nGrosBGFKcsA* excluding) {
	...
	result = tab.data->data[h];
	{
		while (1) {
			...
			if (!!((result == ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL)))) goto LA3;
			{
				...
				T8_ = (NIM_BOOL)0;
				T8_ = contains_astalgo_3496(excluding, (NI)((NI)((NU32)(((NI) ((*xX60gensym168_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym168_).Sup.itemId.item))));
				T6_ = !(T8_);
				LA7_: ;
				if (!T6_) goto LA9_;
				goto LA2;
	...
	(*ti).h = nextTry_astalgo_90(h, T16_);
	{
		...
		T19_ = contains_astalgo_3496(excluding, (NI)((NI)((NU32)(((NI) ((*xX60gensym170_).Sup.itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym170_).Sup.itemId.item))));
		LA20_: ;
		if (!T19_) goto LA21_;
		result = ((tyObject_TSym__nnJKJFyjDGi5mnv8jwfTGQ*) NIM_NIL);
	}
...
{	result = (NI)0;
	...
	xX60gensym199_ = key;
	T1_ = ((t.data ? t.data->Sup.len : 0)-1);
	h = (NI)((NI)((NI)((NU32)(((NI) ((*xX60gensym199_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym199_).itemId.item))) & T1_);
	{
		while (1) {
			NI T8_;
			if (!!((t.data->data[h].key == ((tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w*) NIM_NIL)))) goto LA3;
			{
				...
				xX60gensym202_ = key;
				if (!((NI)((NI)((NU32)(((NI) ((*xX60gensym201_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym201_).itemId.item))) == (NI)((NI)((NU32)(((NI) ((*xX60gensym202_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym202_).itemId.item))))) goto LA6_;
				result = h;
				goto BeforeRet_;
			}
			LA6_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, idNodeTableRawInsert_astalgo_4071)(tySequence__K8W16aeLg4OWxniQxtguMw** data, tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w* key, tyObject_TNode__bROa11lyF5vxEN9aYNbHmhw* val) {
	...
	xX60gensym204_ = key;
	T1_ = (((*data) ? (*data)->Sup.len : 0)-1);
	h = (NI)((NI)((NI)((NU32)(((NI) ((*xX60gensym204_).itemId.module))) << (NU32)(((NI) 20))) + ((NI) ((*xX60gensym204_).itemId.item))) & T1_);
	{
		while (1) {
			NI T4_;
			if (!!(((*data)->data[h].key == ((tyObject_TIdObj__KUwfjfUQEwGHguQbTcXu7w*) NIM_NIL)))) goto LA3;
